...
public:
    ...
    */
    ...
    /// Query as an unsignedeger. See IntAttribute()
...
public:
    ...
    */
	...
	int QueryAttribute( const char* name, unsigned* value ) const {
...
public:
    ...
    */
    ...
    /**
    	...
    	an errorID.
    */
    XMLError LoadFile( const char* file_name );
    ...
    */
    ...
    /**
    	...
    	an errorID.
    */
    XMLError SaveFile( const char* file_name, bool compact = false );
