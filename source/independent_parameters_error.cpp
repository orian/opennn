...
const double& IndependentParametersError::get_target_independent_parameter(const unsigned& i) const
{
...
// const double& get_independent_parameter_error_weight(const unsigned&) const method
...
const double& IndependentParametersError::get_independent_parameter_error_weight(const unsigned& i) const
{
...
void IndependentParametersError::set_target_independent_parameter(const unsigned& i, const double& new_target_independent_parameter)
{
...
// void set_independent_parameter_error_weight(const unsigned&, const double&) method
...
void IndependentParametersError::set_independent_parameter_error_weight(const unsigned& i, const double& new_independent_parameter_error_weight)
{
...
void IndependentParametersError::check(void) const
{
   ...
   const unsigned target_independent_parameters_size = target_independent_parameters.size();
   ...
   const unsigned independent_parameters_errors_weights_size = independent_parameters_errors_weights.size();
...
Vector<double> IndependentParametersError::calculate_gradient(void) const
{
   ...
   const unsigned neural_parameters_number = parameters_number - independent_parameters_number;
