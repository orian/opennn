...
void ScalingLayer::set_item_statistics(const unsigned& i, const Statistics<double>& item_statistics)
{
...
void ScalingLayer::set_standard_deviation(const unsigned& i, const double& new_standard_deviation)
{
...
void ScalingLayer::from_XML(const tinyxml2::XMLDocument& document)
{
   ...
   const unsigned scaling_neurons_number = atoi(scaling_neurons_number_element->GetText());
