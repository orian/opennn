...
const double& OrdinaryDifferentialEquations::get_initial_dependent_variable(const unsigned& i) const
{
...
// void set_initial_dependent_variable(const unsigned&, const double&) const method
...
void OrdinaryDifferentialEquations::set_initial_dependent_variable(const unsigned& i, const double& new_initial_dependent_variable) 
{
...
void OrdinaryDifferentialEquations::set_points_number(const unsigned& new_points_number)
{
...
void OrdinaryDifferentialEquations::set_initial_size(const unsigned& new_initial_size)
{
...
void OrdinaryDifferentialEquations::set_warning_size(const unsigned& new_warning_size)
{
...
void OrdinaryDifferentialEquations::set_error_size(const unsigned& new_error_size)
{
