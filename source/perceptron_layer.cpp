...
PerceptronLayer::PerceptronLayer(const unsigned& new_inputs_number, const unsigned& new_perceptrons_number)
{
...
Vector<unsigned> PerceptronLayer::count_cumulative_parameters_number(void) const
{
   const unsigned perceptrons_number = get_perceptrons_number();
...
Vector<double> PerceptronLayer::arrange_parameters(void) const
{
   ...
   else
   {
      ...
      const unsigned perceptron_parameters_number = perceptrons[0].count_parameters_number();
...
void PerceptronLayer::set(const unsigned& new_inputs_number, const unsigned& new_perceptrons_number)
{
...
void PerceptronLayer::set_perceptron(const unsigned& i, const Perceptron& new_perceptron)
{
...
void PerceptronLayer::set_perceptrons_number(const unsigned& new_perceptrons_number)
{
   const unsigned perceptrons_number = get_perceptrons_number();
   const unsigned inputs_number = get_inputs_number();
...
Vector<double> PerceptronLayer::calculate_combinations(const Vector<double>& inputs, const Vector<double>& parameters) const
{
   ...
   const unsigned perceptron_parameters_number = count_perceptron_parameters_number();
