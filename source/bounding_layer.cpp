...
void BoundingLayer::set_lower_bound(const unsigned& index, const double& new_lower_bound)
{
   const unsigned bounding_neurons_number = get_bounding_neurons_number();
...
void BoundingLayer::set_upper_bound(const unsigned& index, const double& new_upper_bound)
{
   const unsigned bounding_neurons_number = get_bounding_neurons_number();
