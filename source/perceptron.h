...
/// A perceptron will be used to construct layers of perceptrons, which will be
/// used to construct multilayer perceptrons.
/// The perceptron implemented here admits a variety of activation or transfer
/// functions.
...
class Perceptron {
 public:
  ...
  explicit Perceptron(const unsigned&);

  // INPUTS NUMBER AND INITIALIZATION CONSTRUCTOR

  explicit Perceptron(const unsigned&, const double&);
  ...
  /// Enumeration of available activation functions for the perceptron neuron
  /// model.
  ...
  const double& get_synaptic_weight(const unsigned&) const;
  ...
  void set(const unsigned&, const double&);
  ...
  void set_synaptic_weight(const unsigned&, const double&);
  ...
  Vector<double> calculate_combination_gradient(const Vector<double>&,
                                                const Vector<double>&) const;
  Matrix<double> calculate_combination_Hessian(const Vector<double>&,
                                               const Vector<double>&) const;
