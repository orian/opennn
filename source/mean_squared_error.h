...
/// The mean squared error measures the difference between the outputs from a
/// neural network and the targets in a data set.
/// This functional is used in data modeling problems, such as function
/// regression,
