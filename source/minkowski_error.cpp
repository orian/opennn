...
/// Default constructor.
/// It creates Minkowski error performance term not associated to any neural
...
/// Neural network constructor.
/// It creates a Minkowski error performance term associated to a neural network
/// but not measured on any data set.
/// It also initializes all the rest of class members to their default values.
...
/// Data set constructor.
/// It creates a Minkowski error performance term not associated to any neural
/// network but to be measured on a data set.
/// It also initializes all the rest of class members to their default values.
...
/// Neural network and data set constructor.
/// It creates a Minkowski error performance term object associated to a neural
/// network and measured on a data set.
/// It also initializes all the rest of class members to their default values.
/// @param new_neural_network_pointer Pointer to a neural network object.
/// @param new_data_set_pointer Pointer to a data set object.
...
/// XML constructor.
/// It creates a Minkowski error object neither associated to a neural network
/// nor to a data set.
/// The object members are loaded by means of a XML document.
/// @param mean_squared_error_document TinyXML document with the Minkowski error
/// elements.
...
/// Sets a new Minkowski exponent value to be used in order to calculate the
/// error.
/// The Minkowski R-value must be comprised between 1 and 2.
/// @param new_Minkowski_parameter Minkowski exponent value.

void MinkowskiError::set_Minkowski_parameter(
    const double& new_Minkowski_parameter) {
  // Control sentence
...
// Control sentence
  ...
  for (unsigned i = 0; i < training_instances_number; i++) {
    ...
    Minkowski_error +=
        (outputs - targets).calculate_p_norm(Minkowski_parameter);
  }
...
/// Returns which would be the Minkowski error of for an hypothetical vector of
/// parameters.
...
/// associated to the Minkowski error.

double MinkowskiError::calculate_performance(
...
/// Returns the Minkowski error of the multilayer perceptron measured on the
/// generalization instances of the
/// data set.
...
/// Returns the Minkowski error gradient of a neural network measured on a data
/// set.
  ...
  for (unsigned i = 0; i < training_instances_number; i++) {
    ...
    if (!has_conditions_layer) {
      output_gradient = (layers_activation[layers_number - 1] - targets)
          .calculate_p_norm_gradient(Minkowski_parameter);
      ...
      output_gradient =
          (particular_solution +
           ...
           targets).calculate_pow(Minkowski_parameter - 1.0) *
          Minkowski_parameter;
...
/// Returns a string with the name of the Minkowski error performance type,
/// "MINKOWSKI_ERROR".
...
/// Serializes the Minkowski error object into a XML document of the TinyXML
/// library.
...
tinyxml2::XMLDocument* MinkowskiError::to_XML(void) const {
  ...
  tinyxml2::XMLElement* Minkowski_error_element =
      document->NewElement("MinkowskiError");

  document->InsertFirstChild(Minkowski_error_element);

  // Minkowski parameter
  {
    tinyxml2::XMLElement* Minkowski_parameter_element =
        document->NewElement("MinkowskiParameter");
    Minkowski_error_element->LinkEndChild(Minkowski_parameter_element);

    buffer.str("");
    buffer << Minkowski_parameter;

    tinyxml2::XMLText* Minkowski_parameter_text =
...
void MinkowskiError::from_XML(const tinyxml2::XMLDocument& document) {
  const tinyxml2::XMLElement* root_element =
      document.FirstChildElement("MinkowskiError");
  ...
  // Minkowski parameter
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("MinkowskiParameter");
