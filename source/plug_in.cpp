...
/// Default constructor.
/// It constructs a default plug-in object, with zero independent and dependent
/// variables.
...
/// Returns a string with the name of the method for including the information
/// into the input file.
...
// const std::string& get_input_flag(const unsigned&) const method

/// Returns a single input file flag.
/// @param i Index of flag.

const std::string& PlugIn::get_input_flag(const unsigned& i) const {
...
/// Thise method writes the input file with values obtained from the neural
/// network.
...
Matrix<double> PlugIn::calculate_solutions(
    const NeuralNetwork& neural_network) const {
