...
void FinalSolutionsError::set_final_solution_error_weight(const unsigned& i, const double& new_final_solution_error_weight)
{
...
void FinalSolutionsError::set_target_final_solution(const unsigned& i, const double& new_target_final_solution)
{
...
/// Checks that there are a neural network and a mathematical model associated to the sum squared error, 
