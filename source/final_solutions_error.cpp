...
/// Default constructor.
/// It creates a final solutions error performance term not associated to any
/// neural network and not measured on any mathematical model.
/// It also initializes all the rest of class members to their default values.

FinalSolutionsError::FinalSolutionsError(void) : PerformanceTerm() {
...
/// Neural network constructor.
/// It creates a final solutions error performance term associated to a neural
/// network but not measured on any mathematical model.
/// It also initializes all the rest of class members to their default values.
/// @param new_neural_network_pointer Pointer to a neural network object.

FinalSolutionsError::FinalSolutionsError(
...
/// Mathematical model constructor.
/// It creates a final solutions error performance term not associated to any
/// neural network but to be measured on a given mathematical model.
/// It also initializes all the rest of class members to their default values.
...
/// Neural network and mathematical model constructor.
/// It creates a final solutions error performance term object associated to a
/// given neural network and to be measured on a given mathematical model.
/// It also initializes all the rest of class members to their default values.
/// @param new_neural_network_pointer Pointer to a neural network object.
/// @param new_mathematical_model_pointer Pointer to a mathematical model
/// object.
...
/// XML constructor.
/// It creates a final solutions error performance term neither associated to a
/// neural network nor to a mathematical model.
...
FinalSolutionsError::FinalSolutionsError(
    const tinyxml2::XMLDocument& final_state_error_document)
...
/// @param other_final_solutions_error Final solutions error object to be
/// copied.

FinalSolutionsError::FinalSolutionsError(
    const FinalSolutionsError& other_final_solutions_error)
    : PerformanceTerm() {
...
FinalSolutionsError& FinalSolutionsError::operator=(
    const FinalSolutionsError& other_final_solutions_error) {
  if (this != &other_final_solutions_error) {
    *neural_network_pointer =
        *other_final_solutions_error.neural_network_pointer;
    *data_set_pointer = *other_final_solutions_error.data_set_pointer;
    *mathematical_model_pointer =
        *other_final_solutions_error.mathematical_model_pointer;
    *numerical_differentiation_pointer =
        *other_final_solutions_error.numerical_differentiation_pointer;
    display = other_final_solutions_error.display;

    final_solutions_errors_weights =
        other_final_solutions_error.final_solutions_errors_weights;
...
bool FinalSolutionsError::operator==(
    const FinalSolutionsError& other_final_solutions_error) const {
  if (*neural_network_pointer ==
      ...
      *numerical_differentiation_pointer ==
      ...
      final_solutions_errors_weights ==
          other_final_solutions_error.final_solutions_errors_weights &&
      target_final_solutions ==
          other_final_solutions_error.target_final_solutions) {
    return (true);
  } else {
    return (false);
  }
...
const Vector<double>& FinalSolutionsError::get_final_solutions_errors_weights(
    void) const {
...
const Vector<double>& FinalSolutionsError::get_target_final_solutions(
    void) const {
...
/// Sets the neural network and mathematical model pointers to NULL.
...
/// Sets this final solutions error object with the members from another object
/// of the same class.
/// @param other_final_solutions_error Final solutions error object to be
/// copied.

void FinalSolutionsError::set(
    const FinalSolutionsError& other_final_solutions_error) {
...
/// Associates this final solutions error object with a given mathematical model
/// object.
/// @param new_mathematical_model_pointer Pointer to a mathematical model
/// object.

void FinalSolutionsError::set_mathematical_model_pointer(
    MathematicalModel* new_mathematical_model_pointer) {
...
/// @param new_final_solutions_errors_weights Weight values. The size of this
/// vector must be equal to the nuber of dependent variables in the mathematical
/// model.

void FinalSolutionsError::set_final_solutions_errors_weights(
    const Vector<double>& new_final_solutions_errors_weights) {
  final_solutions_errors_weights = new_final_solutions_errors_weights;
}

// void set_final_solution_error_weight(const unsigned&, const double&) method

/// Sets a new weight value for a single error in the final solutions.
/// @param i Index of dependent variable.
/// @param new_final_solution_error_weight Weight value for the error of that
/// dependent variable.

void FinalSolutionsError::set_final_solution_error_weight(
    const unsigned& i, const double& new_final_solution_error_weight) {
...
/// @param new_target_final_solutions Desired final values. The size of this
/// vector must be equal to the number of dependent variables in the
/// mathematical model.

void FinalSolutionsError::set_target_final_solutions(
    const Vector<double>& new_target_final_solutions) {
  target_final_solutions = new_target_final_solutions;
}

// void set_target_final_solution(const unsigned& const double&) method

/// Sets the desired final state of a single dependent variable.
/// @param i Index of dependent variable.
/// @param new_target_final_solution Desired final value of that dependent
/// variable.

void FinalSolutionsError::set_target_final_solution(
    const unsigned& i, const double& new_target_final_solution) {
...
/// Checks that there are a neural network and a mathematical model associated
/// to the sum squared error,
/// and that the number of dependent variables in the mathematical model is
/// equal to the number of target final solutions in the performance term.
...
void FinalSolutionsError::check(void) const {
  ...
  const unsigned target_final_solutions_size = target_final_solutions.size();
  ...
  if (target_final_solutions_size != dependent_variables_number) {
    ...
    buffer << "OpenNN Exception: FinalSolutionsError class." << std::endl
           ...
           << "Size of target final solutions must be equal to number of "
              "dependent variables." << std::endl;
...
// Control sentence
  ...
  const Vector<double> final_solutions =
      mathematical_model_pointer->calculate_final_solutions(
          *neural_network_pointer);

  const Vector<double> dependent_variables_final_solutions =
      final_solutions.take_out(independent_variables_number,
                               dependent_variables_number);

  const Vector<double> final_solutions_errors =
      dependent_variables_final_solutions - target_final_solutions;

  return ((final_solutions_errors_weights * final_solutions_errors *
           final_solutions_errors).calculate_sum());
}
...
/// Returns a string with the name of the final solutions error performance
/// type, "FINAL_SOLUTIONS_ERROR".
...
std::string FinalSolutionsError::write_information(void) const {
  ...
  const double performance =
      (final_solutions_errors_weights * final_solutions_errors *
       final_solutions_errors).calculate_sum();
...
tinyxml2::XMLDocument* FinalSolutionsError::to_XML(void) const {
  ...
  tinyxml2::XMLElement* final_solutions_error_element =
      document->NewElement("FinalSolutionsError");
  ...
  {
    tinyxml2::XMLElement* element =
        document->NewElement("FinalSolutionsErrorsWeights");
    final_solutions_error_element->LinkEndChild(element);
...
void FinalSolutionsError::from_XML(const tinyxml2::XMLDocument& document) {
  const tinyxml2::XMLElement* root_element =
      document.FirstChildElement("FinalSolutionsError");
