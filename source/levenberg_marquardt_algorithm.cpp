...
/// Default constructor.
/// It creates a Levenberg-Marquardt training algorithm object not associated to
...
/// Performance functional constructor.
/// It creates a Levenberg-Marquardt training algorithm object associated
/// associated with a given performance functional object.
/// It also initializes the class members to their default values.
/// @param new_performance_functional_pointer Pointer to an external performance
/// functional object.
...
/// XML Constructor.
/// Creates a Levenberg-Marquardt algorithm object, and loads its members from a
/// XML document.
/// @param document TinyXML document containing the Levenberg-Marquardt
/// algorithm data.
...
const double& LevenbergMarquardtAlgorithm::get_warning_parameters_norm(
    void) const {
...
const double& LevenbergMarquardtAlgorithm::get_warning_gradient_norm(
    void) const {
...
const double& LevenbergMarquardtAlgorithm::get_error_parameters_norm(
    void) const {
...
const double&
LevenbergMarquardtAlgorithm::get_minimum_parameters_increment_norm(void) const {
...
const double& LevenbergMarquardtAlgorithm::get_minimum_performance_increase(
    void) const {
...
const unsigned&
LevenbergMarquardtAlgorithm::get_maximum_generalization_performance_decreases(
    void) const {
...
const unsigned& LevenbergMarquardtAlgorithm::get_maximum_iterations_number(
    void) const {
...
const bool& LevenbergMarquardtAlgorithm::get_reserve_parameters_history(
    void) const {
...
const bool& LevenbergMarquardtAlgorithm::get_reserve_parameters_norm_history(
    void) const {
...
const bool& LevenbergMarquardtAlgorithm::get_reserve_performance_history(
    void) const {
...
const bool& LevenbergMarquardtAlgorithm::get_reserve_gradient_history(
    void) const {
...
const bool& LevenbergMarquardtAlgorithm::get_reserve_gradient_norm_history(
    void) const {
...
const bool&
LevenbergMarquardtAlgorithm::get_reserve_Hessian_approximation_history(
    void) const {
...
const bool& LevenbergMarquardtAlgorithm::get_reserve_elapsed_time_history(
    void) const {
...
const bool&
LevenbergMarquardtAlgorithm::get_reserve_generalization_performance_history(
    void) const {
...
/// Returns the damping parameter factor (beta in the User's Guide) for the
/// Hessian approximation.

const double& LevenbergMarquardtAlgorithm::get_damping_parameter_factor(
    void) const {
...
const double& LevenbergMarquardtAlgorithm::get_minimum_damping_parameter(
    void) const {
...
const double& LevenbergMarquardtAlgorithm::get_maximum_damping_parameter(
    void) const {
...
/// Returns true if the damping parameter history vector is to be reserved, and
/// false otherwise.

const bool& LevenbergMarquardtAlgorithm::get_reserve_damping_parameter_history(
    void) const {
...
/// Returns a vector containing the damping parameter history over the training
/// iterations.

const Vector<double>&
LevenbergMarquardtAlgorithm::get_damping_parameter_history(void) const {
...
/// Sets a new damping parameter (lambda in the User's Guide) for the Hessian
/// approximation.
/// @param new_damping_parameter Damping parameter value.

void LevenbergMarquardtAlgorithm::set_damping_parameter(
    const double& new_damping_parameter) {
...
/// Sets a new damping parameter factor (beta in the User's Guide) for the
/// Hessian approximation.
/// @param new_damping_parameter_factor Damping parameter factor value.

void LevenbergMarquardtAlgorithm::set_damping_parameter_factor(
    const double& new_damping_parameter_factor) {
#ifndef NDEBUG
  ...
  if (new_damping_parameter_factor <= 0.0) {
    ...
    buffer << "OpenNN Exception: LevenbergMarquardtAlgorithm class."
           << std::endl
           << "void set_damping_parameter_factor(const double&) method."
           << std::endl << "Damping parameter factor must be greater than zero."
           << std::endl;
...
void LevenbergMarquardtAlgorithm::set_minimum_damping_parameter(
    const double& new_minimum_damping_parameter) {
#ifndef NDEBUG
  ...
  if (new_minimum_damping_parameter <= 0.0) {
    ...
    buffer
        ...
        << "void set_minimum_damping_parameter(const double&) method."
        << std::endl << "Minimum damping parameter must be greater than zero."
        << std::endl;
...
void LevenbergMarquardtAlgorithm::set_maximum_damping_parameter(
    const double& new_maximum_damping_parameter) {
#ifndef NDEBUG
  ...
  if (new_maximum_damping_parameter <= 0.0) {
    ...
    buffer
        << "OpenNN Exception: LevenbergMarquardtAlgorithm class." << std::endl
        << "void set_maximum_damping_parameter(const double&) method."
        << std::endl << "Maximum damping parameter must be greater than zero."
        << std::endl;
...
/// @param new_reserve_damping_parameter_history True if the damping parameter
/// history vector is to be reserved, false otherwise.

void LevenbergMarquardtAlgorithm::set_reserve_damping_parameter_history(
    const bool& new_reserve_damping_parameter_history) {
...
void LevenbergMarquardtAlgorithm::set_warning_parameters_norm(
...
void LevenbergMarquardtAlgorithm::set_warning_gradient_norm(
...
void LevenbergMarquardtAlgorithm::set_error_parameters_norm(
...
void LevenbergMarquardtAlgorithm::set_error_gradient_norm(
...
void LevenbergMarquardtAlgorithm::set_minimum_performance_increase(
...
void LevenbergMarquardtAlgorithm::set_performance_goal(
...
/// This is used as a stopping criterion when training a neural network.
/// @param new_gradient_norm_goal Goal value for the norm of the performance
/// function gradient.

void LevenbergMarquardtAlgorithm::set_gradient_norm_goal(
...
void
LevenbergMarquardtAlgorithm::set_maximum_generalization_performance_decreases(
...
void LevenbergMarquardtAlgorithm::set_maximum_iterations_number(
...
void LevenbergMarquardtAlgorithm::set_maximum_time(
    const double& new_maximum_time) {
// Control sentence (if debug)
...
void LevenbergMarquardtAlgorithm::set_reserve_parameters_history(
...
void LevenbergMarquardtAlgorithm::set_reserve_parameters_norm_history(
...
void LevenbergMarquardtAlgorithm::set_reserve_performance_history(
...
void LevenbergMarquardtAlgorithm::set_reserve_gradient_history(
...
void LevenbergMarquardtAlgorithm::set_reserve_gradient_norm_history(
...
/// Sets the history of the Hessian approximation to be reserved or not in
/// memory.
/// This is a vector of matrices.
/// @param new_reserve_Hessian_approximation_history True if the Hessian
/// approximation history is to be reserved, false otherwise.

void LevenbergMarquardtAlgorithm::set_reserve_Hessian_approximation_history(
    const bool& new_reserve_Hessian_approximation_history) {
  reserve_Hessian_approximation_history =
      new_reserve_Hessian_approximation_history;
}
...
void LevenbergMarquardtAlgorithm::set_reserve_elapsed_time_history(
...
void
LevenbergMarquardtAlgorithm::set_reserve_generalization_performance_history(
...
void LevenbergMarquardtAlgorithm::set_display_period(
...
/// <ul>
/// <li> The performance functional pointer associated to the training algorithm
/// is not NULL,
/// <li> The neural network associated to that performance functional is neither
/// NULL.
...
void LevenbergMarquardtAlgorithm::check(void) const {
  ...
  const DataSet* data_set_pointer =
      performance_functional_pointer->get_data_set_pointer();

  if (!data_set_pointer) {
    buffer << "OpenNN Exception: LevenbergMarquardtAlgorithm class."
           << std::endl << "void check(void) const method.\n"
...
/// Evaluates the performance function from the evaluation of the terms
/// function.
/// @param terms Vector of performance terms.

double LevenbergMarquardtAlgorithm::calculate_performance(
    const Vector<double>& terms) const {
...
/// Returns the exact gradient vector of the performance function as a function
/// of the terms vector and the terms Jacobian matrix.
...
Vector<double> LevenbergMarquardtAlgorithm::calculate_gradient(
    const Vector<double>& terms, const Matrix<double>& terms_Jacobian) const {
// Control sentence (if debug)
  ...
  if (columns_number != parameters_number) {
    buffer << "OpenNN Exception: LevenbergMarquardtAlgorithm class."
           << std::endl
           << "Vector<double> calculate_gradient(const Vector<double>&, const "
              "Matrix<double>&) const method." << std::endl
           << "Number of columns in terms Jacobian must be equal to number of "
              "parameters." << std::endl;
...
Matrix<double> LevenbergMarquardtAlgorithm::calculate_Hessian_approximation(
    const Matrix<double>& terms_Jacobian) const {
  // Control sentence (if debug)
  ...
  if (columns_number != parameters_number) {
    buffer << "OpenNN Exception: LevenbergMarquardtAlgorithm class."
           << std::endl
           << "Matrix<double> calculate_Hessian_approximation(const "
              "Matrix<double>&) const method." << std::endl
           << "Number of columns in terms Jacobian must be equal to number of "
              "parameters." << std::endl;
  ...
  return (terms_Jacobian.calculate_transpose().dot(terms_Jacobian) * 2.0 +
          identity * damping_parameter);
}
...
void LevenbergMarquardtAlgorithm::LevenbergMarquardtAlgorithmResults::
    resize_training_history(const unsigned& new_size) {
// Control sentence (if debug)
  ...
  if (Levenberg_Marquardt_algorithm_pointer
          ->get_reserve_Hessian_approximation_history()) {
    Hessian_approximation_history.resize(new_size);
  }

  if (Levenberg_Marquardt_algorithm_pointer
          ->get_reserve_damping_parameter_history()) {
...
/// Returns a string representation of the current Levenberg-Marquardt algorithm
/// results structure.

std::string
LevenbergMarquardtAlgorithm::LevenbergMarquardtAlgorithmResults::to_string(
    void) const {
  std::ostringstream buffer;
...
Matrix<std::string> LevenbergMarquardtAlgorithm::
    LevenbergMarquardtAlgorithmResults::write_final_results(
  ...
  const PerformanceFunctional* performance_functional_pointer =
      Levenberg_Marquardt_algorithm_pointer
...
LevenbergMarquardtAlgorithm::perform_training(void) {
  std::ostringstream buffer;
...
// Control sentence
  ...
  LevenbergMarquardtAlgorithmResults* results_pointer =
      new LevenbergMarquardtAlgorithmResults(this);
  ...
  for (unsigned iteration = 0; iteration <= maximum_iterations_number;
    ...
    performance = calculate_performance(
        terms);  //*performance_terms).calculate_sum()/2.0;
    ...
    JacobianT_dot_Jacobian =
        terms_Jacobian.calculate_transpose().dot(terms_Jacobian);

    do {
      Hessian_approximation =
          (JacobianT_dot_Jacobian + identity * damping_parameter);

      parameters_increment = gradient * (-1.0);

      LinearAlgebraicEquations::perform_Gauss_Jordan_elimination(
          Hessian_approximation, parameters_increment);

      const double new_performance =
          performance_functional_pointer->calculate_performance(
    ...
    if (reserve_Hessian_approximation_history) {
      results_pointer->Hessian_approximation_history[iteration] =
          Hessian_approximation;  // as computed by linear algebraic equations
                                  // object
    }
    ...
    if (parameters_increment_norm <= minimum_parameters_increment_norm) {
      if (display) {
        std::cout << "Iteration " << iteration
                  ...
                  << "Parameters increment norm: " << parameters_increment_norm
                  << std::endl;
      }
      ...
      if (display) {
        std::cout
            << "Iteration " << iteration << ": Minimum performance increase ("
            << minimum_performance_increase << ") reached.\n"
      ...
      if (display) {
        std::cout << "Iteration " << iteration
                  ...
                  << generalization_failures << std::endl;
      }
...
void LevenbergMarquardtAlgorithm::set_reserve_all_training_history(
    const bool&) {
...
std::string LevenbergMarquardtAlgorithm::write_training_algorithm_type(
    void) const {
...
tinyxml2::XMLDocument* LevenbergMarquardtAlgorithm::to_XML(void) const {
  ...
  tinyxml2::XMLElement* root_element =
      document->NewElement("LevenbergMarquardtAlgorithm");
...
void LevenbergMarquardtAlgorithm::from_XML(
    const tinyxml2::XMLDocument& document) {
  const tinyxml2::XMLElement* root_element =
      document.FirstChildElement("LevenbergMarquardtAlgorithm");
  ...
  const tinyxml2::XMLElement* damping_parameter_element =
      root_element->FirstChildElement("DampingParameter");

  if (damping_parameter_element) {
    const double new_damping_parameter =
        atof(damping_parameter_element->GetText());
  ...
  const tinyxml2::XMLElement* minimum_damping_parameter_element =
      root_element->FirstChildElement("MinimumDampingParameter");

  if (minimum_damping_parameter_element) {
    const double new_minimum_damping_parameter =
        atof(minimum_damping_parameter_element->GetText());
  ...
  const tinyxml2::XMLElement* maximum_damping_parameter_element =
      root_element->FirstChildElement("MaximumDampingParameter");

  if (maximum_damping_parameter_element) {
    const double new_maximum_damping_parameter =
        atof(maximum_damping_parameter_element->GetText());
  ...
  if (reserve_parameters_history_element) {
    std::string new_reserve_parameters_history =
  ...
  if (reserve_gradient_history_element) {
    std::string new_reserve_gradient_history =
