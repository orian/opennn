...
/// Default constructor.
/// It creates a quasi-Newton method training algorithm not associated to any
...
/// Performance functional constructor.
/// It creates a quasi-Newton method training algorithm associated to a
/// performance functional.
/// It also initializes the class members to their default values.
...
/// the quasi-Newton method object.

const TrainingRateAlgorithm& QuasiNewtonMethod::get_training_rate_algorithm(
    void) const {
...
/// Returns a pointer to the training rate algorithm object inside the
...
// const InverseHessianApproximationMethod&
// get_inverse_Hessian_approximation_method(void) const method

/// Returns the method for approximating the inverse Hessian matrix to be used
/// when training.

const QuasiNewtonMethod::InverseHessianApproximationMethod&
QuasiNewtonMethod::get_inverse_Hessian_approximation_method(void) const {
...
std::string QuasiNewtonMethod::write_inverse_Hessian_approximation_method(
    void) const {
  switch (inverse_Hessian_approximation_method) {
    ...
    default: {
      ...
      buffer << "OpenNN Exception: QuasiNewtonMethod class.\n"
             << "std::string write_inverse_Hessian_approximation_method(void) "
                "const method.\n"
...
const double& QuasiNewtonMethod::get_minimum_parameters_increment_norm(
    void) const {
...
const unsigned&
QuasiNewtonMethod::get_maximum_generalization_performance_decreases(
    void) const {
...
const bool& QuasiNewtonMethod::get_reserve_training_direction_history(
    void) const {
...
/// Returns true if the inverse Hessian history is to be reserved, and false
/// otherwise.
...
const bool& QuasiNewtonMethod::get_reserve_generalization_performance_history(
    void) const {
...
void QuasiNewtonMethod::set_performance_functional_pointer(
    PerformanceFunctional* new_performance_functional_pointer) {
...
// void set_inverse_Hessian_approximation_method(const
// InverseHessianApproximationMethod&) method

/// Sets a new inverse Hessian approximatation method value.
/// @param new_inverse_Hessian_approximation_method Inverse Hessian
...
/// Sets a new method for approximating the inverse of the Hessian matrix from a
...
/// <li> "BFGS"
/// </ul>
/// @param new_inverse_Hessian_approximation_method_name Name of inverse Hessian
/// approximation method.

void QuasiNewtonMethod::set_inverse_Hessian_approximation_method(
    const std::string& new_inverse_Hessian_approximation_method_name) {
...
void QuasiNewtonMethod::set_reserve_all_training_history(
...
void QuasiNewtonMethod::set_warning_parameters_norm(
...
void QuasiNewtonMethod::set_warning_gradient_norm(
...
void QuasiNewtonMethod::set_warning_training_rate(
...
void QuasiNewtonMethod::set_error_parameters_norm(
...
void QuasiNewtonMethod::set_error_gradient_norm(
...
void QuasiNewtonMethod::set_error_training_rate(
...
void QuasiNewtonMethod::set_minimum_parameters_increment_norm(
...
void QuasiNewtonMethod::set_minimum_performance_increase(
...
void QuasiNewtonMethod::set_performance_goal(
...
void QuasiNewtonMethod::set_gradient_norm_goal(
...
void QuasiNewtonMethod::set_maximum_generalization_performance_decreases(
...
void QuasiNewtonMethod::set_maximum_iterations_number(
...
void QuasiNewtonMethod::set_reserve_parameters_history(
...
void QuasiNewtonMethod::set_reserve_parameters_norm_history(
...
void QuasiNewtonMethod::set_reserve_performance_history(
...
void QuasiNewtonMethod::set_reserve_gradient_history(
...
void QuasiNewtonMethod::set_reserve_gradient_norm_history(
...
/// Sets the history of the inverse of the Hessian matrix to be reserved or not
/// in memory.
/// This is a vector of matrices.
/// @param new_reserve_inverse_Hessian_history True if the inverse Hessian
/// history is to be reserved, false otherwise.

void QuasiNewtonMethod::set_reserve_inverse_Hessian_history(
    const bool& new_reserve_inverse_Hessian_history) {
...
void QuasiNewtonMethod::set_reserve_training_direction_history(
...
void QuasiNewtonMethod::set_reserve_training_rate_history(
...
void QuasiNewtonMethod::set_reserve_elapsed_time_history(
...
void QuasiNewtonMethod::set_reserve_generalization_performance_history(
...
/// Calculates an approximation of the inverse Hessian, accoring to the method
/// used.
...
/// @param old_inverse_Hessian Inverse Hessian at the other point of the
/// objective function.
...
Matrix<double> QuasiNewtonMethod::calculate_inverse_Hessian_approximation(
  ...
  switch (inverse_Hessian_approximation_method) {
    case DFP: {
      return (calculate_DFP_inverse_Hessian(old_parameters, parameters,
                                            old_gradient, gradient,
                                            old_inverse_Hessian));
    } break;

    case BFGS: {
      return (calculate_BFGS_inverse_Hessian(old_parameters, parameters,
                                             old_gradient, gradient,
                                             old_inverse_Hessian));
    } break;
    ...
    default: {
      ...
      buffer
          << "OpenNN Exception: QuasiNewtonMethod class.\n"
          << "Vector<double> calculate_inverse_Hessian_approximation(const "
             "Vector<double>&, const Vector<double>&, const Vector<double>&, "
             "const Vector<double>&, const Matrix<double>&) method.\n"
          << "Unknown inverse Hessian approximation method.\n";
...
Vector<double> QuasiNewtonMethod::calculate_gradient_descent_training_direction(
...
// Matrix<double> calculate_DFP_inverse_Hessian(const Vector<double>&, const
// Vector<double>&, const Vector<double>&, const Vector<double>&, const
// Matrix<double>&) method
...
/// @param old_gradient The gradient of the objective function for that previous
/// set of parameters.
/// @param old_inverse_Hessian The Hessian of the objective function for that
/// previous set of parameters.
/// @param parameters Actual set of parameters.
/// @param gradient The gradient of the objective function for the actual set of
/// parameters.
...
// Control sentence (if debug)
  ...
  if (old_parameters_size != parameters_number) {
    buffer << "OpenNN Exception: QuasiNewtonMethod class.\n"
           << "Matrix<double> calculate_DFP_inverse_Hessian(const "
              "Vector<double>&, const Vector<double>&, const Vector<double>&, "
              "const Vector<double>&, const Matrix<double>&) method.\n"
           << "Size of old parameters vector must be equal to number of "
              "parameters.\n";
  ...
  if (old_gradient_size != parameters_number) {
    buffer << "OpenNN Exception: QuasiNewtonMethod class.\n"
           << "Matrix<double> calculate_DFP_inverse_Hessian(const "
              "Vector<double>&, const Vector<double>&, const Vector<double>&, "
              "const Vector<double>&, const Matrix<double>&) method.\n"
           << "Size of old gradient vector must be equal to number of "
              "parameters.\n";
  ...
  if (rows_number != parameters_number) {
    buffer << "OpenNN Exception: QuasiNewtonMethod class.\n"
           << "Matrix<double> calculate_DFP_inverse_Hessian(const "
              "Vector<double>&, const Vector<double>&, const Vector<double>&, "
              "const Vector<double>&, const Matrix<double>&) method.\n"
           << "Number of rows in old inverse Hessian must be equal to number "
              "of parameters.\n";
    ...
    buffer << "OpenNN Exception: QuasiNewtonMethod class.\n"
           << "Matrix<double> calculate_DFP_inverse_Hessian(const "
              "Vector<double>&, const Vector<double>&, const Vector<double>&, "
              "const Vector<double>&, const Matrix<double>&) method.\n"
           << "Number of columns in old inverse Hessian must be equal to "
  ...
  if (fabs(parameters_difference.dot(gradient_difference)) < 1.0e-50) {
    ...
    throw std::logic_error(buffer.str());
  } else if (fabs(gradient_difference.dot(old_inverse_Hessian)
  ...
  const Matrix<double> DFP_inverse_Hessian =
      old_inverse_Hessian +
      ...
      (old_inverse_Hessian.dot(gradient_difference))
              .direct(old_inverse_Hessian.dot(gradient_difference)) /
          gradient_difference.dot(old_inverse_Hessian).dot(gradient_difference);

  return (DFP_inverse_Hessian);
}

// Matrix<double> calculate_BFGS_inverse_Hessian(const Vector<double>&, const
// Vector<double>&, const Matrix<double>&, const Vector<double>&, const
...
// Control sentence (if debug)
  ...
  if (old_parameters_size != parameters_number) {
    buffer << "OpenNN Exception: QuasiNewtonMethod class.\n"
           << "Matrix<double> calculate_BFGS_inverse_Hessian(const "
              "Vector<double>&, const Vector<double>&, const Vector<double>&, "
              "const Vector<double>&, const Matrix<double>&) method.\n"
           << "Size of old parameters vector must be equal to number of "
              "parameters.\n";
  ...
  if (old_gradient_size != parameters_number) {
    buffer << "OpenNN Exception: QuasiNewtonMethod class.\n"
           << "Matrix<double> calculate_BFGS_inverse_Hessian(const "
              "Vector<double>&, const Vector<double>&, const Vector<double>&, "
              "const Vector<double>&, const Matrix<double>&) method."
           << std::endl << "Size of old gradient vector must be equal to "
                           "number of parameters.\n";
  ...
  if (gradient_size != parameters_number) {
    buffer
        ...
        << "Matrix<double> calculate_BFGS_inverse_Hessian(const "
           "Vector<double>&, const Vector<double>&, const Vector<double>&, "
           "const Vector<double>&, const Matrix<double>&) method." << std::endl
        << "Size of gradient vector must be equal to number of parameters.\n";
  ...
  const Vector<double> BFGS =
      parameters_difference / parameters_difference.dot(gradient_difference) -
      old_inverse_Hessian.dot(gradient_difference) /
          gradient_difference.dot(old_inverse_Hessian).dot(gradient_difference);

  // Calculate inverse Hessian approximation

  const Matrix<double> BFGS_inverse_Hessian =
      old_inverse_Hessian +
      parameters_difference.direct(parameters_difference) /
          parameters_difference.dot(gradient_difference) -
      (old_inverse_Hessian.dot(gradient_difference))
              .direct(gradient_difference.dot(old_inverse_Hessian)) /
          gradient_difference.dot(old_inverse_Hessian)
              .dot(gradient_difference) +
      (BFGS.direct(BFGS)) * (gradient_difference.dot(old_inverse_Hessian)
                                 .dot(gradient_difference));
...
void QuasiNewtonMethod::QuasiNewtonMethodResults::resize_training_history(
...
/// Returns a string representation of the current quasi-Newton method results
/// structure.
...
Matrix<std::string>
QuasiNewtonMethod::QuasiNewtonMethodResults::write_final_results(
  ...
  const PerformanceFunctional* performance_functional_pointer =
      quasi_Newton_method_pointer->get_performance_functional_pointer();
...
// Control sentence (if debug)
  ...
  QuasiNewtonMethodResults* results_pointer =
      new QuasiNewtonMethodResults(this);
  ...
  for (iteration = 0; iteration <= maximum_iterations_number; iteration++) {
    ...
    if (iteration == 0) {
      ...
      inverse_Hessian = calculate_inverse_Hessian_approximation(
          old_parameters, parameters, old_gradient, gradient,
          old_inverse_Hessian);
    }
    ...
    training_direction =
        calculate_training_direction(gradient, inverse_Hessian);
    ...
    if (iteration != 0 &&
      ...
      if (display) {
        std::cout << "Iteration " << iteration
                  ...
                  << "Performance increase: " << performance_increase
                  << std::endl;
      }
  ...
  if (display) {
    ...
    if (generalization_performance != 0) {
      std::cout << "Generalization performance: " << generalization_performance
                << std::endl;
    }
  }
...
/// the stopping criteria and other user stuff concerning the quasi-Newton
/// method object.
...
tinyxml2::XMLDocument* QuasiNewtonMethod::to_XML(void) const {
  ...
  tinyxml2::XMLElement* root_element =
      document->NewElement("QuasiNewtonMethod");
  ...
  // Inverse Hessian approximation method
  {
    ...
    text =
        document->NewText(write_inverse_Hessian_approximation_method().c_str());
...
Matrix<std::string> QuasiNewtonMethod::to_string_matrix(void) const {
  ...
  const std::string inverse_Hessian_approximation_method_string =
...
void QuasiNewtonMethod::from_XML(const tinyxml2::XMLDocument& document) {
  const tinyxml2::XMLElement* root_element =
      document.FirstChildElement("QuasiNewtonMethod");
  ...
  // Inverse Hessian approximation method
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("InverseHessianApproximationMethod");

    if (element) {
      const std::string new_inverse_Hessian_approximation_method =
          element->GetText();

      try {
        set_inverse_Hessian_approximation_method(
            new_inverse_Hessian_approximation_method);
      }
  ...
  // Training rate algorithm
  {
    ...
    if (element) {
      ...
      DeepClone(element_clone, element, &training_rate_algorithm_document,
                NULL);
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("ReserveInverseHessianHistory");

    if (element) {
      const std::string new_reserve_inverse_Hessian_history =
          element->GetText();

      try {
        set_reserve_inverse_Hessian_history(
            new_reserve_inverse_Hessian_history != "0");
      }
      catch (const std::logic_error & e) {
        std::cout << e.what() << std::endl;
      }
