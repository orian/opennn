...
/// This constructor also initializes the members of the object to their default
/// values.

IndependentParameters::IndependentParameters(void) { set(); }

// INDEPENDENT PARAMETERS NUMBER CONSTRUCTOR

/// Independent parameters constructor.
/// It creates a independent parameters object with a given number of
/// parameters.
...
IndependentParameters::IndependentParameters(
    const unsigned& new_parameters_number) {
...
/// @param other_independent_parameters Independent parameterse object to be
/// copied.

IndependentParameters::IndependentParameters(
    const IndependentParameters& other_independent_parameters) {
...
/// Assignment operator.
/// It assigns to this object the members of an existing independent parameters
/// object.
/// @param other_independent_parameters Independent parameters object to be
/// assigned.

IndependentParameters& IndependentParameters::operator=(
    const IndependentParameters& other_independent_parameters) {
...
bool IndependentParameters::operator==(
    const IndependentParameters& other_independent_parameters) const {
  if (parameters == other_independent_parameters.parameters &&
      ...
      upper_bounds == other_independent_parameters.upper_bounds &&
      scaling_method == other_independent_parameters.scaling_method &&
      display_range_warning ==
          other_independent_parameters.display_range_warning &&
      display == other_independent_parameters.display) {
    return (true);
  } else {
    return (false);
...
// double get_parameter(const unsigned&) const method

/// Returns the value of a single independent parameter.
/// @param index Index of independent parameter.

double IndependentParameters::get_parameter(const unsigned& index) const {
// Control sentence (if debug)

#ifndef NDEBUG

  const unsigned parameters_number = get_parameters_number();
  ...
  if (index >= parameters_number) {
    ...
    buffer << "OpenNN Exception: IndependentParameters class.\n"
           << "double get_parameter(const unsigned&) const method.\n"
           << "Index of independent parameter must be less than number of "
              "parameters.\n";
...
/// Such names are only used to give the user basic information about the
/// problem at hand.
...
/// Such name is only used to give the user basic information about the problem
/// at hand.
/// @param index Index of independent parameter.

const std::string& IndependentParameters::get_name(
...
/// Such units are only used to give the user basic information about the
/// problem at hand.
...
const std::string& IndependentParameters::get_unit(
    const unsigned& index) const {
// Control sentence (if debug)
...
/// Such descriptions are only used to give the user basic information about the
/// problem at hand.
...
/// Such description is only used to give the user basic information about the
/// problem at hand.
/// @param index Index of independent parameter.

const std::string& IndependentParameters::get_description(
    const unsigned& index) const {
// Control sentence (if debug)
...
/// Such values are to be used for scaling and unscaling independent parameters
...
// double get_minimum(const unsigned&) const method

/// Returns the minimum value of a single independent parameter.
/// Such value is to be used for scaling and unscaling that independent
/// parameter with the minimum and maximum method.
/// @param index Index of independent parameter.

double IndependentParameters::get_minimum(const unsigned& index) const {
// Control sentence (if debug)
...
// double get_maximum(const unsigned&) const method
...
double IndependentParameters::get_maximum(const unsigned& index) const {
// Control sentence (if debug)
...
// double get_mean(const unsigned&) const method

/// Returns the mean value of a single independent parameter.
/// Such a value is to be used for scaling and unscaling that parameter with the
/// mean and standard deviation method.
/// @param index Index of independent parameter.

double IndependentParameters::get_mean(const unsigned& index) const {
// Control sentence (if debug)
...
const Vector<double>& IndependentParameters::get_standard_deviations(
    void) const {
  return (standard_deviations);
}

// double get_standard_deviation(const unsigned&) const method
...
double IndependentParameters::get_standard_deviation(
    const unsigned& index) const {
// Control sentence (if debug)
...
/// The second element contains the maximum values of the independent
/// parameters.
/// Such values are to be used for scaling and unscaling independent parameters
/// with the minimum and maximum method.
...
/// Returns the mean and the standard deviation values of all the independent
/// parameters in a single matrix.
/// The first row contains the mean values of the independent parameters.
/// The second row contains the standard deviation values of the independent
/// parameters.
/// Such values are to be used for scaling and unscaling independent parameters
/// with the mean and standard deviation method.

Vector<Vector<double> >
IndependentParameters::arrange_means_standard_deviations(void) {
...
/// Returns a vector of vectors with the basic statistics of the independent
/// parameters
...
/// Returns the method used for scaling and unscaling the independent
/// parameters.

const IndependentParameters::ScalingMethod&
IndependentParameters::get_scaling_method(void) const {
  return (scaling_method);
}

// std::string write_scaling_method(void) const method

/// Returns a string with the method used for scaling and unscaling the
...
/// These values are used to postprocess the independent parameters so that they
/// are not less than the lower bounds.

const Vector<double>& IndependentParameters::get_lower_bounds(void) const {
  return (lower_bounds);
}

// double get_lower_bound(const unsigned&) const method

/// Returns the lower bound of a single independent parameter.
/// These values are used to postprocess that independent parameter so that it
/// is not less than the lower bound.
/// @param index Index of independent parameter.

double IndependentParameters::get_lower_bound(const unsigned& index) const {
// Control sentence (if debug)
...
/// These values are used to postprocess the independent parameters so that they
/// are not greater than the upper bounds.

const Vector<double>& IndependentParameters::get_upper_bounds(void) const {
  return (upper_bounds);
}

// double get_upper_bound(const unsigned&) const method
...
double IndependentParameters::get_upper_bound(const unsigned& index) const {
// Control sentence (if debug)
...
/// These values are used to postprocess the independent parameters so that they
/// are neither less than the lower
...
const IndependentParameters::BoundingMethod&
IndependentParameters::get_bounding_method(void) const {
  return (bounding_method);
}

// std::string write_bounding_method(void) const method

/// Returns a string with the method used for bounding the independent
/// parameters.
...
const bool& IndependentParameters::get_display(void) const { return (display); }
...
void IndependentParameters::set(const unsigned& new_parameters_number) {
...
void IndependentParameters::set(const Vector<double>& new_parameters) {
  const unsigned new_parameters_number = new_parameters.size();
...
// void set_parameters_number(const unsigned&) method

/// Sets a new number of independent parameters.
/// @param new_parameters_number Number of independent parameters.

void IndependentParameters::set_parameters_number(
    const unsigned& new_parameters_number) {
...
void IndependentParameters::set_parameters(
...
// void set_parameter(const unsigned&, const double&) method

/// Sets a new value for a single independent parameter.
/// @param index Index of independent parameter.
/// @param new_parameter Independent parameter value.

void IndependentParameters::set_parameter(const unsigned& index,
...
/// Such values are only used to give the user basic information on the problem
/// at hand.
...
/// Such a value is only used to give the user basic information on the problem
/// at hand.
/// @param index Index of independent parameter.
/// @param new_name New name for the independent parameter of index i.

void IndependentParameters::set_name(const unsigned& index,
...
/// at hand.
/// @param index Index of independent parameter.
/// @param new_unit New unit for the independent parameter with the previous
/// index.

void IndependentParameters::set_unit(const unsigned& index,
...
void IndependentParameters::set_descriptions(
    const Vector<std::string>& new_descriptions) {
// Control sentence (if debug)
...
/// at hand.
/// @param index Index of independent parameter.
/// @param new_description New description for the independent parameter with
/// the previous index.

void IndependentParameters::set_description(
    const unsigned& index, const std::string& new_description) {
  const unsigned parameters_number = get_parameters_number();
...
/// These values are used for scaling and unscaling the independent parameters
/// with the minimum and maximum method.
/// @param new_minimums New set of minimum values for the independent
/// parameters.
...
/// Such a value is used for scaling and unscaling that independent parameter
/// with the minimum and maximum method.
/// @param index Index of independent parameter.
/// @param new_minimum New minimum value for the independent parameter of index
/// i.

void IndependentParameters::set_minimum(const unsigned& index,
...
/// These values are used for scaling and unscaling the independent parameters
/// with the minimum and maximum method.
/// @param new_maximums New set of maximum values for the independent
/// parameters.
...
/// with the minimum and maximum method.
/// @param index Index of independent parameter.
/// @param new_maximum New maximum value for the independent parameter with the
/// previous index.

void IndependentParameters::set_maximum(const unsigned& index,
...
/// Such a value is used for scaling and unscaling the independent parameters
/// with the mean and standard deviation method.
/// @param index Index of independent parameter.
/// @param new_mean New mean value for the independent parameter with the
/// previous index.

void IndependentParameters::set_mean(const unsigned& index,
...
// Control sentence (if debug)
  ...
  const unsigned size = means.size();
...
/// These values are used for scaling and unscaling the independent parameters
/// with the mean and standard deviation method.
/// @param new_standard_deviations New set of standard deviation values for the
/// independent parameters.

void IndependentParameters::set_standard_deviations(
    const Vector<double>& new_standard_deviations) {
// Control sentence (if debug)
...
/// with the mean and standard deviation method.
/// @param index Index of independent parameter.
/// @param new_standard_deviation New standard deviation value for that
/// independent parameter.

void IndependentParameters::set_standard_deviation(
    const unsigned& index, const double& new_standard_deviation) {
  const unsigned parameters_number = get_parameters_number();
...
// Control sentence (if debug)
  ...
  const unsigned size = standard_deviations.size();
...
/// The first element must contain the minimum values values for the independent
/// parameters.
/// The second element must contain the maximum values for the independent
/// parameters.
/// These values are used for scaling and unscaling the independent parameters
/// with the minimum and maximum method.
/// @param new_minimums_maximums New set of minimum and maximum values for the
/// independent parameters.

void IndependentParameters::set_minimums_maximums(
    const Vector<Vector<double> >& new_minimums_maximums) {
// Control sentence (if debug)
  ...
  // Check that minimum of independent parameters is not greater than their
  // maximum

  for (unsigned i = 0; i < parameters_number; i++) {
...
/// Sets both the mean and the standard deviation values of all the independent
/// parameters.
/// The format is a vector of two real vectors.
/// The first element must contain the mean values values for the independent
/// parameters.
/// The second element must contain the standard deviation values for the
/// independent parameters.
/// These values are used for scaling and unscaling the independent parameters
/// with the mean and standard deviation method.
/// @param new_means_standard_deviations New set of mean and standard deviation
/// values for the independent parameters.

void IndependentParameters::set_means_standard_deviations(
    const Vector<Vector<double> >& new_means_standard_deviations) {
// Control sentence (if debug)
  ...
  const unsigned size = new_means_standard_deviations.size();
  ...
  if (display) {
    for (unsigned i = 0; i < parameters_number; i++) {
      if (new_means_standard_deviations[1][i] < 1.0e-99) {
        ...
        buffer << "OpenNN Exception: IndependentParameters class: \n"
               << "void set_means_standard_deviations(const Vector< "
...
void IndependentParameters::set_statistics(
    const Vector<Vector<double> >& new_statistics) {
// Control sentence (if debug)
...
/// Sets the method to be used for scaling and unscaling the independent
/// parameters.
/// @param new_scaling_method New scaling and unscaling method for the
/// independent parameters.
...
/// @param new_scaling_method Scaling and unscaling method for the independent
/// parameters.

void IndependentParameters::set_scaling_method(
    const std::string& new_scaling_method) {
  if (new_scaling_method == "NoScaling") {
    ...
    buffer << "OpenNN Exception: IndependentParameters class.\n"
           << "void set_scaling_method(const std::string&) method.\n"
           << "Unknown independent parameters scaling method: "
           << new_scaling_method << ".\n";
...
/// These values are used for unscaling the independent parameters so that they
/// are not less than the lower bounds.
/// @param new_lower_bounds New set of lower bounds for the independent
/// parameters.

void IndependentParameters::set_lower_bounds(
    const Vector<double>& new_lower_bounds) {
// Control sentence (if debug)
...
// void set_lower_bound(const unsigned&, const double&) method

/// Sets the lower bound of a single independent parameter.
/// Such a value is used for unscaling that independent parameter so that it is
/// not less than its lower bound.
/// @param index Index of independent parameter.
/// @param new_lower_bound New lower bound for that independent parameter.

void IndependentParameters::set_lower_bound(const unsigned& index,
...
/// Sets the vector of upper bounds for the independent parameters to have size
/// zero.
...
/// upper bounds.
/// @param new_upper_bounds New set of upper bounds for the independent
/// parameters.

void IndependentParameters::set_upper_bounds(
    const Vector<double>& new_upper_bounds) {
// Control sentence (if debug)
...
// void set_upper_bound(const unsigned&, const double&) method

/// Sets the upper bound of a single independent parameter.
/// Such a value is used for unscaling that independent parameter so that it is
/// not greater than its upper bound.
/// @param index Index of independent parameter.
/// @param new_upper_bound New upper bound for the independent parameter of
/// index i.

void IndependentParameters::set_upper_bound(const unsigned& index,
...
/// Sets the vectors of lower and upper bounds for the independent parameters to
/// have size zero.
...
/// The format is a vector of two real vectors.
/// The first element must contain the lower bound values values for the
/// independent parameters.
/// The second element must contain the upper bound values for the independent
/// parameters.
/// These values are used for unscaling the independent parameters so that they
/// are neither less than the
/// lower bounds nor greater than the upper bounds.
/// @param new_bounds New set of lower and upper bounds for the independent
/// parameters.

void IndependentParameters::set_bounds(
    const Vector<Vector<double> >& new_bounds) {
// Control sentence (if debug)
...
/// @param new_bounding_method New method for bounding the independent
/// parameters.
...
/// Sets the method to be used for bounding the independent parameters.
/// The argument is a string containing the name of the method ("NoBounding" or
/// "Bounding").
/// @param new_bounding_method Bounding method for the independent parameters.

void IndependentParameters::set_bounding_method(
    const std::string& new_bounding_method) {
...
/// Initializes the independent parameters with values comprised between -1 and
/// +1.
...
/// Initializes the independent parameters at random with values comprised
/// between a minimum and a maximum values.
...
/// comprised between different minimum and maximum numbers for each independent
/// parameter.
...
/// between different minimum and maximum numbers for each independent
/// parameter.
...
/// vectors.
/// The first element must contain the mean value for each independent
/// parameter.
/// The second element must contain the standard deviation value for each
/// independent parameter.
/// @param mean_standard_deviation Vector of mean and standard deviation
/// vectors.
...
void IndependentParameters::initialize_random(void) {
  const unsigned parameters_number = rand() % (rand() % (10 - 1)) + 1;
  ;
...
/// Preprocesses the independendent parameters according to their scaling and
/// unscaling method.
        ...
        if (maximums[i] - minimums[i] < 1.0e-99) {
          if (display) {
            std::cout << "OpenNN Warning: IndependentParameters class.\n"
                      << "Vector<double> calculate_scaled_parameters(void) "
                         "const method.\n"
          ...
          scaled_parameters[i] = 2.0 * (parameters[i] - minimums[i]) /
    ...
    case MeanStandardDeviation: {
      ...
      for (unsigned i = 0; i < parameters_number; i++) {
        if (standard_deviations[i] < 1.0e-99) {
          ...
          scaled_parameters[i] =
              (parameters[i] - means[i]) / standard_deviations[i];
        }
      }
...
/// Postprocesses the independendent parameters according to their scaling and
/// unscaling method.
/// This form of scaling is used when setting a new vector of parameters.

void IndependentParameters::unscale_parameters(
    const Vector<double>& scaled_parameters) {
  const unsigned parameters_number = get_parameters_number();
    ...
    case MeanStandardDeviation: {
      for (unsigned i = 0; i < parameters_number; i++) {
        if (standard_deviations[i] < 1e-99) {
          ...
          parameters[i] =
              means[i] + scaled_parameters[i] * standard_deviations[i];
        }
      }
    } break;
    ...
    case MinimumMaximum: {
      for (unsigned i = 0; i < parameters_number; i++) {
        if (maximums[i] - minimums[i] < 1e-99) {
          ...
          parameters[i] =
              0.5 * (scaled_parameters[i] + 1.0) * (maximums[i] - minimums[i]) +
              minimums[i];
        }
      }
    } break;
...
/// Makes the independent parameters to fall in the range defined by their lower
/// and the upper bounds.

void IndependentParameters::bound_parameters(void) {
  const unsigned parameters_number = get_parameters_number();

  const unsigned lower_bounds_size = lower_bounds.size();
  const unsigned upper_bounds_size = upper_bounds.size();

  if (lower_bounds_size == parameters_number &&
      upper_bounds_size == parameters_number) {
...
// void bound_parameter(const unsigned&) method

/// Makes a single independent parameter to fall in the range defined by its
/// lower and the upper bounds.
/// @param index Index of independent parameters.

void IndependentParameters::bound_parameter(const unsigned& index) {
...
/// Returns a string representation of the current independent parameters
/// object.
...
/// Serializes the independent parameters object into a XML document of the
/// TinyXML library.
...
tinyxml2::XMLDocument* IndependentParameters::to_XML(void) const {
  ...
  tinyxml2::XMLElement* independent_parameters_element =
  ...
  // Descriptions
  {
    tinyxml2::XMLElement* descriptions_element =
        document->NewElement("Descriptions");
...

  {
    ...
    tinyxml2::XMLText* text =
        document->NewText(write_bounding_method().c_str());
    element->LinkEndChild(text);
  }
...
void IndependentParameters::from_XML(const tinyxml2::XMLDocument& document) {
  int index = 0;  // unsigned does not work

  unsigned parameters_number = get_parameters_number();
  ...
  // Names
  {
    const tinyxml2::XMLElement* names_element =
        document.FirstChildElement("Names");

    if (names_element) {
      Vector<std::string> new_names(parameters_number);

      const tinyxml2::XMLElement* name_element =
          names_element->FirstChildElement("Name");
      ...
      if (name_element) {
        ...
        for (; name_element;
             name_element = name_element->NextSiblingElement()) {
          name_element->QueryIntAttribute("Index", &index);
  ...
  // Units
  {
    const tinyxml2::XMLElement* units_element =
        document.FirstChildElement("VariablesUnits");

    if (units_element) {
      Vector<std::string> new_units(parameters_number);

      const tinyxml2::XMLElement* variable_units_element =
          units_element->FirstChildElement("VariableUnits");
      ...
      if (variable_units_element) {
        ...
        for (; variable_units_element;
             variable_units_element =
                 variable_units_element->NextSiblingElement()) {
          variable_units_element->QueryIntAttribute("Index", &index);
  ...
  // Descriptions
  {
    const tinyxml2::XMLElement* descriptions_element =
        document.FirstChildElement("Descriptions");

    if (descriptions_element) {
      Vector<std::string> new_descriptions(parameters_number);

      const tinyxml2::XMLElement* variable_description_element =
          descriptions_element->FirstChildElement("Description");
      ...
      if (variable_description_element) {
        ...
        for (; variable_description_element;
             variable_description_element =
                 variable_description_element->NextSiblingElement()) {
          variable_description_element->QueryIntAttribute("Index", &index);

          if (variable_description_element->GetText()) {
            new_descriptions[index - 1] =
                variable_description_element->GetText();
          }
        }
      }
  ...
  // Minimums
  {
    const tinyxml2::XMLElement* minimums_element =
        document.FirstChildElement("Minimums");
  ...
  // Maximums
  {
    const tinyxml2::XMLElement* maximums_element =
        document.FirstChildElement("Maximums");
  ...
  // Means
  {
    const tinyxml2::XMLElement* means_element =
        document.FirstChildElement("Means");
  ...
  // Standard deviations
  {
    const tinyxml2::XMLElement* standard_deviations_element =
        document.FirstChildElement("StandardDeviations");

    if (standard_deviations_element) {
      const char* standard_deviations_text =
          standard_deviations_element->GetText();
  ...
  // Lower bounds
  {
    const tinyxml2::XMLElement* lower_bounds_element =
        document.FirstChildElement("LowerBounds");
  ...
  // Upper bounds
  {
    const tinyxml2::XMLElement* upper_bounds_element =
        document.FirstChildElement("UpperBounds");
