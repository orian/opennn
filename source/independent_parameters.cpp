...
IndependentParameters::IndependentParameters(const unsigned& new_parameters_number)
{
...
const std::string& IndependentParameters::get_name(const unsigned& index) const
{
   // Control sentence (if debug)
...
const std::string& IndependentParameters::get_unit(const unsigned& index) const
{
   // Control sentence (if debug)
...
const std::string& IndependentParameters::get_description(const unsigned& index) const
{
   // Control sentence (if debug)
...
double IndependentParameters::get_standard_deviation(const unsigned& index) const
{
   // Control sentence (if debug)
...
void IndependentParameters::set_parameters_number(const unsigned& new_parameters_number)
{
...
void IndependentParameters::set_parameter(const unsigned& index, const double& new_parameter)
{
   // Control sentence (if debug)
...
void IndependentParameters::set_name(const unsigned& index, const std::string& new_name)
{
   // Control sentence (if debug)
...
void IndependentParameters::set_unit(const unsigned& index, const std::string& new_unit)
{
   const unsigned parameters_number = get_parameters_number();
...
void IndependentParameters::set_description(const unsigned& index, const std::string& new_description)
{
   const unsigned parameters_number = get_parameters_number();
...
void IndependentParameters::set_minimum(const unsigned& index, const double& new_minimum)
{
   const unsigned parameters_number = get_parameters_number();
...
void IndependentParameters::set_maximum(const unsigned& index, const double& new_maximum)
{
   const unsigned parameters_number = get_parameters_number();
...
void IndependentParameters::set_mean(const unsigned& index, const double& new_mean)
{
   const unsigned parameters_number = get_parameters_number();
...
void IndependentParameters::set_standard_deviation(const unsigned& index, const double& new_standard_deviation)
{
   const unsigned parameters_number = get_parameters_number();
...
void IndependentParameters::set_lower_bound(const unsigned& index, const double& new_lower_bound)
{
   const unsigned parameters_number = get_parameters_number();
...
void IndependentParameters::set_upper_bound(const unsigned& index, const double& new_upper_bound)
{
   // Control sentence (if debug)
