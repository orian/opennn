...
/// Default constructor.
/// It creates a gradient descent training algorithm not associated to any
/// performance functional object.
/// It also initializes the class members to their default values.

GradientDescent::GradientDescent(void) : TrainingAlgorithm() { set_default(); }

// PERFORMANCE FUNCTIONAL CONSTRUCTOR

/// Performance functional constructor.
/// It creates a gradient descent training algorithm associated to a performance
/// functional.
/// It also initializes the class members to their default values.
...
/// @param document TinyXML document with the members of a gradient descent
/// object.

GradientDescent::GradientDescent(const tinyxml2::XMLDocument& document)
...
const TrainingRateAlgorithm& GradientDescent::get_training_rate_algorithm(
    void) const {
...
/// Returns a pointer to the training rate algorithm object inside the gradient
/// descent object.
...
const double& GradientDescent::get_minimum_parameters_increment_norm(
    void) const {
...
const unsigned&
GradientDescent::get_maximum_generalization_performance_decreases(void) const {
...
const unsigned& GradientDescent::get_maximum_iterations_number(void) const {
...
const bool& GradientDescent::get_reserve_training_direction_history(
    void) const {
...
const bool& GradientDescent::get_reserve_generalization_performance_history(
    void) const {
...
const unsigned& GradientDescent::get_display_period(void) const {
...
void GradientDescent::set_training_rate_algorithm(
    const TrainingRateAlgorithm& new_training_rate_algorithm) {
...
void GradientDescent::set_performance_functional_pointer(
    PerformanceFunctional* new_performance_functional_pointer) {
...
/// variables is to be reserved, false otherwise.

void GradientDescent::set_reserve_all_training_history(
...
void GradientDescent::set_warning_parameters_norm(
...
void GradientDescent::set_warning_gradient_norm(
...
void GradientDescent::set_warning_training_rate(
...
void GradientDescent::set_error_parameters_norm(
...
void GradientDescent::set_error_gradient_norm(
...
void GradientDescent::set_error_training_rate(
...
void GradientDescent::set_minimum_parameters_increment_norm(
...
void GradientDescent::set_minimum_performance_increase(
...
void GradientDescent::set_gradient_norm_goal(
...
void GradientDescent::set_maximum_generalization_performance_decreases(
...
void GradientDescent::set_maximum_iterations_number(
...
void GradientDescent::set_reserve_parameters_history(
...
void GradientDescent::set_reserve_parameters_norm_history(
...
void GradientDescent::set_reserve_performance_history(
...
void GradientDescent::set_reserve_gradient_history(
...
void GradientDescent::set_reserve_gradient_norm_history(
...
void GradientDescent::set_reserve_training_direction_history(
...
void GradientDescent::set_reserve_training_rate_history(
...
void GradientDescent::set_reserve_elapsed_time_history(
...
void GradientDescent::set_reserve_generalization_performance_history(
...
void GradientDescent::set_display_period(const unsigned& new_display_period) {
// Control sentence (if debug)
...
Vector<double> GradientDescent::calculate_training_direction(
...
Matrix<std::string>
GradientDescent::GradientDescentResults::write_final_results(
  ...
  const PerformanceFunctional* performance_functional_pointer =
      gradient_descent_pointer->get_performance_functional_pointer();
...
// void GradientDescentResults::resize_training_history(const unsigned&) method

/// Resizes the training history variables which are to be reserved by the
/// training algorithm.
/// @param new_size Size of training history variables.

void GradientDescent::GradientDescentResults::resize_training_history(
...
/// It returns a results structure with the history and the final values of the
/// reserved variables.
  ...
  for (unsigned iteration = 0; iteration <= maximum_iterations_number;
    ...
    if (iteration == 0) {
      initial_training_rate =
          first_training_rate;  // training_rate_algorithm.get_first_training_rate();
    } else {
...
/// Serializes the training parameters, the stopping criteria and other user
/// stuff
...
void GradientDescent::from_XML(const tinyxml2::XMLDocument& document) {
  const tinyxml2::XMLElement* root_element =
      document.FirstChildElement("GradientDescent");
