...
const unsigned& GradientDescent::get_maximum_generalization_performance_decreases(void) const
{
...
void GradientDescent::set_maximum_generalization_performance_decreases(const unsigned& new_maximum_generalization_performance_decreases)
{
...
void GradientDescent::set_maximum_iterations_number(const unsigned& new_maximum_iterations_number)
{
...
Matrix<std::string> GradientDescent::GradientDescentResults::write_final_results(const unsigned& precision) const
{
   std::ostringstream buffer;
...
void GradientDescent::GradientDescentResults::resize_training_history(const unsigned& new_size)
{
    // Control sentence (if debug)
