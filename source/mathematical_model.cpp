...
/// Default constructor.
/// It constructs a default mathematical model object, with zero independent and
/// dependent variables.
...
/// XML constructor.
/// It creates a mathematical model and loads its members from a TinyXML
/// document.
/// @param mathematical_model_document XML document containing the mathematical
/// model members.

MathematicalModel::MathematicalModel(
    const tinyxml2::XMLDocument& mathematical_model_document) {
  set_default();
...
/// Copy constructor.
/// It creates a mathematical model object and copies its members from another
/// object.
/// @param other_mathematical_model Mathematical model object to be copied.

MathematicalModel::MathematicalModel(
    const MathematicalModel& other_mathematical_model) {
...
/// Assignment operator.
/// It assigns to this object the members of an existing mathematical model
/// object.
/// @param other_mathematical_model Mathematical model object to be assigned.

MathematicalModel& MathematicalModel::operator=(
    const MathematicalModel& other_mathematical_model) {
  if (this != &other_mathematical_model) {
    independent_variables_number =
        other_mathematical_model.independent_variables_number;
    dependent_variables_number =
        other_mathematical_model.dependent_variables_number;
...
bool MathematicalModel::operator==(
    const MathematicalModel& other_mathematical_model) const {
  if (independent_variables_number ==
          other_mathematical_model.independent_variables_number &&
      dependent_variables_number ==
          other_mathematical_model.dependent_variables_number &&
      display == other_mathematical_model.display) {
...
// const unsigned& get_independent_variables_number(void) const method

/// Returns the number of independent variables in the mathematical model.

const unsigned& MathematicalModel::get_independent_variables_number(
    void) const {
  return (independent_variables_number);
}

// unsigned get_dependent_variables_number(void) const method

/// Returns the number of dependent variables in the mathematical model.

const unsigned& MathematicalModel::get_dependent_variables_number(void) const {
  return (dependent_variables_number);
}

// unsigned count_variables_number(void) const method
...
unsigned MathematicalModel::count_variables_number(void) const {
...
const bool& MathematicalModel::get_display(void) const { return (display); }

// void set(const MathematicalModel&) method

/// Sets the members of this mathematical model object with those from other
...
// void set_independent_variables_number(const unsigned&) method
...
void MathematicalModel::set_independent_variables_number(
    const unsigned& new_independent_variables_number) {
  independent_variables_number = new_independent_variables_number;
}

// void set_dependent_variables_number(const unsigned&) method
...
void MathematicalModel::set_dependent_variables_number(
    const unsigned& new_dependent_variables_number) {
...
Matrix<double> MathematicalModel::calculate_solutions(
    const NeuralNetwork&) const {
...
Vector<double> MathematicalModel::calculate_final_solutions(
    const NeuralNetwork&) const {
  std::ostringstream buffer;

  buffer << "OpenNN Exception: MathematicalModel class.\n"
         << "Vector<double> calculate_final_solutions(const NeuralNetwork&) "
            "const method.\n"
         << "This method has not been derived.\n";
...
// Matrix<double> calculate_dependent_variables(const NeuralNetwork&, const
// Matrix<double>&) const method

/// This virtual method returns the dependent variables solutions to the
/// mathematical model,
/// Needs to be derived, otherwise an exception is thrown.

Matrix<double> MathematicalModel::calculate_dependent_variables(
    const NeuralNetwork&, const Matrix<double>&) const {
  std::ostringstream buffer;

  buffer << "OpenNN Exception: MathematicalModel class.\n"
         << "Matrix<double> calculate_dependent_variables(const "
            "NeuralNetwork&, const Matrix<double>&) const method.\n"
         << "This method has not been derived.\n";
...
/// This method outputs to the console the string representation of the
/// mathematical model.

void MathematicalModel::print(void) const { std::cout << to_string(); }

// tinyxml2::XMLDocument* to_XML(void) const method

/// Serializes the mathematical model object into a XML document of the TinyXML
/// library.
...
tinyxml2::XMLDocument* MathematicalModel::to_XML(void) const {
  ...
  tinyxml2::XMLElement* mathematical_model_element =
      document->NewElement("MathematicalModel");
  ...
  // Independent variables number
  {
    ...
    mathematical_model_element->LinkEndChild(
        independent_variables_number_element);
  ...
  // Dependent variables number
  {
    ...
    mathematical_model_element->LinkEndChild(
        dependent_variables_number_element);
...
void MathematicalModel::from_XML(const tinyxml2::XMLDocument& document) {
  const tinyxml2::XMLElement* root_element =
      document.FirstChildElement("MathematicalModel");
  ...
  // Independent variables number
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("IndependentVariablesNumber");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("DependentVariablesNumber");
...
void MathematicalModel::save_data(const NeuralNetwork&,
                                  const std::string&) const {
  std::ostringstream buffer;

  buffer << "OpenNN Exception: MathematicalModel class.\n"
         << "void save_data(const NeuralNetwork&, const std::string&) const "
            "method.\n"
         << "This method has not been derived.\n";
