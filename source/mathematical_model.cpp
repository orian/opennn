...
const unsigned& MathematicalModel::get_independent_variables_number(void) const
{
...
void MathematicalModel::set_independent_variables_number(const unsigned& new_independent_variables_number)
{
...
void MathematicalModel::set_dependent_variables_number(const unsigned& new_dependent_variables_number)
{
