...
/// They are used to normalize variables so they are in an appropriate range for
/// computer processing.
...
class ScalingLayer {
 ...
 public:
  ...
  std::string write_no_scaling_expression(const Vector<std::string>&,
  ...
  std::string write_mean_standard_deviation_expression(
      const Vector<std::string>&, const Vector<std::string>&) const;
