...
class Vector : public std::vector<Type> {
 ...
 public:
  ...
  explicit Vector(const unsigned& new_size, const Type& value)
      : std::vector<Type>(new_size, value) {}
  ...
  explicit Vector(const Type& first, const double& step, const Type& last)
      : std::vector<Type>() {
    set(first, step, last);
  }
  ...
  /// Greater than or equal to than relational operator between this vector and
  /// a Type value.
  ...
  void set(const unsigned& new_size) { this->resize(new_size); }

  // void set(const unsigned&, const Type&) method

  /// Sets a new size to the vector and initializes all its elements with a
  /// given value.
  /// @param new_size Size for the vector.
  ...
  /// Depending on the starting, step and finishin values, this method can
  /// produce a variety of sizes and data.
  ...
  void set(const Vector& other_vector) { *this = other_vector; }
  ...
  /// Assigns a random value comprised between -1 and 1 to each element in the
  /// vector.
  ...
  /// Assigns a random value comprised between a minimum value and a maximum
...
// Control sentence (if debug)
  ...
  /// Assigns a random value comprised between given minimum and a maximum
  /// values to every element in the
  /// vector.
...
// Control sentence (if debug)
  ...
  /// Assigns random values to each element in the vector. These are taken from
...
// Control sentence (if debug)
  ...
  /// @param standard_deviation Standard deviation values of normal
  /// distributions.
...
// Control sentence (if debug)
    ...
    if (mean_size != this_size || standard_deviation_size != this_size) {
      ...
      buffer << "OpenNN Exception: Vector Template.\n"
             << "void randomize_normal(const Vector<double>&, const "
                "Vector<double>&) method.\n"
             << "Mean and standard deviation sizes must be equal to vector "
                "size.\n";
  ...
  /// Returns the number of times that a certain value is contained in the
  /// vector.
...
// Control sentence (if debug)
    ...
    if (bins_number < 1) {
      ...
      buffer << "OpenNN Exception: Vector Template.\n"
             << "Histogram<Type> calculate_histogram(const unsigned&) const "
                "method.\n"
...
// Control sentence (if debug)
  ...
  /// Returns the minimum, maximum, mean and the standard deviation of the
...
// Control sentence (if debug)
    ...
    if (p_norm == 0.0) {
      ...
      //       gradient = (*this)*(*this).calculate_pow(p-2.0)/pow(p_norm,
      // p-1.0);
    }
  ...
  /// Returns the distance between the elements of this vector and the elements
  /// of another vector.
...
// Control sentence (if debug)
    ...
    for (unsigned i = 0; i < this_size; i++) {
      sum_squared_error +=
          ((*this)[i] - other_vector[i]) * ((*this)[i] - other_vector[i]);
    }
  ...
  /// Returns the Minkowski squared error between the elements of this vector
  /// and the elements of another vector.
  /// @param other_vector Other vector.
  /// @param Minkowski_parameter Minkowski exponent.

  double calculate_Minkowski_error(const Vector<double>& other_vector,
                                   double Minkowski_parameter) const {
    const unsigned this_size = this->size();
...
// Control sentence (if debug)
    ...
    if (other_size != n) {
      buffer << "OpenNN Exception: Vector Template.\n"
             << "Type calculate_linear_correlation(const Vector<Type>&) const "
                "method.\n"
             << "Other size must be equal to this size.\n";
  ...
  // LinearRegressionParameters<Type>
  // calculate_linear_regression_parameters(const Vector<Type>&) const method
  ...
  LinearRegressionParameters<Type> calculate_linear_regression_parameters(
      const Vector<Type>& other) const {
    const unsigned n = this->size();
...
// Control sentence (if debug)
    ...
    if (other_size != n) {
      buffer << "OpenNN Exception: Vector Template.\n"
             << "LinearRegressionParameters<Type> "
                "calculate_linear_regression_parameters(const Vector<Type>&) "
                "const method.\n"
             << "Other size must be equal to this size.\n";
  ...
  /// Returns a vector with the bounded elements from below of the current
  /// vector.
  ...
  /// Returns a vector with the bounded elements from above of the current
  /// vector.
  /// @param lower_bound Lower bound values.
...
// Control sentence (if debug)
    ...
    if (lower_bound_size != this_size) {
      ...
      buffer << "OpenNN Exception: Vector Template.\n"
             << "Vector<Type> calculate_lower_bounded(const Vector<Type>&) "
                "const method.\n"
...
// Control sentence (if debug)
    ...
    if (upper_bound_size != this_size) {
      ...
      buffer << "OpenNN Exception: Vector Template.\n"
             << "Vector<Type> calculate_upper_bounded(const Vector<Type>&) "
                "const method.\n"
  ...
  Vector<Type> calculate_lower_upper_bounded(const Type& lower_bound,
                                             const Type& upper_bound) const {
    const unsigned this_size = this->size();
  ...
  // Vector<Type> calculate_lower_upper_bounded(const Vector<Type>&, const
  // Vector<Type>&) const method
  ...
  Vector<Type> calculate_lower_upper_bounded(
      const Vector<Type>& lower_bound, const Vector<Type>& upper_bound) const {
    const unsigned this_size = this->size();
...
// Control sentence (if debug)
    ...
    if (lower_bound_size != this_size || upper_bound_size != this_size) {
      ...
      buffer << "OpenNN Exception: Vector Template.\n"
             << "Vector<Type> calculate_lower_upper_bounded(const "
                "Vector<Type>&, const Vector<Type>&) const method.\n"
  ...
  void apply_lower_upper_bounds(const Type& lower_bound,
  ...
  void apply_lower_upper_bounds(const Vector<Type>& lower_bound,
...
// Control sentence (if debug)
  ...
  /// Normalizes the elements of this vector using the minimum and maximum
  /// method.
  ...
  /// Normalizes the elements of this vector using the mean and standard
  /// deviation method.
  /// @param mean Mean value for the scaling.
  /// @param standard_deviation Standard deviation value for the scaling.

  void scale_mean_standard_deviation(const Type& mean,
                                     const Type& standard_deviation) {
  ...
  void scale_mean_standard_deviation(const Statistics<Type>& statistics) {
    scale_mean_standard_deviation(statistics.mean,
  ...
  /// The size of the minimum and maximum vectors must be equal to the size of
  /// the vector.
  /// @param minimum Minimum values.
  /// @param maximum Maximum values.

  void scale_minimum_maximum(const Vector<Type>& minimum,
    ...
    if (minimum_size != this_size) {
      ...
      buffer << "OpenNN Exception: Vector template."
             << "void scale_minimum_maximum(const Vector<Type>&, const "
                "Vector<Type>&) method.\n"
  ...
  // void scale_mean_standard_deviation(const Vector<Type>&, const
  // Vector<Type>&) method
  ...
  void scale_mean_standard_deviation(const Vector<Type>& mean,
    ...
    for (unsigned i = 0; i < this_size; i++) {
      if (standard_deviation[i] < 1e-99) {
        std::cout << "OpenNN Warning: Vector class.\n"
                  << "void scale_mean_standard_deviation(const Vector<Type>&, "
                     "const Vector<Type>&) method.\n"
  ...
  // Vector<Type> calculate_scaled_minimum_maximum(const Vector<Type>&, const
  // Vector<Type>&) const method
  ...
  Vector<Type> calculate_scaled_minimum_maximum(
      const Vector<Type>& minimum, const Vector<Type>& maximum) const {
    const unsigned this_size = this->size();
    ...
    if (minimum_size != this_size) {
      ...
      buffer << "OpenNN Exception: Vector template."
             << "Vector<Type> calculate_scaled_minimum_maximum(const "
                "Vector<Type>&, const Vector<Type>&) const method.\n"
             << "Size of minimum vector must be equal to size.\n";
  ...
  // Vector<Type> calculate_scaled_mean_standard_deviation(const Vector<Type>&,
  // const Vector<Type>&) const method
  ...
  Vector<Type> calculate_scaled_mean_standard_deviation(
      const Vector<Type>& mean, const Vector<Type>& standard_deviation) const {
    const unsigned this_size = this->size();
    ...
    if (mean_size != this_size) {
      buffer << "OpenNN Exception: Vector template."
             << "Vector<Type> calculate_scaled_mean_standard_deviation(const "
                "Vector<Type>&, const Vector<Type>&) const method.\n"
             << "Size of mean vector must be equal to size.\n";
  ...
  // Vector<Type> calculate_unscaled_minimum_maximum(const Vector<Type>&, const
  // Vector<Type>&) const method
  ...
  Vector<Type> calculate_unscaled_minimum_maximum(
      const Vector<Type>& minimum, const Vector<Type>& maximum) const {
    const unsigned this_size = this->size();
    ...
    if (minimum_size != this_size) {
      ...
      buffer << "OpenNN Exception: Vector template."
             << "Vector<Type> calculate_unscaled_minimum_maximum(const "
                "Vector<Type>&, const Vector<Type>&) const method.\n"
             << "Size of minimum vector must be equal to size.\n";
  ...
  // Vector<Type> calculate_unscaled_mean_standard_deviation(const
  // Vector<Type>&, const Vector<Type>&) const method
  ...
  Vector<Type> calculate_unscaled_mean_standard_deviation(
      const Vector<Type>& mean, const Vector<Type>& standard_deviation) const {
    const unsigned this_size = this->size();
  ...
  // void unscale_minimum_maximum(const Vector<Type>&, const Vector<Type>&)
  // method
  ...
  void unscale_minimum_maximum(const Vector<Type>& minimum,
                               const Vector<Type>& maximum) {
    const unsigned this_size = this->size();
    ...
    if (minimum_size != this_size) {
      ...
      buffer << "OpenNN Exception: Vector template."
             << "void unscale_minimum_maximum(const Vector<Type>&, const "
                "Vector<Type>&) method.\n"
             << "Size of minimum vector must be equal to size.\n";
  ...
  // void unscale_mean_standard_deviation(const Vector<Type>&, const
  // Vector<Type>&) method

  /// Unscales the vector elements with given mean and standard deviation
  /// values.
  /// It updates the vector elements.
  /// The size of the mean and standard deviation vectors must be equal to the
  /// size of the vector.
  ...
  void unscale_mean_standard_deviation(const Vector<Type>& mean,
                                       const Vector<Type>& standard_deviation) {
    const unsigned this_size = this->size();
    ...
    if (mean_size != this_size) {
      ...
      buffer << "OpenNN Exception: Vector template."
             << "void unscale_mean_standard_deviation(const Vector<Type>&, "
                "const Vector<Type>&) method.\n"
             << "Size of mean vector must be equal to size.\n";
    ...
    for (unsigned i = 0; i < this_size; i++) {
      if (standard_deviation[i] < 1e-99) {
        std::cout << "OpenNN Warning: Vector template.\n"
                  << "void unscale_mean_standard_deviation(const "
                     "Vector<Type>&, const Vector<Type>&) method.\n"
                  << "Standard deviation of variable " << i << " is zero.\n"
                  << "Those elements won't be scaled.\n";
  ...
  /// Returns a squared matrix in which the entries outside the main diagonal
  /// are all zero.
...
// Control sentence (if debug)
    ...
    for (unsigned i = 0; i < new_size; i++) {
      if (indices[i] > this_size) {
        ...
        buffer << "OpenNN Exception: Vector Template.\n"
               << "Vector<Type> arrange_subvector(const Vector<Type>&) const "
                  "method.\n"
...
// Control sentence (if debug)
    ...
    if (position + other_size > this_size) {
      ...
      buffer << "OpenNN Exception: Vector Template.\n"
             << "void tuck_in(const unsigned&, const Vector<Type>&) const "
                "method.\n"
  ...
  Vector<Type> take_out(const unsigned& position,
                        const unsigned& other_size) const {
// Control sentence (if debug)
  ...
  /// Returns a new vector which is a copy of this vector but with a given
  /// element removed.
  /// Therefore, the size of the new vector is the size of this vector minus
  /// one.
...
// Control sentence (if debug)
  ...
  /// vector and elements equal to string representations of the elements of
  /// this vector.
  ...
  /// The number of rows multiplied by the number of columns must be equal to
  /// the size of this vector.
  /// @param rows_number Number of rows in the new matrix.
  /// @param columns_number Number of columns in the new matrix.

  Matrix<Type> to_matrix(const unsigned& rows_number,
                         const unsigned& columns_number) const {
// Control sentence (if debug)
    ...
    if (rows_number * columns_number != this_size) {
      ...
      buffer << "OpenNN Exception: Vector Template.\n"
             << "Matrix<Type> to_matrix(const unsigned&, const unsigned&) "
                "method.\n"
...
inline double calculate_random_uniform(const double& minimum,
...
inline double calculate_random_normal(const double& mean,
  ...
  const double random_normal =
      mean + sqrt(-2.0 * log(random_uniform_1)) *
                 sin(2.0 * pi * random_uniform_2) * standard_deviation;

  return (random_normal);
}

/// This template defines the most important statistic results of a set,
/// function, etc.
...
struct Statistics {
  ...
  Statistics(const Type& new_minimum, const Type& new_maximum,
  ...
  void set_minimum(const double& new_minimum) { minimum = new_minimum; }

  /// Sets a new maximum value in the statistics structure.
  /// @param new_maximum Maximum value.

  void set_maximum(const double& new_maximum) { maximum = new_maximum; }

  /// Sets a new mean value in the statistics structure.
  /// @param new_mean Mean value.

  void set_mean(const double& new_mean) { mean = new_mean; }
  ...
  /// The elements correspond to the minimum, maximum, mean and standard
...
struct Histogram {
  ...
  Histogram(const Vector<Type>& new_centers,
            const Vector<unsigned>& new_frequencies) {
    centers = new_centers;
  ...
  unsigned get_bins_number(void) const { return (centers.size()); }
  ...
  Vector<Type> calculate_maximal_centers(void) const {
    ...
    const Vector<unsigned> maximal_indices =
...
std::ostream& operator<<(
    std::ostream& os,
    const LinearRegressionParameters<Type>& linear_regression_parameters) {
