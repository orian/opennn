...
void UnscalingLayer::set_item_statistics(const unsigned& i, const Statistics<double>& item_statistics)
{
...
void UnscalingLayer::set_standard_deviation(const unsigned& i, const double& new_standard_deviation)
{
...
void UnscalingLayer::from_XML(const tinyxml2::XMLDocument& document)
{
  ...
  const unsigned unscaling_neurons_number = atoi(unscaling_neurons_number_element->GetText());
