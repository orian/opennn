...
/// Default constructor.
/// It creates a Newton method training algorithm object not associated to any
/// performance functional object.
/// It also initializes the class members to their default values.

NewtonMethod::NewtonMethod(void) : TrainingAlgorithm() { set_default(); }

// PERFORMANCE FUNCTIONAL CONSTRUCTOR

/// General constructor.
/// It creates a Newton method training algorithm object associated to a
/// performance functional object.
/// It also initializes the class members to their default values.
...
/// @param document Pointer to a TinyXML document containing the Newton method
/// data.
...
/// the Newton method object.

const TrainingRateAlgorithm& NewtonMethod::get_training_rate_algorithm(
    void) const {
...
/// Returns a pointer to the training rate algorithm object inside the Newton
/// method object.
...
const unsigned& NewtonMethod::get_maximum_generalization_performance_decreases(
    void) const {
...
const unsigned& NewtonMethod::get_maximum_iterations_number(void) const {
...
/// Returns true if the inverse Hessian history vector of matrices is to be
...
const bool& NewtonMethod::get_reserve_generalization_performance_history(
    void) const {
...
const unsigned& NewtonMethod::get_display_period(void) const {
...
void NewtonMethod::set_performance_functional_pointer(
    PerformanceFunctional* new_performance_functional_pointer) {
...
void NewtonMethod::set_warning_parameters_norm(
...
void NewtonMethod::set_warning_gradient_norm(
...
void NewtonMethod::set_warning_training_rate(
...
void NewtonMethod::set_error_parameters_norm(
...
void NewtonMethod::set_error_gradient_norm(
...
void NewtonMethod::set_error_training_rate(
...
void NewtonMethod::set_minimum_parameters_increment_norm(
...
void NewtonMethod::set_minimum_performance_increase(
...
void NewtonMethod::set_gradient_norm_goal(
...
void NewtonMethod::set_maximum_generalization_performance_decreases(
...
void NewtonMethod::set_maximum_iterations_number(
...
void NewtonMethod::set_reserve_parameters_history(
...
void NewtonMethod::set_reserve_parameters_norm_history(
...
void NewtonMethod::set_reserve_performance_history(
...
void NewtonMethod::set_reserve_gradient_history(
...
void NewtonMethod::set_reserve_gradient_norm_history(
...
void NewtonMethod::set_reserve_inverse_Hessian_history(
...
void NewtonMethod::set_reserve_training_direction_history(
...
void NewtonMethod::set_reserve_training_rate_history(
...
void NewtonMethod::set_reserve_elapsed_time_history(
...
void NewtonMethod::set_reserve_generalization_performance_history(
...
void NewtonMethod::set_display_period(const unsigned& new_display_period) {
// Control sentence (if debug)
...
Vector<double> NewtonMethod::calculate_gradient_descent_training_direction(
...
/// Returns the Newton method training direction, which has been previously
/// normalized.
/// @param gradient Gradient vector.
...
Vector<double> NewtonMethod::calculate_training_direction(
    ...
    const Matrix<double>& inverse_Hessian) const {
  const Vector<double> training_direction =
      inverse_Hessian.dot(gradient) * (-1.0);
...
void NewtonMethod::NewtonMethodResults::resize_training_history(
...
/// Returns a string representation of the current Newton method results
/// structure.
...
Matrix<std::string> NewtonMethod::NewtonMethodResults::write_final_results(
  ...
  const PerformanceFunctional* performance_functional_pointer =
      Newton_method_pointer->get_performance_functional_pointer();
...
/// to the Newton method algorithm.
/// Training occurs according to the training operators, the training parameters
...
NewtonMethod::NewtonMethodResults* NewtonMethod::perform_training(void) {
  ...
  /*
     ...
     NewtonMethodResults* Newton_method_results_pointer = new
  NewtonMethodResults(this);
  ...
  performance_functional_pointer->calculate_generalization_performance();
        ...
        {
           generalization_performance_increment = generalization_performance -
  old_generalization_performance;
        }
  ...
  inverse_Hessian);
        ...
        if(training_slope >= 0.0)
        {
           if(display)
     {
      std::cout << "Iteration " << iteration << ": Training slope is greater
  than zero. Reseting training direction.\n";
     }
  ...
  //	  directional_point = calculate_directional_point(performance,
  training_direction, initial_training_rate);
     ...
     training_rate = directional_point[0];
        ...
        {
           Newton_method_results_pointer->parameters_history[iteration] =
  parameters;                                
        }
  
        if(reserve_parameters_norm_history)
        {
           Newton_method_results_pointer->parameters_norm_history[iteration] =
  parameters_norm; 
        }
        ...
        {
           Newton_method_results_pointer->performance_history[iteration] =
  performance;
        }
  
        if(reserve_generalization_performance_history)
        {
           Newton_method_results_pointer->generalization_performance_history[iteration]
  = generalization_performance;
        }
  
        if(reserve_gradient_history)
        {
           Newton_method_results_pointer->gradient_history[iteration] =
  gradient;                                
        }
  
        if(reserve_gradient_norm_history)
        {
           Newton_method_results_pointer->gradient_norm_history[iteration] =
  gradient_norm;
        }
  
        if(reserve_inverse_Hessian_history)
        {
           Newton_method_results_pointer->inverse_Hessian_history[iteration] =
  inverse_Hessian;
        }
        ...
        {
           Newton_method_results_pointer->training_direction_history[iteration]
  = training_direction;                                
        }
  
        if(reserve_training_rate_history)
        {
           Newton_method_results_pointer->training_rate_history[iteration] =
  training_rate;
        }
  
        if(reserve_elapsed_time_history)
        {
           Newton_method_results_pointer->elapsed_time_history[iteration] =
  elapsed_time;
        }
     ...
     // Stopping Criteria
        ...
        if(parameters_increment_norm <= minimum_parameters_increment_norm)
        {
           if(display)
           {
              std::cout << "Iteration " << iteration << ": Minimum parameters
  increment norm reached.\n"
  ...
  std::endl;
        ...
        else if(performance <= performance_goal)
        {
           if(display)
           {
              std::cout << "Iteration " << iteration << ": Performance goal
  reached.\n";
           }
        ...
        else if(iteration != 0 && performance_increase <=
  minimum_performance_increase)
        {
           if(display)
           {
              std::cout << "Iteration " << iteration << ": Minimum performance
  increase reached.\n"
                        << "Performance improvement: " << performance_increase
  << std::endl;
           }
        ...
        else if(iteration != 0 && generalization_performance_increment < 0.0)
        {
           if(display)
           {
              std::cout << "Iteration " << iteration << ": Generalization
  performance stopped improving.\n";
              std::cout << "Generalization performance increment: "<<
  generalization_performance_increment << std::endl;
           }
        ...
        else if(gradient_norm <= gradient_norm_goal)
        {
           if(display)
           {
              std::cout << "Iteration " << iteration << ": Gradient norm goal
  reached.\n";  
           }
        ...
        if(iteration == maximum_iterations_number)
        {
           if(display)
           {
              std::cout << "Iteration " << iteration << ": Maximum number of
  iterations reached.\n";
           }
        ...
        else if(elapsed_time >= maximum_time)
        {
           if(display)
           {
              std::cout << "Iteration " << iteration << ": Maximum training time
  reached.\n";
           }
...
void NewtonMethod::from_XML(const tinyxml2::XMLDocument& document) {
  const tinyxml2::XMLElement* root_element =
      document.FirstChildElement("NewtonMethod");
...
void NewtonMethod::set_reserve_all_training_history(
