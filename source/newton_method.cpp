...
const unsigned& NewtonMethod::get_maximum_generalization_performance_decreases(void) const
{
...
void NewtonMethod::set_maximum_generalization_performance_decreases(const unsigned& new_maximum_generalization_performance_decreases)
{
...
void NewtonMethod::set_maximum_iterations_number(const unsigned& new_maximum_iterations_number)
{
...
{
   const Vector<double> training_direction = inverse_Hessian.dot(gradient)*(-1.0);
...
void NewtonMethod::NewtonMethodResults::resize_training_history(const unsigned& new_size)
{
    // Control sentence (if debug)
...
// Matrix<std::string> write_final_results(const unsigned& precision = 3) const method

Matrix<std::string> NewtonMethod::NewtonMethodResults::write_final_results(const unsigned& precision) const
{
   std::ostringstream buffer;
