...
/// Default constructor.
/// It creates a conjugate gradient training algorithm object not associated to
/// any performance functional object.
...
/// General constructor.
/// It creates a conjugate gradient training algorithm associated to a
/// performance functional object.
/// It also initializes the rest of class members to their default values.
/// @param new_performance_functional_pointer Pointer to a performance
/// functional object.

ConjugateGradient::ConjugateGradient(
    PerformanceFunctional* new_performance_functional_pointer)
    : TrainingAlgorithm(new_performance_functional_pointer) {
  training_rate_algorithm.set_performance_functional_pointer(
      new_performance_functional_pointer);
...
/// XML constructor.
/// It creates a conjugate gradient training algorithm not associated to any
/// performance functional object.
/// It also loads the class members from a XML document.
/// @param conjugate_gradient_document TinyXML document with the members of a
...
/// Returns a constant reference to the training rate algorithm object inside
/// the conjugate gradient method object.

const TrainingRateAlgorithm& ConjugateGradient::get_training_rate_algorithm(
    void) const {
...
/// Returns a pointer to the training rate algorithm object inside the conjugate
/// gradient method object.
...
const ConjugateGradient::TrainingDirectionMethod&
ConjugateGradient::get_training_direction_method(void) const {
...
/// Returns the minimum value for the norm of the parameters vector at wich a
/// warning message is written to the screen.
...
/// Returns the minimum value for the norm of the gradient vector at wich a
/// warning message is written to the screen.
...
/// Returns the training rate value at wich a warning message is written to the
/// screen during line minimization.
...
/// Returns the value for the norm of the parameters vector at wich an error
/// message is written to the screen and the program exits.
...
/// Returns the value for the norm of the gradient vector at wich an error
/// message is written
...
/// Returns the training rate value at wich the line minimization algorithm is
/// assumed to fail when
...
/// Returns the minimum norm of the parameter increment vector used as a
/// stopping criteria when training.

const double& ConjugateGradient::get_minimum_parameters_increment_norm(
    void) const {
...
/// Returns the maximum number of generalization failures during the training
/// process.

const unsigned&
ConjugateGradient::get_maximum_generalization_performance_decreases(
    void) const {
...
const unsigned& ConjugateGradient::get_maximum_iterations_number(void) const {
...
/// Returns true if the parameters history matrix is to be reserved, and false
/// otherwise.
...
/// Returns true if the parameters norm history vector is to be reserved, and
/// false otherwise.
...
/// Returns true if the performance history vector is to be reserved, and false
/// otherwise.

const bool& ConjugateGradient::get_reserve_performance_history(void) const {
  return (reserve_performance_history);
}

// const bool& get_reserve_gradient_history(void) const method

/// Returns true if the gradient history vector of vectors is to be reserved,
/// and false otherwise.
...
/// Returns true if the gradient norm history vector is to be reserved, and
/// false otherwise.
...
/// Returns true if the training direction history matrix is to be reserved, and
/// false otherwise.

const bool& ConjugateGradient::get_reserve_training_direction_history(
    void) const {
...
/// Returns true if the training rate history vector is to be reserved, and
/// false otherwise.
...
/// Returns true if the elapsed time history vector is to be reserved, and false
/// otherwise.
...
/// Returns true if the Generalization performance history vector is to be
/// reserved, and false otherwise.

const bool& ConjugateGradient::get_reserve_generalization_performance_history(
    void) const {
...
const unsigned& ConjugateGradient::get_display_period(void) const {
  return (display_period);
}

// void set_performance_functional_pointer(PerformanceFunctional*) method

/// Sets a pointer to a performance functional object to be associated to the
/// conjugate gradient object.
/// It also sets that performance functional to the training rate algorithm.
/// @param new_performance_functional_pointer Pointer to a performance
/// functional object.

void ConjugateGradient::set_performance_functional_pointer(
    PerformanceFunctional* new_performance_functional_pointer) {
...
/// <li> "FR"
/// </ul>
/// @param new_training_direction_method_name String with the name of the
/// training direction method.

void ConjugateGradient::set_training_direction_method(
    const std::string& new_training_direction_method_name) {
  if (new_training_direction_method_name == "PR") {
    ...
    buffer << "OpenNN Exception: ConjugateGradient class.\n"
           << "void set_training_direction_method(const std::string&) method.\n"
           << "Unknown training direction method: "
           << new_training_direction_method_name << ".\n";
...
/// Makes the training history of all variables to reseved or not in memory when
/// training.
/// <ul>
/// <li> Parameters.
/// <li> Parameters norm.
...
/// </ul>
///
/// @param new_reserve_all_training_history True if all training history
/// variables are to be reserved,
/// false otherwise.

void ConjugateGradient::set_reserve_all_training_history(
    const bool& new_reserve_all_training_history) {
...
/// Sets a new value for the parameters vector norm at which a warning message
/// is written to the
/// screen.
/// @param new_warning_parameters_norm Warning norm of parameters vector value.

void ConjugateGradient::set_warning_parameters_norm(
    const double& new_warning_parameters_norm) {
...
void ConjugateGradient::set_warning_gradient_norm(
    const double& new_warning_gradient_norm) {
// Control sentence (if debug)
...
/// Sets a new training rate value at wich a warning message is written to the
/// screen during line
/// minimization.
/// @param new_warning_training_rate Warning training rate value.

void ConjugateGradient::set_warning_training_rate(
    const double& new_warning_training_rate) {
// Control sentence (if debug)
...
/// Sets a new value for the parameters vector norm at which an error message is
/// written to the
/// screen and the program exits.
/// @param new_error_parameters_norm Error norm of parameters vector value.

void ConjugateGradient::set_error_parameters_norm(
    const double& new_error_parameters_norm) {
// Control sentence (if debug)
...
/// Sets a new value for the gradient vector norm at which an error message is
/// written to the screen
/// and the program exits.
/// @param new_error_gradient_norm Error norm of gradient vector value.

void ConjugateGradient::set_error_gradient_norm(
...
/// Sets a new training rate value at wich a the line minimization algorithm is
/// assumed to fail when
/// bracketing a minimum.
/// @param new_error_training_rate Error training rate value.

void ConjugateGradient::set_error_training_rate(
    const double& new_error_training_rate) {
// Control sentence (if debug)
...
/// Sets a new value for the minimum parameters increment norm stopping
/// criterion.
/// @param new_minimum_parameters_increment_norm Value of norm of parameters
/// increment norm used to stop training.

void ConjugateGradient::set_minimum_parameters_increment_norm(
...
// Control sentence (if debug)
  ...
  if (new_minimum_parameters_increment_norm < 0.0) {
    ...
    buffer
        ...
        << "Minimum parameters increment norm must be equal or greater than "
           "0.\n";
...
/// @param new_minimum_performance_increase Minimum improvement in the
/// performance between two iterations.

void ConjugateGradient::set_minimum_performance_increase(
    const double& new_minimum_performance_increase) {
// Control sentence (if debug)
...
void ConjugateGradient::set_performance_goal(
    const double& new_performance_goal) {
...
/// This is used as a stopping criterion when training a multilayer perceptron
/// @param new_gradient_norm_goal Goal value for the norm of the objective
/// function gradient.

void ConjugateGradient::set_gradient_norm_goal(
...
/// @param new_maximum_generalization_performance_decreases Maximum number of
/// iterations in which the generalization evalutation decreases.

void ConjugateGradient::set_maximum_generalization_performance_decreases(
    const unsigned& new_maximum_generalization_performance_decreases) {
  maximum_generalization_performance_decreases =
      new_maximum_generalization_performance_decreases;
}

// void set_maximum_iterations_number(unsigned) method

/// Sets a maximum number of iterations for training.
/// @param new_maximum_iterations_number Maximum number of iterations for
/// training.

void ConjugateGradient::set_maximum_iterations_number(
    const unsigned& new_maximum_iterations_number) {
...
/// Makes the parameters history vector of vectors to be reseved or not in
/// memory.
/// @param new_reserve_parameters_history True if the parameters history vector
/// of vectors is to be reserved, false otherwise.

void ConjugateGradient::set_reserve_parameters_history(
    const bool& new_reserve_parameters_history) {
...
/// @param new_reserve_parameters_norm_history True if the parameters norm
/// history vector is to be reserved, false otherwise.

void ConjugateGradient::set_reserve_parameters_norm_history(
    const bool& new_reserve_parameters_norm_history) {
...
/// @param new_reserve_performance_history True if the performance history
/// vector is to be reserved, false otherwise.

void ConjugateGradient::set_reserve_performance_history(
    const bool& new_reserve_performance_history) {
...
/// @param new_reserve_gradient_history True if the gradient history matrix is
/// to be reserved, false otherwise.

void ConjugateGradient::set_reserve_gradient_history(
    const bool& new_reserve_gradient_history) {
...
/// @param new_reserve_gradient_norm_history True if the gradient norm history
/// matrix is to be reserved, false
/// otherwise.

void ConjugateGradient::set_reserve_gradient_norm_history(
    const bool& new_reserve_gradient_norm_history) {
  reserve_gradient_norm_history = new_reserve_gradient_norm_history;
}

// void set_reserve_training_direction_history(bool) method

/// Makes the training direction history vector of vectors to be reseved or not
/// in memory.
/// @param new_reserve_training_direction_history True if the training direction
/// history matrix is to be reserved,
/// false otherwise.

void ConjugateGradient::set_reserve_training_direction_history(
    const bool& new_reserve_training_direction_history) {
...
/// @param new_reserve_training_rate_history True if the training rate history
/// vector is to be reserved, false
/// otherwise.

void ConjugateGradient::set_reserve_training_rate_history(
    const bool& new_reserve_training_rate_history) {
  reserve_training_rate_history = new_reserve_training_rate_history;
}

// void set_reserve_elapsed_time_history(bool) method

/// Makes the elapsed time over the iterations to be reseved or not in memory.
/// This is a vector.
/// @param new_reserve_elapsed_time_history True if the elapsed time history
/// vector is to be reserved, false
/// otherwise.

void ConjugateGradient::set_reserve_elapsed_time_history(
    const bool& new_reserve_elapsed_time_history) {
...
/// Makes the Generalization performance history to be reserved or not in
/// memory.
/// This is a vector.
/// @param new_reserve_generalization_performance_history True if the
/// Generalization performance history is to be reserved, false otherwise.

void ConjugateGradient::set_reserve_generalization_performance_history(
    const bool& new_reserve_generalization_performance_history) {
...
void ConjugateGradient::set_display_period(const unsigned& new_display_period) {
// Control sentence (if debug)
...
// double calculate_FR_parameter(const Vector<double>&, const Vector<double>&)
// const method

/// Returns the Fletcher-Reeves parameter used to calculate the training
/// direction.
///
/// @param old_gradient Previous objective function gradient.
/// @param gradient: Current objective function gradient.

double ConjugateGradient::calculate_FR_parameter(
    const Vector<double>& old_gradient, const Vector<double>& gradient) const {
// Control sentence (if debug)
  ...
  if (!performance_functional_pointer) {
    buffer << "OpenNN Exception: ConjugateGradient class.\n"
           << "double calculate_FR_parameter(const Vector<double>&, const "
  ...
  const NeuralNetwork* neural_network_pointer =
      performance_functional_pointer->get_neural_network_pointer();
  ...
  if (FR_parameter < 0.0) FR_parameter = 0.0;

  if (FR_parameter > 1.0) FR_parameter = 1.0;

  return (FR_parameter);
}

// double calculate_PR_parameter(const Vector<double>&, const Vector<double>&)
// const method

/// Returns the Polak-Ribiere parameter used to calculate the training
/// direction.
/// @param old_gradient Previous objective function gradient.
/// @param gradient Current objective function gradient.

double ConjugateGradient::calculate_PR_parameter(
    const Vector<double>& old_gradient, const Vector<double>& gradient) const {
// Control sentence (if debug)
  ...
  if (!performance_functional_pointer) {
    buffer << "OpenNN Exception: ConjugateGradient class.\n"
           << "double calculate_PR_parameter(const Vector<double>&, const "
              "Vector<double>&) const method.\n"
           << "Performance functional pointer is NULL.\n";
...
// Vector<double> calculate_PR_training_direction(const Vector<double>&, const
// Vector<double>&, const Vector<double>&) const method
...
Vector<double> ConjugateGradient::calculate_PR_training_direction(
    ...
    const Vector<double>& old_training_direction) const {
// Control sentence (if debug)
  ...
  if (!performance_functional_pointer) {
    buffer << "OpenNN Exception: ConjugateGradient class.\n"
           << "Vector<double> calculate_PR_training_direction(const "
  ...
  const unsigned old_training_direction_size = old_training_direction.size();
  ...
  const Vector<double> gradient_descent_term =
      calculate_gradient_descent_training_direction(gradient);
  const Vector<double> conjugate_direction_term =
      old_training_direction * PR_parameter;

  const Vector<double> PR_training_direction =
      gradient_descent_term + conjugate_direction_term;

  const double PR_training_direction_norm =
      PR_training_direction.calculate_norm();

  return (PR_training_direction / PR_training_direction_norm);
}

// Vector<double> calculate_FR_training_direction(const Vector<double>&, const
// Vector<double>&, const Vector<double>&) const method
...
// Control sentence (if debug)
  ...
  if (!performance_functional_pointer) {
    buffer << "OpenNN Exception: ConjugateGradient class.\n"
           << "Vector<double> calculate_FR_training_direction(const "
              "Vector<double>&, const Vector<double>&, const Vector<double>&) "
              "const method.\n"
           << "Performance functional pointer is NULL.\n";
  ...
  const Vector<double> gradient_descent_term =
      calculate_gradient_descent_training_direction(gradient);
  const Vector<double> conjugate_direction_term =
      old_training_direction * FR_parameter;

  const Vector<double> FR_training_direction =
      gradient_descent_term + conjugate_direction_term;

  const double FR_training_direction_norm =
      FR_training_direction.calculate_norm();
...
/// Returns the conjugate gradient training direction, which has been previously
/// normalized.
...
// Control sentence (if debug)
  ...
  if (!performance_functional_pointer) {
    buffer
        ...
        << "Vector<double> calculate_training_direction(const Vector<double>&, "
           "const Vector<double>&, const Vector<double>&) const method.\n"
        << "Performance functional pointer is NULL.\n";
  ...
  switch (training_direction_method) {
    case FR: {
      return (calculate_FR_training_direction(old_gradient, gradient,
                                              old_training_direction));
    } break;

    case PR: {
      return (calculate_PR_training_direction(old_gradient, gradient,
                                              old_training_direction));
    } break;
...
// Vector<double> calculate_gradient_descent_training_direction(const
// Vector<double>&) const method

/// Returns the gradient descent training direction, which is the negative of
/// the normalized gradient.
/// @param gradient Gradient vector.

Vector<double> ConjugateGradient::calculate_gradient_descent_training_direction(
...
void ConjugateGradient::ConjugateGradientResults::resize_training_history(
...
// Control sentence (if debug)
  ...
  if (conjugate_gradient_pointer->get_reserve_performance_history()) {
...
// Matrix<std::string> write_final_results(const unsigned& precision) const
// method

Matrix<std::string>
ConjugateGradient::ConjugateGradientResults::write_final_results(
  ...
  const PerformanceFunctional* performance_functional_pointer =
      conjugate_gradient_pointer->get_performance_functional_pointer();
...
/// Trains a neural network with an associated performance functional according
/// to the conjugate gradient algorithm.
/// Training occurs according to the training operators, training parameters and
/// stopping criteria.

ConjugateGradient::ConjugateGradientResults*
ConjugateGradient::perform_training(void) {
// Control sentence (if debug)
  ...
  ConjugateGradientResults* results_pointer =
      new ConjugateGradientResults(this);
  ...
  //   const double& first_training_rate =
  // training_rate_algorithm.get_first_training_rate();
  ...
  for (unsigned iteration = 0; iteration <= maximum_iterations_number;
       iteration++) {
    ...
    generalization_performance =
        performance_functional_pointer->calculate_generalization_performance();

    if (iteration != 0 &&
        generalization_performance > old_generalization_performance) {
    ...
    if (iteration == 0 || iteration % parameters_number == 0) {
      ...
      training_direction =
          calculate_gradient_descent_training_direction(gradient);
    } else if (fabs(old_gradient.dot(gradient)) >=
               0.2 * gradient.dot(gradient))  // Powell-Bealle restarts
        {
      // Gradient descent training direction
      ...
      training_direction = calculate_training_direction(old_gradient, gradient,
                                                        old_training_direction);
    }
    ...
    directional_point = training_rate_algorithm.calculate_directional_point(
        performance, training_direction, initial_training_rate);
    ...
    if (iteration != 0 && training_rate < 1.0e-99) {
      ...
      directional_point = training_rate_algorithm.calculate_directional_point(
          performance, training_direction, first_training_rate);
    ...
    if (reserve_generalization_performance_history) {
      results_pointer->generalization_performance_history[iteration] =
          generalization_performance;
    }
    ...
    if (reserve_training_direction_history) {
      results_pointer->training_direction_history[iteration] =
          training_direction;
    }
    ...
    if (parameters_increment_norm <= minimum_parameters_increment_norm) {
      if (display) {
        ...
        std::cout << "Parameters increment norm: " << parameters_increment_norm
                  << std::endl;
      }

      stop_training = true;
    } else if (iteration != 0 &&
               performance_increase <= minimum_performance_increase) {
      if (display) {
        std::cout << "Iteration " << iteration
                  << ": Minimum performance increase reached.\n";
        std::cout << "Performance increase: " << performance_increase
                  << std::endl;
      }
      ...
      stop_training = true;
    } else if (generalization_failures >
               maximum_generalization_performance_decreases) {
      if (display) {
        std::cout << "Iteration " << iteration
                  << ": Maximum generalization failures reached.\n"
                  << "Generalization failures: " << generalization_failures
                  << std::endl;
      }
    ...
    if (stop_training) {
      if (display) {
        ...
        if (generalization_performance != 0) {
          std::cout << "Generalization performance: "
                    << generalization_performance << std::endl;
        }
      }
      ...
      results_pointer->final_generalization_performance =
          generalization_performance;
...
Matrix<std::string> ConjugateGradient::to_string_matrix(void) const {
  ...
  const std::string training_direction_method_string =
  ...
  const std::string training_rate_method =
      training_rate_algorithm.write_training_rate_method();
...
/// Serializes the conjugate gradient object into a XML document of the TinyXML
/// library.
...
tinyxml2::XMLDocument* ConjugateGradient::to_XML(void) const {
  ...
  tinyxml2::XMLElement* root_element =
      document->NewElement("ConjugateGradient");
  ...
  // Training rate algorithm
  {
    tinyxml2::XMLElement* element =
        document->NewElement("TrainingRateAlgorithm");
    root_element->LinkEndChild(element);

    const tinyxml2::XMLDocument* training_rate_algorithm_document =
        training_rate_algorithm.to_XML();

    const tinyxml2::XMLElement* training_rate_algorithm_element =
        training_rate_algorithm_document->FirstChildElement(
  ...
  {
    tinyxml2::XMLElement* element =
        document->NewElement("ReserveTrainingRateHistory");
    root_element->LinkEndChild(element);
...
void ConjugateGradient::from_XML(const tinyxml2::XMLDocument& document) {
  ...
  // Training direction method
  {
    const tinyxml2::XMLElement* training_direction_method_element =
        root_element->FirstChildElement("TrainingDirectionMethod");

    if (training_direction_method_element) {
      const std::string new_training_direction_method =
          training_direction_method_element->GetText();
  ...
  {
    const tinyxml2::XMLElement* training_rate_algorithm_element =
        root_element->FirstChildElement("TrainingRateAlgorithm");

    if (training_rate_algorithm_element) {
      tinyxml2::XMLDocument training_rate_algorithm_document;

      tinyxml2::XMLElement* element_clone =
          training_rate_algorithm_document.NewElement("TrainingRateAlgorithm");
      training_rate_algorithm_document.InsertFirstChild(element_clone);

      DeepClone(element_clone, training_rate_algorithm_element,
                &training_rate_algorithm_document, NULL);
  ...
  // Warning parameters norm
  {
    const tinyxml2::XMLElement* warning_parameters_norm_element =
        root_element->FirstChildElement("WarningParametersNorm");

    if (warning_parameters_norm_element) {
      const double new_warning_parameters_norm =
          atof(warning_parameters_norm_element->GetText());
  ...
  // Warning gradient norm
  {
    const tinyxml2::XMLElement* warning_gradient_norm_element =
        root_element->FirstChildElement("WarningGradientNorm");

    if (warning_gradient_norm_element) {
      const double new_warning_gradient_norm =
          atof(warning_gradient_norm_element->GetText());
  ...
  // Warning training rate
  {
    const tinyxml2::XMLElement* warning_training_rate_element =
        root_element->FirstChildElement("WarningTrainingRate");

    if (warning_training_rate_element) {
      const double new_warning_training_rate =
          atof(warning_training_rate_element->GetText());
  ...
  // Error parameters norm
  {
    const tinyxml2::XMLElement* error_parameters_norm_element =
        root_element->FirstChildElement("ErrorParametersNorm");

    if (error_parameters_norm_element) {
      const double new_error_parameters_norm =
          atof(error_parameters_norm_element->GetText());
  ...
  // Error gradient norm
  {
    const tinyxml2::XMLElement* error_gradient_norm_element =
        root_element->FirstChildElement("ErrorGradientNorm");

    if (error_gradient_norm_element) {
      const double new_error_gradient_norm =
          atof(error_gradient_norm_element->GetText());
  ...
  // Error training rate
  {
    const tinyxml2::XMLElement* error_training_rate_element =
        root_element->FirstChildElement("ErrorTrainingRate");

    if (error_training_rate_element) {
      const double new_error_training_rate =
          atof(error_training_rate_element->GetText());
  ...
  // Minimum parameters increment norm
  {
    ...
    if (minimum_parameters_increment_norm_element) {
      const double new_minimum_parameters_increment_norm =
          atof(minimum_parameters_increment_norm_element->GetText());

      try {
        set_minimum_parameters_increment_norm(
            new_minimum_parameters_increment_norm);
      }
      catch (const std::logic_error & e) {
        std::cout << e.what() << std::endl;
      }
  ...
  // Minimum performance increase
  {
    const tinyxml2::XMLElement* minimum_performance_increase_element =
        root_element->FirstChildElement("MinimumPerformanceIncrease");

    if (minimum_performance_increase_element) {
      const double new_minimum_performance_increase =
          atof(minimum_performance_increase_element->GetText());
  ...
  // Performance goal
  {
    const tinyxml2::XMLElement* performance_goal_element =
        root_element->FirstChildElement("PerformanceGoal");

    if (performance_goal_element) {
      const double new_performance_goal =
          atof(performance_goal_element->GetText());
  ...
  // Gradient norm goal
  {
    const tinyxml2::XMLElement* gradient_norm_goal_element =
        root_element->FirstChildElement("GradientNormGoal");

    if (gradient_norm_goal_element) {
      const double new_gradient_norm_goal =
          atof(gradient_norm_goal_element->GetText());
  ...
  // Maximum generalization performance decreases
  {
    const tinyxml2::XMLElement*
        maximum_generalization_performance_decreases_element =
            root_element->FirstChildElement(
                "MaximumGeneralizationPerformanceDecreases");

    if (maximum_generalization_performance_decreases_element) {
      const unsigned new_maximum_generalization_performance_decreases =
          atoi(maximum_generalization_performance_decreases_element->GetText());
  ...
  // Maximum iterations number
  {
    const tinyxml2::XMLElement* maximum_iterations_number_element =
        root_element->FirstChildElement("MaximumIterationsNumber");
  ...
  // Maximum time
  {
    const tinyxml2::XMLElement* maximum_time_element =
        root_element->FirstChildElement("MaximumTime");
  ...
  // Reserve parameters history
  {
    const tinyxml2::XMLElement* reserve_parameters_history_element =
        root_element->FirstChildElement("ReserveParametersHistory");

    if (reserve_parameters_history_element) {
      const std::string new_reserve_parameters_history =
          reserve_parameters_history_element->GetText();
  ...
  // Reserve parameters norm history
  {
    const tinyxml2::XMLElement* reserve_parameters_norm_history_element =
        root_element->FirstChildElement("ReserveParametersNormHistory");

    if (reserve_parameters_norm_history_element) {
      const std::string new_reserve_parameters_norm_history =
          reserve_parameters_norm_history_element->GetText();

      try {
        set_reserve_parameters_norm_history(
            new_reserve_parameters_norm_history != "0");
      }
      catch (const std::logic_error & e) {
        std::cout << e.what() << std::endl;
      }
  ...
  // Reserve performance history
  {
    const tinyxml2::XMLElement* reserve_performance_history_element =
        root_element->FirstChildElement("ReservePerformanceHistory");

    if (reserve_performance_history_element) {
      const std::string new_reserve_performance_history =
          reserve_performance_history_element->GetText();
  ...
  {
    const tinyxml2::XMLElement*
        reserve_generalization_performance_history_element =
            root_element->FirstChildElement(
    ...
    if (reserve_generalization_performance_history_element) {
      const std::string new_reserve_generalization_performance_history =
          reserve_generalization_performance_history_element->GetText();

      try {
        set_reserve_generalization_performance_history(
            new_reserve_generalization_performance_history != "0");
      }
      catch (const std::logic_error & e) {
        std::cout << e.what() << std::endl;
      }
  ...
  // Reserve gradient history
  {
    const tinyxml2::XMLElement* reserve_gradient_history_element =
        root_element->FirstChildElement("ReserveGradientHistory");

    if (reserve_gradient_history_element) {
      const std::string new_reserve_gradient_history =
          reserve_gradient_history_element->GetText();
    ...
    // Reserve gradient norm history
    {
      const tinyxml2::XMLElement* reserve_gradient_norm_history_element =
          root_element->FirstChildElement("ReserveGradientNormHistory");

      if (reserve_gradient_norm_history_element) {
        const std::string new_reserve_gradient_norm_history =
            reserve_gradient_norm_history_element->GetText();
    ...
    // Reserve training direction history
    {
      const tinyxml2::XMLElement* reserve_training_direction_history_element =
          root_element->FirstChildElement("ReserveTrainingDirectionHistory");

      if (reserve_training_direction_history_element) {
        const std::string new_reserve_training_direction_history =
            reserve_training_direction_history_element->GetText();

        try {
          set_reserve_training_direction_history(
              new_reserve_training_direction_history != "0");
        }
        catch (const std::logic_error & e) {
          std::cout << e.what() << std::endl;
        }
    ...
    // Reserve training rate history
    {
      const tinyxml2::XMLElement* reserve_training_rate_history_element =
          root_element->FirstChildElement("ReserveTrainingRateHistory");

      if (reserve_training_rate_history_element) {
        const std::string new_reserve_training_rate_history =
            reserve_training_rate_history_element->GetText();
    ...
    // Reserve elapsed time history
    {
      const tinyxml2::XMLElement* reserve_elapsed_time_history_element =
          root_element->FirstChildElement("ReserveElapsedTimeHistory");

      if (reserve_elapsed_time_history_element) {
        const std::string new_reserve_elapsed_time_history =
            reserve_elapsed_time_history_element->GetText();
    ...
    // Display period
    {
      const tinyxml2::XMLElement* display_period_element =
          root_element->FirstChildElement("DisplayPeriod");

      if (display_period_element) {
        const unsigned new_display_period =
