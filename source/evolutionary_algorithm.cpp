...
/// Default constructor.
/// It creates a evolutionary training algorithm not associated to any
...
/// Performance functional constructor.
/// It creates a evolutionary training algorithm associated to a performance
/// functional.
/// It also initializes the class members to their default values.
...
/// @param evolutionary_algorithm_document TinyXML document with the
/// evolutionary algorithm object members.

EvolutionaryAlgorithm::EvolutionaryAlgorithm(
    const tinyxml2::XMLDocument& evolutionary_algorithm_document)
...
const EvolutionaryAlgorithm::FitnessAssignmentMethod&
EvolutionaryAlgorithm::get_fitness_assignment_method(void) const {
...
const EvolutionaryAlgorithm::SelectionMethod&
EvolutionaryAlgorithm::get_selection_method(void) const {
...
const EvolutionaryAlgorithm::RecombinationMethod&
EvolutionaryAlgorithm::get_recombination_method(void) const {
...
const EvolutionaryAlgorithm::MutationMethod&
EvolutionaryAlgorithm::get_mutation_method(void) const {
...
const unsigned&
EvolutionaryAlgorithm::get_maximum_generalization_performance_decreases(
    void) const {
...
const bool& EvolutionaryAlgorithm::get_reserve_elapsed_time_history(
    void) const {
...
const bool&
EvolutionaryAlgorithm::get_reserve_generalization_performance_history(
    void) const {
...
/// Returns true if the population history vector of matrices is to be reserved,
/// and false otherwise.
...
/// Returns true if the best individual history vector of vectors is to be
/// reserved, and false otherwise.

const bool& EvolutionaryAlgorithm::get_reserve_best_individual_history(
    void) const {
...
/// Returns true if the mean population norm history vector is to be reserved,
/// and false otherwise.
...
/// Returns true if the standard deviation of the population norm history vector
/// is to be reserved,
/// and false otherwise.

const bool& EvolutionaryAlgorithm::get_reserve_standard_deviation_norm_history(
    void) const {
...
/// Returns true if the norm of the best individual in the population history
/// vector is to be
/// reserved, and false otherwise.
...
/// Returns true if the mean performance history vector is to be reserved, and
/// false otherwise.

const bool& EvolutionaryAlgorithm::get_reserve_mean_performance_history(
    void) const {
...
/// Returns true if the standard deviation of the performance history vector is
/// to be reserved,
/// and false otherwise.

const bool&
EvolutionaryAlgorithm::get_reserve_standard_deviation_performance_history(
    void) const {
...
/// Returns true if the best performance history vector is to be reserved, and
/// false otherwise.

const bool& EvolutionaryAlgorithm::get_reserve_best_performance_history(
    void) const {
...
/// Sets a new performance functional pointer to the evolutionary algorithm
/// object.
/// It also sets the rest of members to their default values.
...
/// Sets the members of the evolutionary algorithm object to their default
/// values.
/// Training operators:
/// <ul>
...
///
/// @param new_population_size Number of individuals in the population. This
/// must be an even number equal or
/// greater than four.

void EvolutionaryAlgorithm::set_population_size(
    const unsigned& new_population_size) {
...
/// <li> "LinearRanking"
/// </ul>
/// @param new_fitness_assignment_method_name String with name of method for
/// fitness assignment.

void EvolutionaryAlgorithm::set_fitness_assignment_method(
    const std::string& new_fitness_assignment_method_name) {
  if (new_fitness_assignment_method_name == "LinearRanking") {
    ...
    buffer << "OpenNN Exception: EvolutionaryAlgorithm class.\n"
           << "void set_fitness_assignment_method(const std::string&) method.\n"
           << "Unknown fitness assignment method: "
           << new_fitness_assignment_method_name << ".\n";
...
void EvolutionaryAlgorithm::set_selection_method(
    const std::string& new_selection_method_name) {
...
/// <li> "Intermediate"
/// </ul>
/// @param new_recombination_method_name String with name of method for
/// recombination.

void EvolutionaryAlgorithm::set_recombination_method(
    const std::string& new_recombination_method_name) {
...
void EvolutionaryAlgorithm::set_mutation_method(
    const std::string& new_mutation_method_name) {
...
void EvolutionaryAlgorithm::set_population(
    const Matrix<double>& new_population) {
// Control sentence (if debug)
...
void EvolutionaryAlgorithm::set_performance(
    const Vector<double>& new_performance) {
// Control sentence (if debug)
...
/// Makes the population history vector of matrices to be reseved or not in
/// memory.
/// @param new_reserve_population_history True if the population history vector
/// of matrices is to be reserved, false
/// otherwise.

void EvolutionaryAlgorithm::set_reserve_population_history(
    const bool& new_reserve_population_history) {
  reserve_population_history = new_reserve_population_history;
}

// void set_reserve_best_individual_history(bool) method

/// Makes the best individual history vector of vectors to be reseved or not in
/// memory.
/// @param new_reserve_best_individual_history True if the best individual
/// history vector of vectors is to be reserved,
/// false otherwise.

void EvolutionaryAlgorithm::set_reserve_best_individual_history(
    const bool& new_reserve_best_individual_history) {
...
///
/// @param new_reserve_mean_norm_history True if the mean norm history vector is
/// to be reserved, false otherwise.

void EvolutionaryAlgorithm::set_reserve_mean_norm_history(
    const bool& new_reserve_mean_norm_history) {
  reserve_mean_norm_history = new_reserve_mean_norm_history;
}

// void set_reserve_standard_deviation_norm_history(bool) method

/// Makes the standard deviation norm history vector to be reseved or not in
/// memory.
///
/// @param new_reserve_standard_deviation_norm_history True if the standard
/// deviation norm history vector is to be
/// reserved, false otherwise.

void EvolutionaryAlgorithm::set_reserve_standard_deviation_norm_history(
    const bool& new_reserve_standard_deviation_norm_history) {
  reserve_standard_deviation_norm_history =
      new_reserve_standard_deviation_norm_history;
}
...
///
/// @param new_reserve_best_norm_history True if the best norm history vector is
/// to be reserved, false otherwise.

void EvolutionaryAlgorithm::set_reserve_best_norm_history(
    const bool& new_reserve_best_norm_history) {
...
///
/// @param new_reserve_mean_performance_history True if the mean performance
/// history vector is to be reserved, false
/// otherwise.

void EvolutionaryAlgorithm::set_reserve_mean_performance_history(
    const bool& new_reserve_mean_performance_history) {
...
/// Makes the standard deviation performance history vector to be reseved or not
/// in memory.
///
/// @param new_reserve_standard_deviation_performance_history True if the
/// standard deviation performance history vector
/// is to be reserved, false otherwise.

void EvolutionaryAlgorithm::set_reserve_standard_deviation_performance_history(
    const bool& new_reserve_standard_deviation_performance_history) {
  reserve_standard_deviation_performance_history =
      new_reserve_standard_deviation_performance_history;
}
...
///
/// @param new_reserve_best_performance_history True if the best performance
/// history vector is to be reserved,
/// false otherwise.

void EvolutionaryAlgorithm::set_reserve_best_performance_history(
    const bool& new_reserve_best_performance_history) {
...
///
/// @param new_reserve_all_training_history True if the training history of all
/// variables is to be reserved,
/// false otherwise.

void EvolutionaryAlgorithm::set_reserve_all_training_history(
  ...
  reserve_standard_deviation_performance_history =
      new_reserve_all_training_history;
...
/// Returns the Vector of parameters corresponding to the individual i in the
/// population.
///
...
void EvolutionaryAlgorithm::set_individual(const unsigned& i,
...
void EvolutionaryAlgorithm::set_warning_parameters_norm(
...
void EvolutionaryAlgorithm::set_error_parameters_norm(
...
void EvolutionaryAlgorithm::set_best_performance_goal(
    const double& new_best_performance_goal) {
...
void EvolutionaryAlgorithm::set_maximum_generalization_performance_decreases(
...
void EvolutionaryAlgorithm::set_reserve_elapsed_time_history(
...
void EvolutionaryAlgorithm::set_reserve_generalization_performance_history(
...
void EvolutionaryAlgorithm::set_display_period(
...
double EvolutionaryAlgorithm::calculate_standard_deviation_performance(
    void) const {
...
/// Returns the number of individuals which will always be selected for
/// recombination.
...
/// Returns the mean performance value of the population at which training will
/// stop.
...
/// Returns the standard deviation of the performance at which training will
/// stop.

const double& EvolutionaryAlgorithm::get_standard_deviation_performance_goal(
    void) const {
...
const unsigned& EvolutionaryAlgorithm::get_maximum_generations_number(
    void) const {
...
/// The elitism size is the number of individuals which will always be selected
/// for recombination.
...
void EvolutionaryAlgorithm::set_elitism_size(const unsigned& new_elitism_size) {
  ...
  if (new_elitism_size > half_population_size) {
    ...
    buffer << "OpenNN Exception: EvolutionaryAlgorithm class.\n"
           << "void set_elitism_size(const unsigned&) method.\n"
           << "Eltism size (" << new_elitism_size
           << ") must be less or equal than half the population size ("
...
void EvolutionaryAlgorithm::set_selective_pressure(
    const double& new_selective_pressure) {
...
///
/// @param new_recombination_size Recombination size value. This must be equal
/// or greater than 0.

void EvolutionaryAlgorithm::set_recombination_size(
    const double& new_recombination_size) {
...
///
/// @param new_mutation_rate Mutation rate value. This value must lie in the
/// interval [0,1].
...
///
/// @param new_mutation_range Mutation range value. This must be equal or
/// greater than 0.

void EvolutionaryAlgorithm::set_mutation_range(
    const double& new_mutation_range) {
  // Control sentence
...
void EvolutionaryAlgorithm::set_maximum_generations_number(
    const unsigned& new_maximum_generations_number) {
// Control sentence (if debug)
...
/// @param new_mean_performance_goal Goal value for the mean performance of the
/// population.

void EvolutionaryAlgorithm::set_mean_performance_goal(
    const double& new_mean_performance_goal) {
  mean_performance_goal = new_mean_performance_goal;
}

// void set_standard_deviation_performance_goal(const double&) method

/// Sets a new value for the standard deviation performance goal stopping
/// criterion.
/// @param new_standard_deviation_performance_goal Goal for the standard
/// deviation performance of the population.

void EvolutionaryAlgorithm::set_standard_deviation_performance_goal(
    const double& new_standard_deviation_performance_goal) {
// Control sentence (if debug)
  ...
  if (new_standard_deviation_performance_goal < 0.0) {
    ...
    buffer << "OpenNN Exception: EvolutionaryAlgorithm class.\n"
           << "void set_standard_deviation_performance_goal(const double&) "
              "method.\n"
           << "Standard deviation of performance goal must be equal or greater "
              "than 0.\n";
...
/// @param new_fitness_assignment_method Fitness assignment method chosen for
/// training.

void EvolutionaryAlgorithm::set_fitness_assignment_method(
    const EvolutionaryAlgorithm::FitnessAssignmentMethod&
        new_fitness_assignment_method) {
...
void EvolutionaryAlgorithm::set_selection_method(
    const EvolutionaryAlgorithm::SelectionMethod& new_selection_method) {
...
void EvolutionaryAlgorithm::set_mutation_method(
    const EvolutionaryAlgorithm::MutationMethod& new_mutation_method) {
...
/// Initializes the parameters of all the individuals in the population at
/// random, with values
...
// Control sentence (if debug)
  ...
  if (minimum_size != parameters_number || maximum_size != parameters_number) {
    ...
    buffer << "OpenNN Exception: EvolutionaryAlgorithm class.\n"
           << "void randomize_population_uniform(Vector<double>, "
              "Vector<double>).\n"
           << "Minimum value and maximum value sizes must be equal to number "
              "of parameters.\n";
...
/// Initializes the parameters of all the individuals in the population with
...
// Control sentence (if debug)
  ...
  if (mean_size != parameters_number ||
      standard_deviation_size != parameters_number) {
    std::ostringstream buffer;

    buffer
        << "OpenNN Exception: EvolutionaryAlgorithm class.\n"
        << "void randomize_population_normal(Vector<double>, Vector<double>).\n"
        << "Mean and standard deviation sizes must be equal to number of "
           "parameters.\n";
...
/// Assigns a fitness value to all the individuals in the population according
/// to the finess assignment operator.
...
/// Selects for recombination some individuals from the population according to
...
// Control sentence (if debug)
  ...
  const unsigned selected_individuals_number =
      selection.count_occurrences(true);
  ...
  if (selected_individuals_number != population_size / 2) {
    ...
    buffer << "OpenNN Exception: EvolutionaryAlgorithm class.\n"
           << "void perform_selection(void).\n"
           << "Number of selected individuals is not equal to half of the "
              "population size.\n";
...
/// Recombinates the selected individuals according to the recombination
/// operator.
...
/// Generates a new population matrix by applying fitness assignment, selection,
...
// Control sentence (if debug)
  ...
  for (unsigned i = 0; i < population_size; i++) {
    ...
    performance[i] =
        performance_functional_pointer->calculate_performance(individual);
...
/// so that the least fit individual has rank 1 and the fittest individual has
...
void EvolutionaryAlgorithm::perform_linear_ranking_fitness_assignment(void) {
  ...
  // Cannot do that without loop because of different types of fitness and rank
  // vectors
...
void EvolutionaryAlgorithm::perform_roulette_wheel_selection(void) {
  ...
  const Vector<unsigned> elite_individuals =
      fitness.calculate_maximal_indices(elitism_size);
...
// Control sentence (if debug)
  ...
  if (selection.count_occurrences(true) != population_size / 2) {
    ...
    buffer << "OpenNN Exception: EvolutionaryAlgorithm class.\n"
           << "void perform_roulette_wheel_selection(void) method.\n"
           << "Selection count (" << selection.count_occurrences(true)
...
/// Performs inediate recombination between pairs of selected individuals to
/// generate a new
/// population.
/// Each selected individual is to be recombined with two other selected
    ...
    if (selection[i]) {
      ...
      for (unsigned j = 0; j < 2; j++) {
        ...
        do {
          ...
          parent_2_candidate_index =
              (unsigned)calculate_random_uniform(0.0, population_size);

          // Check if candidate for parent 2 is ok

          if (selection[parent_2_candidate_index] &&
              parent_2_candidate_index != i) {
            parent_2_candidate = true;

            recombination[new_population_size_count][0] = i;

            recombination[new_population_size_count][1] =
                parent_2_candidate_index;
            ...
            for (unsigned j = 0; j < parameters_number; j++) {
              ...
              scaling_factor = calculate_random_uniform(
                  -recombination_size, 1.0 + recombination_size);

              offspring[j] = scaling_factor * parent_1[j] +
                             (1.0 - scaling_factor) * parent_2[j];
            }
...
/// Performs line recombination between pairs of selected individuals to
    ...
    if (selection[i]) {
      ...
      for (unsigned j = 0; j < 2; j++) {
        ...
        do {
          ...
          parent_2_candidate_index =
              (unsigned)calculate_random_uniform(0.0, (double)population_size);
          ...
          if (selection[parent_2_candidate_index] &&
            ...
            scaling_factor = calculate_random_uniform(-recombination_size,
                                                      1.0 + recombination_size);
...
/// Performs normal mutation to all individuals in order to generate a new
/// population.
/// Results are stored in the population matrix.
...
/// Performs uniform mutation to all individuals in order to generate a new
/// population.
/// Results are stored in the population matrix.
...
void EvolutionaryAlgorithm::perform_uniform_mutation(void) {
  ...
  for (unsigned i = 0; i < population_size; i++) {
    ...
    for (unsigned j = 0; j < parameters_number; j++) {
      ...
      if (pointer < mutation_rate) {
        individual[j] +=
            calculate_random_uniform(-mutation_range, mutation_range);
      }
    }
...
/// Returns a string representation of the current evolutionary algorithm
/// resutls structure.

std::string EvolutionaryAlgorithm::EvolutionaryAlgorithmResults::to_string(
    void) const {
  std::ostringstream buffer;
...
void
EvolutionaryAlgorithm::EvolutionaryAlgorithmResults::resize_training_history(
  ...
  if (evolutionary_algorithm_pointer
          ->get_reserve_standard_deviation_norm_history()) {
  ...
  if (evolutionary_algorithm_pointer
          ->get_reserve_standard_deviation_performance_history()) {
...
Matrix<std::string>
EvolutionaryAlgorithm::EvolutionaryAlgorithmResults::write_final_results(
  ...
  buffer << std::setprecision(precision)
         << final_standard_deviation_performance;
  ...
  const PerformanceFunctional* performance_functional_pointer =
      evolutionary_algorithm_pointer->get_performance_functional_pointer();
...
/// Trains a neural network with an associated performance function according to
...
EvolutionaryAlgorithm::perform_training(void) {
#ifndef NDEBUG
  ...
  EvolutionaryAlgorithmResults* results_pointer =
      new EvolutionaryAlgorithmResults(this);
  ...
  for (unsigned generation = 0; generation <= maximum_generations_number;
       generation++) {
    // Population stuff
    ...
    if (reserve_standard_deviation_norm_history) {
      results_pointer->standard_deviation_norm_history[generation] =
    ...
    if (best_generation_performance < best_performance_ever) {
      ...
      generalization_performance = performance_functional_pointer
    ...
    const double standard_deviation_performance =
        performance.calculate_standard_deviation();

    if (reserve_standard_deviation_performance_history) {
      results_pointer->standard_deviation_performance_history[generation] =
          standard_deviation_performance;
    }

    // Best performance

    if (reserve_best_performance_history) {
      results_pointer->best_performance_history[generation] =
    ...
    if (reserve_generalization_performance_history) {
      results_pointer->generalization_performance_history[generation] =
    ...
    if (standard_deviation_performance <= standard_deviation_performance_goal) {
      ...
      if (display) {
        ...
        std::cout << "Generalization performance decreases: "
    ...
    if (stop_training) {
      ...
      results_pointer->final_standard_deviation_performance =
          standard_deviation_performance;
...
tinyxml2::XMLDocument* EvolutionaryAlgorithm::to_XML(void) const {
  ...
  tinyxml2::XMLElement* root_element =
      document->NewElement("EvolutionaryAlgorithm");
...
/// @param document TinyXML document with the evolutionary algorithm object
/// members.

void EvolutionaryAlgorithm::from_XML(const tinyxml2::XMLDocument& document) {
  const tinyxml2::XMLElement* root_element =
      document.FirstChildElement("EvolutionaryAlgorithm");
  ...
  // Population
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("Population");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("FitnessAssignmentMethod");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("SelectionMethod");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("RecombinationMethod");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("MutationMethod");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("ElitismSize");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("SelectivePressure");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("RecombinationSize");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("MutationRate");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("MutationRange");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("MeanPerformanceGoal");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("StandardDeviationPerformanceGoal");
    ...
    if (element) {
      ...
      try {
        set_standard_deviation_performance_goal(
            new_standard_deviation_performance_goal);
      }
      catch (const std::logic_error & e) {
        std::cout << e.what() << std::endl;
      }
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("BestPerformanceGoal");
  ...
  // Maximum generalization performance decreases
  {
    const tinyxml2::XMLElement* element = root_element->FirstChildElement(
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("MaximumGenerationsNumber");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("ReserveMeanNormHistory");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("ReserveStandardDeviationNormHistory");

    if (element) {
      const bool new_standard_deviation_norm_history = atoi(element->GetText());
      set_reserve_standard_deviation_norm_history(
          new_standard_deviation_norm_history);
    }
  }
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("ReserveBestNormHistory");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("ReserveMeanPerformanceHistory");
  ...
  // Reserve standard deviation performance history
  {
    ...
    if (element) {
      const bool new_standard_deviation_performance_history =
          atoi(element->GetText());
      set_reserve_standard_deviation_performance_history(
          new_standard_deviation_performance_history);
    }
  }
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("ReserveBestPerformanceHistory");
  ...
  // Reserve generalization performance history
  {
    ...
    if (element) {
      const bool new_generalization_performance_history =
          atoi(element->GetText());
      set_reserve_generalization_performance_history(
          new_generalization_performance_history);
    }
  }
}
...
void EvolutionaryAlgorithm::initialize_random(void) {
  ...
  const unsigned new_population_size =
      (unsigned)calculate_random_uniform(1.0, 11.0) * 4;
