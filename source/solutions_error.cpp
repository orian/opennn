...
const double& SolutionsError::get_solution_error_weight(const unsigned& i) const
{
...
void SolutionsError::set_solution_error_weight(const unsigned& i, const double& new_solution_error_weight)
{
...
void SolutionsError::set_default(void)
{
   ...
   {
      const unsigned dependent_variables_number = mathematical_model_pointer->get_dependent_variables_number();
...
void SolutionsError::check(void) const
{
   ...
   const unsigned solutions_errors_weights_size = solutions_errors_weights.size();
...
double SolutionsError::calculate_solutions_error_sum(void) const   
{
   ...
   const unsigned independent_variables_number = mathematical_model_pointer->get_independent_variables_number();
   const unsigned dependent_variables_number = mathematical_model_pointer->get_dependent_variables_number();

   const unsigned variables_number = mathematical_model_pointer->count_variables_number();

   const Matrix<double> solution = mathematical_model_pointer->calculate_solutions(*neural_network_pointer);    

   const Vector<unsigned> independent_variables_indices(0, 1, independent_variables_number-1);
   const Vector<unsigned> dependent_variables_indices(independent_variables_number, 1, variables_number-1);
