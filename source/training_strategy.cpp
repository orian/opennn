...
/// Default constructor.
/// It creates a training strategy object not associated to any performance
/// functional object.
...
/// Performance functional constructor.
/// It creates a training strategy object associated to a performance functional
/// object.
/// It also constructs the main training algorithm object.
...
/// Destructor.
/// This destructor deletes the initialization, main and refinement training
/// algorithm objects.
...
/// Throws an exception if the training strategy has not a performance
...
void TrainingStrategy::check_training_algorithms(void) const {
  if (initialization_type == NO_INITIALIZATION && main_type == NO_MAIN &&
...
/// Returns a pointer to the performance functional object to which the training
/// strategy is associated.

PerformanceFunctional* TrainingStrategy::get_performance_functional_pointer(
    void) const {
  if (!performance_functional_pointer) {
    std::ostringstream buffer;
...
/// Returns true if this training strategy has a performance functional
/// associated,
/// and false otherwise.
...
EvolutionaryAlgorithm* TrainingStrategy::get_evolutionary_algorithm_pointer(
    void) const {
  if (!evolutionary_algorithm_pointer) {
    std::ostringstream buffer;

    buffer << "OpenNN Exception: TrainingStrategy class.\n"
           << "EvolutionaryAlgorithm* get_evolutionary_algorithm_pointer(void) "
              "const method.\n"
...
QuasiNewtonMethod* TrainingStrategy::get_quasi_Newton_method_pointer(
  ...
  if (!quasi_Newton_method_pointer) {
    ...
    buffer << "OpenNN Exception: TrainingStrategy class.\n"
           << "QuasiNetwtonMethod* get_quasi_Newton_method_pointer(void) const "
              "method.\n"
...
// LevenbergMarquardtAlgorithm* get_Levenberg_Marquardt_algorithm_pointer(void)
// const method
...
TrainingStrategy::get_Levenberg_Marquardt_algorithm_pointer(void) const {
  if (!Levenberg_Marquardt_algorithm_pointer) {
    std::ostringstream buffer;

    buffer << "OpenNN Exception: TrainingStrategy class.\n"
           << "LevenbergMarquardtAlgorithm* "
              "get_Levenberg_Marquardt_algorithm_pointer(void) const method.\n"
...
/// Returns the type of the initialization training algorithm composing this
/// training strategy object.

const TrainingStrategy::InitializationType&
TrainingStrategy::get_initialization_type(void) const {
  return (initialization_type);
}

// const MainType& get_main_type(void) const method

/// Returns the type of the main training algorithm composing this training
/// strategy object.
...
/// Returns the type of the refinement training algorithm composing this
/// training strategy object.

const TrainingStrategy::RefinementType& TrainingStrategy::get_refinement_type(
    void) const {
...
/// Returns a string with the type of the initialization training algorithm
/// composing this training strategy object.
...
/// Returns a string with the type of the main training algorithm composing this
/// training strategy object.
...
/// Returns a string with the type of the refinement training algorithm
/// composing this training strategy object.
...
/// false if messages from
/// this class can't be displayed on the screen.

const bool& TrainingStrategy::get_display(void) const { return (display); }

// void set(void) method

/// Sets the performance functional pointer to NULL.
/// It also destructs the initialization, main and refinement training
/// algorithms.
...
void TrainingStrategy::set_initialization_type(
    const InitializationType& new_initialization_type) {
  ...
  switch (initialization_type) {
    ...
    case EVOLUTIONARY_ALGORITHM: {
      evolutionary_algorithm_pointer =
          new EvolutionaryAlgorithm(performance_functional_pointer);
    } break;
  ...
  switch (main_type) {
    ...
    case GRADIENT_DESCENT: {
      gradient_descent_pointer =
          new GradientDescent(performance_functional_pointer);
    } break;

    case CONJUGATE_GRADIENT: {
      conjugate_gradient_pointer =
          new ConjugateGradient(performance_functional_pointer);
    } break;

    case QUASI_NEWTON_METHOD: {
      quasi_Newton_method_pointer =
          new QuasiNewtonMethod(performance_functional_pointer);
    } break;

    case LEVENBERG_MARQUARDT_ALGORITHM: {
      Levenberg_Marquardt_algorithm_pointer =
          new LevenbergMarquardtAlgorithm(performance_functional_pointer);
    } break;
...
/// Note that it destructs the current refinement algorithm object and
/// constructs a new one.
/// @param new_refinement_type Type of refinement training algorithm.

void TrainingStrategy::set_refinement_type(
    const RefinementType& new_refinement_type) {
  destruct_refinement();
...
void TrainingStrategy::set_initialization_type(
    const std::string& new_initialization_type) {
...
/// It destructs the previous refinement algorithm object and constructs a new
/// object.
/// @param new_refinement_type String with the refinement training algorithm
/// type.

void TrainingStrategy::set_refinement_type(
    const std::string& new_refinement_type) {
...
void TrainingStrategy::set_performance_functional_pointer(
    PerformanceFunctional* new_performance_functional_pointer) {
  performance_functional_pointer = new_performance_functional_pointer;
  ...
  switch (initialization_type) {
    ...
    case RANDOM_SEARCH: {
      random_search_pointer->set_performance_functional_pointer(
          new_performance_functional_pointer);
    } break;

    case EVOLUTIONARY_ALGORITHM: {
      evolutionary_algorithm_pointer->set_performance_functional_pointer(
          new_performance_functional_pointer);
    } break;
  ...
  switch (main_type) {
    ...
    case GRADIENT_DESCENT: {
      gradient_descent_pointer->set_performance_functional_pointer(
          new_performance_functional_pointer);
    } break;

    case CONJUGATE_GRADIENT: {
      conjugate_gradient_pointer->set_performance_functional_pointer(
          new_performance_functional_pointer);
    } break;

    case QUASI_NEWTON_METHOD: {
      quasi_Newton_method_pointer->set_performance_functional_pointer(
          new_performance_functional_pointer);
    } break;

    case LEVENBERG_MARQUARDT_ALGORITHM: {
      Levenberg_Marquardt_algorithm_pointer->set_performance_functional_pointer(
          new_performance_functional_pointer);
    } break;
  ...
  switch (refinement_type) {
    ...
    case NEWTON_METHOD: {
      Newton_method_pointer->set_performance_functional_pointer(
          new_performance_functional_pointer);
    } break;
...
void TrainingStrategy::set_default(void) { display = true; }

// void destruct_initialization(void) method

/// This method deletes the initialization training algorithm object which
/// composes this training strategy object.
...
/// This method deletes the main training algorithm object which composes this
/// training strategy object.
...
/// This method deletes the refinement training algorithm object which composes
/// this training strategy object.
...
/// The most general training strategy consists of three steps: initialization,
/// main and refinement training processes.
...
/// Prints to the screen the string representation of the training strategy
/// object.

void TrainingStrategy::print(void) const { std::cout << to_string(); }

// tinyxml2::XMLDocument* to_XML(void) const method

/// Returns a default string representation in XML-type format of the training
/// algorithm object.
/// This containts the training operators, the training parameters, stopping
...
tinyxml2::XMLDocument* TrainingStrategy::to_XML(void) const {
  ...
  tinyxml2::XMLElement* training_strategy_element =
      document->NewElement("TrainingStrategy");
  ...
  switch (initialization_type) {
    case NO_INITIALIZATION: {
      tinyxml2::XMLElement* initialization_element =
          document->NewElement("Initialization");
    ...
    case RANDOM_SEARCH: {
      ...
      const tinyxml2::XMLDocument* random_search_document =
          random_search_pointer->to_XML();

      const tinyxml2::XMLElement* random_search_element =
          random_search_document->FirstChildElement("RandomSearch");
    ...
    case EVOLUTIONARY_ALGORITHM: {
      ...
      const tinyxml2::XMLDocument* evolutionary_algorithm_document =
          evolutionary_algorithm_pointer->to_XML();

      const tinyxml2::XMLElement* evolutionary_algorithm_element =
          evolutionary_algorithm_document->FirstChildElement(
              "EvolutionaryAlgorithm");

      DeepClone(initialization_element, evolutionary_algorithm_element,
                document, NULL);
  ...
  switch (main_type) {
    ...
    case GRADIENT_DESCENT: {
      ...
      const tinyxml2::XMLDocument* gradient_descent_document =
          gradient_descent_pointer->to_XML();

      const tinyxml2::XMLElement* gradient_descent_element =
          gradient_descent_document->FirstChildElement("GradientDescent");
    ...
    case CONJUGATE_GRADIENT: {
      ...
      const tinyxml2::XMLDocument* conjugate_gradient_document =
          conjugate_gradient_pointer->to_XML();

      const tinyxml2::XMLElement* conjugate_gradient_element =
          conjugate_gradient_document->FirstChildElement("ConjugateGradient");
    ...
    case QUASI_NEWTON_METHOD: {
      ...
      const tinyxml2::XMLDocument* quasi_Newton_method_document =
          quasi_Newton_method_pointer->to_XML();

      const tinyxml2::XMLElement* quasi_Newton_method_element =
          quasi_Newton_method_document->FirstChildElement("QuasiNewtonMethod");
    ...
    case LEVENBERG_MARQUARDT_ALGORITHM: {
      ...
      const tinyxml2::XMLDocument* Levenberg_Marquardt_algorithm_document =
          Levenberg_Marquardt_algorithm_pointer->to_XML();

      const tinyxml2::XMLElement* Levenberg_Marquardt_algorithm_element =
          Levenberg_Marquardt_algorithm_document->FirstChildElement(
              "LevenbergMarquardtAlgorithm");

      DeepClone(main_element, Levenberg_Marquardt_algorithm_element, document,
                NULL);
  ...
  switch (refinement_type) {
    ...
    case NEWTON_METHOD: {
      tinyxml2::XMLElement* refinement_element =
          document->NewElement("Refinement");
      training_strategy_element->LinkEndChild(refinement_element);

      refinement_element->SetAttribute("Type", "NEWTON_METHOD");

      const tinyxml2::XMLDocument* Newton_method_document =
          Newton_method_pointer->to_XML();

      const tinyxml2::XMLElement* Newton_method_element =
          Newton_method_document->FirstChildElement("NewtonMethod");
...
void TrainingStrategy::from_XML(const tinyxml2::XMLDocument& document) {
  const tinyxml2::XMLElement* root_element =
      document.FirstChildElement("TrainingStrategy");
  ...
  // Initialization
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("Initialization");
      ...
      switch (initialization_type) {
        ...
        case RANDOM_SEARCH: {
          ...
          tinyxml2::XMLElement* element_clone =
              new_document.NewElement("RandomSearch");
        ...
        case EVOLUTIONARY_ALGORITHM: {
          ...
          tinyxml2::XMLElement* element_clone =
              new_document.NewElement("EvolutionaryAlgorithm");
          new_document.InsertFirstChild(element_clone);
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("Main");
    ...
    if (element) {
      ...
      switch (main_type) {
        ...
        case GRADIENT_DESCENT: {
          ...
          tinyxml2::XMLElement* element_clone =
              new_document.NewElement("GradientDescent");
          new_document.InsertFirstChild(element_clone);
        ...
        case CONJUGATE_GRADIENT: {
          ...
          tinyxml2::XMLElement* element_clone =
              new_document.NewElement("ConjugateGradient");
          new_document.InsertFirstChild(element_clone);
        ...
        case QUASI_NEWTON_METHOD: {
          ...
          tinyxml2::XMLElement* element_clone =
              new_document.NewElement("QuasiNewtonMethod");
          new_document.InsertFirstChild(element_clone);
        ...
        case LEVENBERG_MARQUARDT_ALGORITHM: {
          ...
          tinyxml2::XMLElement* element_clone =
              new_document.NewElement("LevenbergMarquardtAlgorithm");
          new_document.InsertFirstChild(element_clone);
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("Refinement");
    ...
    if (element) {
      ...
      switch (refinement_type) {
        ...
        case NEWTON_METHOD: {
          ...
          tinyxml2::XMLElement* element_clone =
              new_document.NewElement("NewtonMethod");
          new_document.InsertFirstChild(element_clone);
