...
ProbabilisticLayer::ProbabilisticLayer(void) { set(); }
...
ProbabilisticLayer::ProbabilisticLayer(
    const unsigned& new_probabilistic_neurons_number) {
...
ProbabilisticLayer::ProbabilisticLayer(
    const ProbabilisticLayer& other_probabilistic_layer) {
...
/// Assignment operator.
/// It assigns to this object the members of an existing probabilistic layer
/// object.
/// @param other_probabilistic_layer Probabilistic layer object to be assigned.

ProbabilisticLayer& ProbabilisticLayer::operator=(
    const ProbabilisticLayer& other_probabilistic_layer) {
...
bool ProbabilisticLayer::operator==(
    const ProbabilisticLayer& other_probabilistic_layer) const {
  if (probabilistic_neurons_number ==
          other_probabilistic_layer.probabilistic_neurons_number &&
      probabilistic_method == other_probabilistic_layer.probabilistic_method &&
      display == other_probabilistic_layer.display) {
    return (true);
...
const unsigned& ProbabilisticLayer::get_probabilistic_neurons_number(
    void) const {
...
/// Returns the method to be used for interpreting the outputs as probabilistic
/// values.
/// The two methods available for that are Competitive and Softmax.

const ProbabilisticLayer::ProbabilisticMethod&
ProbabilisticLayer::get_probabilistic_method(void) const {
...
/// Returns a string with the probabilistic method for the outputs to be
/// included in some text
...
const bool& ProbabilisticLayer::get_display(void) const { return (display); }
...
/// @param new_probabilistic_neurons_number New size for the probabilistic
/// layer.
...
void ProbabilisticLayer::set_probabilistic_neurons_number(
    const unsigned& new_probabilistic_neurons_number) {
  probabilistic_neurons_number = new_probabilistic_neurons_number;
}
...
/// @param new_probabilistic_method Method for interpreting the outputs as
/// probabilistic values.

void ProbabilisticLayer::set_probabilistic_method(
    const ProbabilisticMethod& new_probabilistic_method) {
...
void ProbabilisticLayer::set_probabilistic_method(
    const std::string& new_probabilistic_method) {
...
/// As probabilistic neurons do not have any parameter, it does not matter which
/// one is pruned.
...
/// This method processes the input to the probabilistic layer in order to
/// obtain a set of outputs which can be interpreted as probabilities.
/// This posprocessing is performed according to the probabilistic method to be
/// used.
/// @param inputs Set of inputs to the probabilistic layer.

Vector<double> ProbabilisticLayer::calculate_outputs(
...
/// Returns the partial derivatives of the outputs from the probabilistic layer
...
Matrix<double> ProbabilisticLayer::calculate_Jacobian(
    const Vector<double>& inputs) const {
// Control sentence (if debug)
...
/// The elements contain second partial derivatives of the outputs from the
/// layer with resptect to the inputs to it.

Vector<Matrix<double> > ProbabilisticLayer::calculate_Hessian_form(
    const Vector<double>& inputs) const {
// Control sentence (if debug)
  ...
  if (size != probabilistic_neurons_number) {
    ...
    buffer << "OpenNN Exception: ProbabilisticLayer class.\n"
           << "Matrix<double> calculate_Hessian_form(const Vector<double>&) "
              "const method.\n"
           << "Size must be equal to number of probabilistic neurons.\n";
...
/// Returns the outputs from the layer for given inputs when the probabilistic
/// method is the competitive.
/// @param inputs Vector of input values to the probabilistic layer.

Vector<double> ProbabilisticLayer::calculate_competitive_output(
    const Vector<double>& inputs) const {
...
/// This method throws an exception, since the competitive function is not
/// derivable.

Matrix<double> ProbabilisticLayer::calculate_competitive_Jacobian(
    const Vector<double>&) const {
  std::ostringstream buffer;

  buffer << "OpenNN Exception: ProbabilisticLayer class.\n"
         << "Matrix<double> calculate_competitive_Jacobian(const "
...
// Vector< Matrix<double> > calculate_competitive_Hessian_form(const
// Vector<double>&) const method

/// This method throws an exception, since the competitive function is not
/// derivable.

Vector<Matrix<double> > ProbabilisticLayer::calculate_competitive_Hessian_form(
    const Vector<double>&) const {
  std::ostringstream buffer;
...
Vector<double> ProbabilisticLayer::calculate_softmax_output(
    const Vector<double>& inputs) const {
...
/// Returns the partial derivatives of the softmax outputs with respect to the
/// inputs.
/// @param inputs Input values to the probabilistic layer.

Matrix<double> ProbabilisticLayer::calculate_softmax_Jacobian(
    const Vector<double>& inputs) const {
  Matrix<double> probabilistic_Jacobian(probabilistic_neurons_number,
                                        probabilistic_neurons_number);
...
// Vector< Matrix<double> > calculate_softmax_Hessian_form(const
// Vector<double>&) const method

/// Returns the second partial derivatives of the softmax outputs with respect
/// to the inputs,
/// in the so called Hessian form.
/// @todo

Vector<Matrix<double> > ProbabilisticLayer::calculate_softmax_Hessian_form(
    const Vector<double>&) const {
...
Vector<double> ProbabilisticLayer::calculate_no_probabilistic_output(
    const Vector<double>& inputs) const {
  return (inputs);
}

// Matrix<double> calculate_no_probabilistic_Jacobian(const Vector<double>&)
// const method

/// Returns the partial derivatives of the no probabilistic outputs with respect
/// to the inputs.
/// This is just the identity matrix of size the number of probabilistic
/// neurons.

Matrix<double> ProbabilisticLayer::calculate_no_probabilistic_Jacobian(
    const Vector<double>&) const {
  Matrix<double> Jacobian(probabilistic_neurons_number,
                          probabilistic_neurons_number);
...
// Vector< Matrix<double> > calculate_no_probabilistic_Hessian_form(const
// Vector<double>&) const method

/// Returns the second partial derivatives of the no probabilistic outputs with
/// respect to the inputs,
/// in the so called Hessian form.
/// @todo

Vector<Matrix<double> >
ProbabilisticLayer::calculate_no_probabilistic_Hessian_form(
    const Vector<double>&) const {
  Vector<Matrix<double> > Hessian_form;
...
/// Serializes the probabilistic layer object into a XML document of the TinyXML
/// library.
...
tinyxml2::XMLDocument* ProbabilisticLayer::to_XML(void) const {
  ...
  tinyxml2::XMLElement* root_element =
      document->NewElement("ProbabilisticLayer");
...
void ProbabilisticLayer::from_XML(const tinyxml2::XMLDocument& document) {
  ...
  const tinyxml2::XMLElement* probabilistic_layer_element =
      document.FirstChildElement("ProbabilisticLayer");
  ...
  // Probabilistic neurons number
  {
    const tinyxml2::XMLElement* element =
        probabilistic_layer_element->FirstChildElement(
  ...
  {
    const tinyxml2::XMLElement* element =
        probabilistic_layer_element->FirstChildElement("ProbabilisticMethod");
  ...
  // Display
  {
    const tinyxml2::XMLElement* display_element =
        probabilistic_layer_element->FirstChildElement("Display");
...
// std::string write_competitive_expression(const Vector<std::string>&, const
// Vector<std::string>&) const method

/// Returns a string with the expression of the competitive probabilistic
/// outputs function.
...
std::string ProbabilisticLayer::write_competitive_expression(
    const Vector<std::string>& inputs_names,
    const Vector<std::string>& outputs_names) const {
  std::ostringstream buffer;

  for (unsigned i = 0; i < probabilistic_neurons_number; i++) {
    buffer << outputs_names[i] << "= Competitive("
           << inputs_names.to_string(",") << ");\n";
  }

  return (buffer.str());
}

// std::string write_softmax_expression(const Vector<std::string>&, const
// Vector<std::string>&) const method

/// Returns a string with the expression of the softmax probabilistic outputs
/// function.
/// @param inputs_names Names of inputs to the probabilistic layer.
/// @param outputs_names Names of outputs to the probabilistic layer.

std::string ProbabilisticLayer::write_softmax_expression(
    const Vector<std::string>& inputs_names,
    const Vector<std::string>& outputs_names) const {
  std::ostringstream buffer;
...
// std::string write_no_probabilistic_expression(const Vector<std::string>&,
// const Vector<std::string>&) const method

/// Returns a string with the expression of the no probabilistic outputs
/// function.
/// @param inputs_names Names of inputs to the probabilistic layer.
/// @param outputs_names Names of outputs to the probabilistic layer.

std::string ProbabilisticLayer::write_no_probabilistic_expression(
    const Vector<std::string>& inputs_names,
    const Vector<std::string>& outputs_names) const {
  std::ostringstream buffer;
...
std::string ProbabilisticLayer::write_expression(
    const Vector<std::string>& inputs_names,
    const Vector<std::string>& outputs_names) const {
  switch (probabilistic_method) {
    case Competitive: {
