...
NeuralNetwork::NeuralNetwork(
    const MultilayerPerceptron& new_multilayer_perceptron)
    : multilayer_perceptron_pointer(NULL),
      scaling_layer_pointer(NULL),
      unscaling_layer_pointer(NULL),
      bounding_layer_pointer(NULL),
  ...
  multilayer_perceptron_pointer =
      new MultilayerPerceptron(new_multilayer_perceptron);
...
/// Multilayer perceptron architecture constructor.
/// It creates a neural network object with a multilayer perceptron given by its
/// architecture.
/// The rest of pointers are initialized to NULL.
/// This constructor also initializes the rest of class members to their default
/// values.
/// @param new_multilayer_perceptron_architecture Vector with the number of
/// inputs and the numbers of perceptrons in each layer.
/// The size of this vector must be equal to one plus the number of layers.

NeuralNetwork::NeuralNetwork(
    const Vector<unsigned>& new_multilayer_perceptron_architecture)
    : multilayer_perceptron_pointer(NULL),
      scaling_layer_pointer(NULL),
      unscaling_layer_pointer(NULL),
      bounding_layer_pointer(NULL),
      ...
      independent_parameters_pointer(NULL) {
  multilayer_perceptron_pointer =
      new MultilayerPerceptron(new_multilayer_perceptron_architecture);
...
NeuralNetwork::NeuralNetwork(const unsigned& new_inputs_number,
    ...
    : multilayer_perceptron_pointer(NULL),
      ...
      independent_parameters_pointer(NULL) {
  multilayer_perceptron_pointer =
      new MultilayerPerceptron(new_inputs_number, new_perceptrons_number);
...
/// @param new_hidden_perceptrons_number Number of neurons in the hidden layer
/// of the multilayer perceptron
/// @param new_output_perceptrons_number Number of outputs neurons.

NeuralNetwork::NeuralNetwork(const unsigned& new_inputs_number,
                             const unsigned& new_hidden_perceptrons_number,
                             const unsigned& new_output_perceptrons_number)
    : multilayer_perceptron_pointer(NULL),
      scaling_layer_pointer(NULL),
      unscaling_layer_pointer(NULL),
      bounding_layer_pointer(NULL),
      ...
      independent_parameters_pointer(NULL) {
  multilayer_perceptron_pointer =
      new MultilayerPerceptron(new_inputs_number, new_hidden_perceptrons_number,
...
/// associated to the multilayer perceptron
...
NeuralNetwork::NeuralNetwork(const unsigned& new_independent_parameters_number)
    : multilayer_perceptron_pointer(NULL),
      ...
      outputs_pointer(NULL),
      independent_parameters_pointer(NULL) {
  independent_parameters_pointer =
      new IndependentParameters(new_independent_parameters_number);
...
/// File constructor.
/// It creates a neural network object by loading its members from an XML-type
/// file.
...
/// XML constructor.
/// It creates a neural network object by loading its members from an XML
/// document.
...
NeuralNetwork& NeuralNetwork::operator=(
    const NeuralNetwork& other_neural_network) {
  if (this != &other_neural_network) {
    ...
    multilayer_perceptron_pointer = new MultilayerPerceptron(
        *other_neural_network.multilayer_perceptron_pointer);

    scaling_layer_pointer =
        new ScalingLayer(*other_neural_network.scaling_layer_pointer);

    unscaling_layer_pointer =
        new UnscalingLayer(*other_neural_network.unscaling_layer_pointer);

    bounding_layer_pointer =
        new BoundingLayer(*other_neural_network.bounding_layer_pointer);

    probabilistic_layer_pointer = new ProbabilisticLayer(
        *other_neural_network.probabilistic_layer_pointer);

    conditions_layer_pointer =
        new ConditionsLayer(*other_neural_network.conditions_layer_pointer);

    independent_parameters_pointer = new IndependentParameters(
        *other_neural_network.independent_parameters_pointer);
...
bool NeuralNetwork::operator==(
    const NeuralNetwork& other_neural_network) const {
  if (*multilayer_perceptron_pointer ==
          *other_neural_network.multilayer_perceptron_pointer &&
      *scaling_layer_pointer == *other_neural_network.scaling_layer_pointer &&
      *unscaling_layer_pointer ==
          *other_neural_network.unscaling_layer_pointer &&
      *bounding_layer_pointer == *other_neural_network.bounding_layer_pointer &&
      *probabilistic_layer_pointer ==
          *other_neural_network.probabilistic_layer_pointer &&
      *conditions_layer_pointer ==
          *other_neural_network.conditions_layer_pointer &&
      *independent_parameters_pointer ==
          *other_neural_network.independent_parameters_pointer &&
...
/// Returns true if the neural network object has a multilayer perceptron object
/// inside,
/// and false otherwise.
...
/// Returns true if the neural network object has an unscaling layer object
/// inside,
/// and false otherwise.
...
/// Returns true if the neural network object has a bounding layer object
/// inside,
/// and false otherwise.
...
/// Returns true if the neural network object has a probabilistic layer object
/// inside,
/// and false otherwise.
...
/// Returns true if the neural network object has a conditions layer object
/// inside,
/// and false otherwise.
...
/// Returns true if the neural network object has an independent parameters
/// object inside,
/// and false otherwise.
...
/// Returns a pointer to the multilayer perceptron composing this neural
/// network.

MultilayerPerceptron* NeuralNetwork::get_multilayer_perceptron_pointer(
    void) const {
#ifndef NDEBUG
...
/// Returns a pointer to the independent parameters object composing this neural
/// network.

IndependentParameters* NeuralNetwork::get_independent_parameters_pointer(
    void) const {
#ifndef NDEBUG
  ...
  if (!independent_parameters_pointer) {
    ...
    buffer << "OpenNN Exception: NeuralNetwork class.\n"
           << "IndependentParameters* get_independent_parameters_pointer(void) "
              "const method.\n"
...
const bool& NeuralNetwork::get_display(void) const { return (display); }
...
/// This method deletes all the pointers in the neural network and then
/// constructs a copy of an exisiting multilayer perceptron.
/// It also sets the rest of members to their default values.
...
/// It also sets the rest of members to their default values.
/// @param new_multilayer_perceptron_architecture Architecture of the multilayer
/// perceptron.
...
/// Sets a new multilayer_perceptron_pointer architecture with one layer and
/// zero independent parameters.
/// It also sets the rest of members to their default values.
/// @param new_inputs_number Number of inputs.
/// @param new_outputs_number Number of outputs.

void NeuralNetwork::set(const unsigned& new_inputs_number,
  ...
  multilayer_perceptron_pointer =
      new MultilayerPerceptron(new_inputs_number, new_outputs_number);
...
/// Sets a new multilayer_perceptron_pointer architecture with one hidden layer
/// and zero independent parameters.
/// It also sets the rest of members to their default values.
/// @param new_inputs_number Number of inputs.
...
void NeuralNetwork::set(const unsigned& new_inputs_number,
  ...
  multilayer_perceptron_pointer = new MultilayerPerceptron(
      new_inputs_number, new_hidden_neurons_number, new_outputs_number);
...
/// Sets a null new multilayer_perceptron_pointer architecture a given number of
/// independent parameters.
/// It also sets the rest of members to their default values.
/// @param new_independent_parameters_number Number of
/// independent_parameters_pointer.
...
/// Sets the members of this neural network object with those from other neural
/// network object.
/// @param other_neural_network Neural network object to be copied.
...
void NeuralNetwork::set_default(void) { display = true; }
...
/// @param new_multilayer_perceptron_pointer Pointer to a multilayer perceptron
/// object.
/// Note that the neural network destructror will delete this pointer.

void NeuralNetwork::set_multilayer_perceptron_pointer(
    MultilayerPerceptron* new_multilayer_perceptron_pointer) {
...
void NeuralNetwork::set_scaling_layer_pointer(
    ScalingLayer* new_scaling_layer_pointer) {
...
void NeuralNetwork::set_unscaling_layer_pointer(
    UnscalingLayer* new_unscaling_layer_pointer) {
...
void NeuralNetwork::set_bounding_layer_pointer(
    BoundingLayer* new_bounding_layer_pointer) {
...
/// @param new_probabilistic_layer_pointer Pointer to a probabilistic layer
/// object.
/// Note that the neural network destructror will delete this pointer.

void NeuralNetwork::set_probabilistic_layer_pointer(
    ProbabilisticLayer* new_probabilistic_layer_pointer) {
...
void NeuralNetwork::set_conditions_layer_pointer(
    ConditionsLayer* new_conditions_layer_pointer) {
...
/// @param new_independent_parameters_pointer Pointer to an independent
/// parameters object.
/// Note that the neural network destructror will delete this pointer.

void NeuralNetwork::set_independent_parameters_pointer(
    IndependentParameters* new_independent_parameters_pointer) {
...
unsigned NeuralNetwork::get_inputs_number(void) const {
  ...
  if (scaling_layer_pointer) {
    ...
    inputs_number =
        probabilistic_layer_pointer->get_probabilistic_neurons_number();
...
/// <LI> Multilayer perceptron architecture (if there is a multilayer
/// perceptron).</LI>
...
/// <LI> Number of probabilistic neurons (if there is a probabilistic
/// layer).</LI>
...
Vector<unsigned> NeuralNetwork::arrange_architecture(void) const {
  ...
  if (multilayer_perceptron_pointer) {
    architecture = architecture.assemble(
        multilayer_perceptron_pointer->arrange_layers_perceptrons_numbers());
  }
  ...
  if (conditions_layer_pointer) {
    architecture.push_back(
        conditions_layer_pointer->get_conditions_neurons_number());
  }
  ...
  if (bounding_layer_pointer) {
    architecture.push_back(
        bounding_layer_pointer->get_bounding_neurons_number());
  }
...
/// The number of parameters is the sum of all the multilayer perceptron
/// parameters (biases and synaptic weights) and independent parameters.
...
unsigned NeuralNetwork::count_parameters_number(void) const {
  ...
  if (independent_parameters_pointer) {
    parameters_number +=
        independent_parameters_pointer->get_parameters_number();
  }
...
/// Returns the values of the parameters in the multilayer perceptron as a
/// single vector.
/// This contains all the multilayer perceptron parameters (biases and synaptic
/// weights) and preprocessed independent parameters.
  ...
  if (multilayer_perceptron_pointer && !independent_parameters_pointer) {
    ...
    return (independent_parameters_pointer->calculate_scaled_parameters());
      ...
      // Both neural and independent parameters
               ...
               independent_parameters_pointer) {
    const Vector<double> network_parameters =
        multilayer_perceptron_pointer->arrange_parameters();

    const Vector<double> scaled_independent_parameters =
        independent_parameters_pointer->calculate_scaled_parameters();
...
/// Sets all the parameters (multilayer_perceptron_pointer parameters and
/// independent parameters) from a single vector.
...
// Control sentence (if debug)
  ...
  if (multilayer_perceptron_pointer &&
      !independent_parameters_pointer) {  // Only network parameters

    multilayer_perceptron_pointer->set_parameters(new_parameters);
  } else if (!multilayer_perceptron_pointer &&
             independent_parameters_pointer) {  // Only independent parameters

    independent_parameters_pointer->unscale_parameters(new_parameters);
  } else if (multilayer_perceptron_pointer &&
             independent_parameters_pointer) {  // Both network and independent
                                                // parameters
    ...
    const unsigned neural_parameters_number =
        multilayer_perceptron_pointer->count_parameters_number();
    const unsigned independent_parameters_number =
        independent_parameters_pointer->get_parameters_number();

    const Vector<double> network_parameters =
        new_parameters.take_out(0, neural_parameters_number);
    ...
    const Vector<double> scaled_independent_parameters =
        new_parameters.take_out(neural_parameters_number,
                                independent_parameters_number);

    independent_parameters_pointer->unscale_parameters(
        scaled_independent_parameters);
  } else {  // None neural neither independent parameters
...
/// This method constructs an empty multilayer perceptron within the neural
/// network.
...
/// The size of the scaling layer is the number of inputs in the multilayer
/// perceptron.
...
/// The size of the unscaling layer is the number of outputs in the multilayer
/// perceptron.
...
/// The size of the bounding layer is the number of outputs in the multilayer
/// perceptron.
...
/// The size of the probabilistic layer is the number of outputs in the
/// multilayer perceptron.
...
/// The number of external inputs in the conditions layer is the number of
/// inputs in the multilayer perceptron.
/// The size fo the conditions layer is the number of outputs in the multilayer
/// perceptron.
...
void NeuralNetwork::construct_conditions_layer(void) {
  if (!conditions_layer_pointer) {
    ...
    conditions_layer_pointer =
        new ConditionsLayer(inputs_number, outputs_number);
  }
}
...
/// This method constructs an independent parameters object within the neural
/// network.
...
/// This method deletes the independent parameters object within the neural
/// network.
...
/// This involves removing the output itself and the corresponding unscaling
/// layer,
/// conditions layer, probabilistic layer, bounding layer and multilayer
/// perceptron outputs.
...
/// That includes perceptron, scaling, unscaling, bounding, probabilistic or
/// conditions layers.
...
/// Initializes all the neural and the independent parameters with a given
/// value.
...
/// Initializes all the parameters in the newtork (biases and synaptic weiths +
/// independent parameters)
...
/// Initializes all the parameters in the newtork (biases and synaptic weiths +
/// independent
/// parameters) at random with values comprised between a given minimum and a
/// given maximum values.
/// @param minimum Minimum initialization value.
/// @param maximum Maximum initialization value.

void NeuralNetwork::randomize_parameters_uniform(const double& minimum,
                                                 const double& maximum) {
  if (multilayer_perceptron_pointer) {
    multilayer_perceptron_pointer->randomize_parameters_uniform(minimum,
                                                                maximum);
  }

  if (independent_parameters_pointer) {
    independent_parameters_pointer->randomize_parameters_uniform(minimum,
                                                                 maximum);
  }
}
...
/// Initializes all the parameters in the newtork (biases and synaptic weiths +
/// independent
/// parameters) at random with values comprised between a different minimum and
/// maximum numbers for each free
/// parameter.
...
/// Initializes all the parameters in the newtork (biases and synaptic weiths +
/// independent
/// parameters) values comprised between a different minimum and maximum numbers
/// for each parameter.
/// Minimum and maximum initialization values are given from a vector of two
/// real vectors.
/// The first element must contain the minimum initialization value for each
/// parameter.
/// The second element must contain the maximum initialization value for each
/// parameter.
...
/// Initializes all the parameters in the neural newtork (biases and synaptic
/// weiths + independent
/// parameters) at random with values chosen from a normal distribution with
...
/// Initializes all the parameters in the newtork (biases and synaptic weiths +
/// independent
/// parameters) at random with values chosen from a normal distribution with a
/// given mean and a given standard
/// deviation.
...
/// Initializes all the parameters in the neural newtork (biases and synaptic
/// weiths +
/// independent parameters) at random with values chosen from normal
/// distributions with a given mean and a given
...
/// Initializes all the parameters in the newtork (biases and synaptic weiths +
/// independent
/// parameters) at random with values chosen from normal distributions with a
/// given mean and a given standard
...
/// That contains the minimum, maximum, mean and standard deviation values of
/// the parameters.
...
Histogram<double> NeuralNetwork::calculate_parameters_histogram(
...
/// Calculates the outputs vector from the multilayer perceptron in response to
/// an inputs vector.
...
Vector<double> NeuralNetwork::calculate_outputs(
...
// Matrix<double> calculate_directional_input_data(const unsigned&, const
// Vector<double>&, const double&, const double&, const unsigned& = 101) const

/// Calculates the input data which is necessary to compute the output data from
/// the neural network in some direction.
...
Matrix<double> NeuralNetwork::calculate_directional_input_data(
    const unsigned& direction, const Vector<double>& point,
  ...
  for (unsigned i = 0; i < points_number; i++) {
    inputs[direction] =
        minimum + (maximum - minimum) * i / (double)(points_number - 1);
...
/// Returns which would be the outputs for a given inputs and a set of
/// parameters.
...
// Control sentence (if debug)
  ...
  if (multilayer_perceptron_pointer) {
    outputs =
        multilayer_perceptron_pointer->calculate_outputs(outputs, parameters);
  }
...
/// Calculates a set of outputs from the neural network in response to a set of
/// inputs.
/// The format is a matrix, where each row contains the output for a single
/// input.
/// @param input_data Matrix of inputs to the neural network.

Matrix<double> NeuralNetwork::calculate_output_data(
    const Matrix<double>& input_data) const {
  const unsigned inputs_number =
      multilayer_perceptron_pointer->get_inputs_number();
  const unsigned outputs_number =
      multilayer_perceptron_pointer->get_outputs_number();
...
// Control sentence (if debug)
  ...
  if (columns_number != inputs_number) {
    ...
    buffer << "OpenNN Exception: NeuralNetwork class.\n"
           << "Matrix<double> calculate_output_data(const Matrix<double>&) "
              "const method.\n"
...
/// Returns the Jacobian Matrix of the neural network for a set of inputs,
/// corresponding to the
/// point in inputs space at which the Jacobian Matrix is to be found. It uses a
/// forward-propagation method.
/// @param inputs Set of inputs to the neural network.
/// @todo

Matrix<double> NeuralNetwork::calculate_Jacobian(
    const Vector<double>& inputs) const {
#ifndef NDEBUG
  ...
  if (scaling_layer_pointer) {
    const Vector<double> scaling_layer_derivative =
        scaling_layer_pointer->calculate_derivatives(outputs);
    scaling_layer_Jacobian =
        scaling_layer_pointer->arrange_Jacobian(scaling_layer_derivative);
  ...
  if (multilayer_perceptron_pointer) {
    multilayer_perceptron_Jacobian =
        multilayer_perceptron_pointer->calculate_Jacobian(outputs);
  ...
  if (unscaling_layer_pointer) {
    const Vector<double> unscaling_layer_derivative =
        unscaling_layer_pointer->calculate_derivatives(outputs);
    unscaling_layer_Jacobian =
        unscaling_layer_pointer->arrange_Jacobian(unscaling_layer_derivative);
  ...
  if (probabilistic_layer_pointer) {
    probabilistic_layer_Jacobian =
        probabilistic_layer_pointer->calculate_Jacobian(outputs);
  ...
  if (bounding_layer_pointer) {
    const Vector<double>& derivatives =
        bounding_layer_pointer->calculate_derivative(outputs);

    bounding_layer_Jacobian =
        bounding_layer_pointer->arrange_Jacobian(derivatives);
  ...
  if (conditions_layer_pointer) {
    conditions_layer_Jacobian =
        conditions_layer_pointer->calculate_Jacobian(inputs, outputs, Jacobian);
...
/// Calculates a set of Jacobians from the neural network in response to a set
/// of inputs.
/// The format is a vector of matrices, where each element is the Jacobian
/// matrix for a single input.
/// @param input_data Matrix of inputs to the neural network.

Vector<Matrix<double> > NeuralNetwork::calculate_Jacobian_data(
    const Matrix<double>& input_data) const {
  const unsigned inputs_number = inputs_pointer->get_inputs_number();
...
/// Returns the partial derivatives of the outputs with respect to a given set
/// of parameters.
/// @todo
...
Matrix<double> NeuralNetwork::calculate_Jacobian(
    const Vector<double>& inputs, const Vector<double>& parameters) const {
  return (
      multilayer_perceptron_pointer->calculate_Jacobian(inputs, parameters));
}

// Vector< Matrix<double> > calculate_Hessian_form(const Vector<double>&) const
// method

/// Returns the second partial derivatives of the outputs with respect to the
/// inputs.
/// @todo

Vector<Matrix<double> > NeuralNetwork::calculate_Hessian_form(
    const Vector<double>& inputs) const {
...
/// Serializes the neural network object into a XML document of the TinyXML
/// library.
...
tinyxml2::XMLDocument* NeuralNetwork::to_XML(void) const {
  ...
  tinyxml2::XMLElement* neural_network_element =
      document->NewElement("NeuralNetwork");
  ...
  if (inputs_pointer) {
    ...
    const tinyxml2::XMLElement* inputsElement =
        inputs_document->FirstChildElement("Inputs");
  ...
  if (scaling_layer_pointer) {
    ...
    const tinyxml2::XMLDocument* scaling_layer_document =
        scaling_layer_pointer->to_XML();

    const tinyxml2::XMLElement* scaling_layer_element =
        scaling_layer_document->FirstChildElement("ScalingLayer");
  ...
  if (multilayer_perceptron_pointer) {
    ...
    const tinyxml2::XMLDocument* multilayer_perceptron_document =
        multilayer_perceptron_pointer->to_XML();

    const tinyxml2::XMLElement* multilayer_perceptron_element =
        multilayer_perceptron_document->FirstChildElement(
  ...
  if (unscaling_layer_pointer) {
    ...
    const tinyxml2::XMLDocument* unscaling_layer_document =
        unscaling_layer_pointer->to_XML();

    const tinyxml2::XMLElement* unscaling_layer_element =
        unscaling_layer_document->FirstChildElement("UnscalingLayer");
  ...
  if (probabilistic_layer_pointer) {
    ...
    const tinyxml2::XMLDocument* probabilistic_layer_document =
        probabilistic_layer_pointer->to_XML();

    const tinyxml2::XMLElement* probabilistic_layer_element =
        probabilistic_layer_document->FirstChildElement("ProbabilisticLayer");
  ...
  if (bounding_layer_pointer) {
    ...
    const tinyxml2::XMLDocument* bounding_layer_document =
        bounding_layer_pointer->to_XML();

    const tinyxml2::XMLElement* bounding_layer_element =
        bounding_layer_document->FirstChildElement("BoundingLayer");
  ...
  if (conditions_layer_pointer) {
    ...
    const tinyxml2::XMLDocument* conditions_layer_document =
        conditions_layer_pointer->to_XML();

    const tinyxml2::XMLElement* conditions_layer_element =
        conditions_layer_document->FirstChildElement("ConditionsLayer");
  ...
  if (outputs_pointer) {
    ...
    const tinyxml2::XMLElement* outputs_element =
        outputs_document->FirstChildElement("Outputs");
  ...
  if (independent_parameters_pointer) {
    tinyxml2::XMLElement* element =
        document->NewElement("IndependentParameters");
    neural_network_element->LinkEndChild(element);

    const tinyxml2::XMLDocument* independent_parameters_document =
        independent_parameters_pointer->to_XML();

    const tinyxml2::XMLElement* independent_parameters_element =
        independent_parameters_document->FirstChildElement(
...
void NeuralNetwork::from_XML(const tinyxml2::XMLDocument& document) {
  ...
  const tinyxml2::XMLElement* root_element =
      document.FirstChildElement("NeuralNetwork");
  ...
  // Inputs
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("Inputs");
    ...
    if (element) {
      ...
      tinyxml2::XMLElement* element_clone =
          inputs_document.NewElement("Inputs");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("Outputs");
    ...
    if (element) {
      ...
      tinyxml2::XMLElement* element_clone =
          outputs_document.NewElement("Outputs");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("MultilayerPerceptron");
    ...
    if (element) {
      ...
      tinyxml2::XMLElement* element_clone =
          multilayer_perceptron_document.NewElement("MultilayerPerceptron");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("ScalingLayer");
    ...
    if (element) {
      ...
      tinyxml2::XMLElement* element_clone =
          scaling_layer_document.NewElement("ScalingLayer");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("UnscalingLayer");
    ...
    if (element) {
      ...
      tinyxml2::XMLElement* element_clone =
          unscaling_layer_document.NewElement("UnscalingLayer");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("BoundingLayer");
    ...
    if (element) {
      ...
      tinyxml2::XMLElement* element_clone =
          bounding_layer_document.NewElement("BoundingLayer");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("ProbabilisticLayer");
    ...
    if (element) {
      ...
      tinyxml2::XMLElement* element_clone =
          probabilistic_layer_document.NewElement("ProbabilisticLayer");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("ConditionsLayer");
    ...
    if (element) {
      ...
      tinyxml2::XMLElement* element_clone =
          conditions_layer_document.NewElement("ConditionsLayer");
  ...
  {
    const tinyxml2::XMLElement* element =
        root_element->FirstChildElement("IndependentParameters");
    ...
    if (element) {
      ...
      tinyxml2::XMLElement* element_clone =
          independent_parameters_document.NewElement("IndependentParameters");
...
/// Prints to the screen the members of a neural network object in a XML-type
/// format.
...
std::string NeuralNetwork::write_expression(void) const {
  ...
  if (scaling_layer_pointer) {
    buffer << scaling_layer_pointer->write_expression(inputs_name,
                                                      scaled_inputs_name);
  }
  ...
  if (multilayer_perceptron_pointer) {
    if (scaling_layer_pointer && unscaling_layer_pointer) {
      buffer << multilayer_perceptron_pointer->write_expression(
                    scaled_inputs_name, scaled_outputs_name);
    } else if (scaling_layer_pointer && probabilistic_layer_pointer) {
      buffer << multilayer_perceptron_pointer->write_expression(
                    scaled_inputs_name, non_probabilistic_outputs_name);
    } else {
      buffer << multilayer_perceptron_pointer->write_expression(inputs_name,
                                                                outputs_name);
    }
  }
  ...
  if (unscaling_layer_pointer) {
    buffer << unscaling_layer_pointer->write_expression(scaled_outputs_name,
                                                        outputs_name);
  }
  ...
  if (probabilistic_layer_pointer) {
    buffer << probabilistic_layer_pointer->write_expression(
                  non_probabilistic_outputs_name, outputs_name);
  }
  ...
  //   if(conditions_layer_pointer)
  //   {
  //      buffer << conditions_layer_pointer->write_expression(inputs_name,
  // outputs_name);
  //   }
...
/// Saves the mathematical expression represented by the neural network to a
/// text file.
...
void NeuralNetwork::save_data(const std::string& file_name) const {
  ...
  const Vector<Statistics<double> > scaling_layer_statistics =
      scaling_layer_pointer->get_statistics();
  //   const Vector< Statistics<double> > unscaling_layer_statistics =
  // unscaling_layer_pointer->get_statistics();

  //   const Vector< Statistics<double> > inputs_minimums =
  // scaling_layer_pointer->get_minimums();
  //   const Vector<double> inputs_maximums =
  // scaling_layer_pointer->get_maximums();
  ...
  for (unsigned i = 0; i < inputs_number; i++) {
    ...
    increments[i] = (scaling_layer_statistics[i].maximum -
                     scaling_layer_statistics[i].minimum) /
