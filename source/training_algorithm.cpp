...
/// Default constructor.
/// It creates a training algorithm object not associated to any performance
/// functional object.
...
/// General constructor.
/// It creates a training algorithm object associated to a performance
/// functional object.
...
/// Assignment operator.
/// It assigns to this object the members of an existing training algorithm
/// object.
/// @param other_training_algorithm Training algorithm object to be assigned.

TrainingAlgorithm& TrainingAlgorithm::operator=(
    const TrainingAlgorithm& other_training_algorithm) {
  if (this != &other_training_algorithm) {
    performance_functional_pointer =
        other_training_algorithm.performance_functional_pointer;
...
/// Equal to operator.
/// @param other_training_algorithm Training algorithm object to be compared
/// with.

/// @todo

bool TrainingAlgorithm::operator==(
    const TrainingAlgorithm& other_training_algorithm) const {
...
PerformanceFunctional* TrainingAlgorithm::get_performance_functional_pointer(
    void) const {
#ifndef NDEBUG
...
/// Returns true if this training algorithm object has an associated performance
/// functional object,
/// and false otherwise.
...
const bool& TrainingAlgorithm::get_display(void) const { return (display); }
...
void TrainingAlgorithm::set_performance_functional_pointer(
    PerformanceFunctional* new_performance_functional_pointer) {
  performance_functional_pointer = new_performance_functional_pointer;
}
...
void TrainingAlgorithm::set_default(void) { display = true; }
...
/// In particular, it checks that the performance functional pointer associated
/// to the training algorithm is not NULL,
/// and that the neural network associated to that performance functional is
/// neither NULL.
...
/// Serializes a default training algorithm object into a XML document of the
/// TinyXML library.
/// See the OpenNN manual for more information about the format of this
/// document.

tinyxml2::XMLDocument* TrainingAlgorithm::to_XML(void) const { return (NULL); }
...
/// Prints to the screen the XML-type representation of the training algorithm
/// object.

void TrainingAlgorithm::print(void) const { std::cout << to_string(); }
