 ...
 */
/*                                                                                                              */
/*   L E V E N B E R G - M A R Q U A R D T   A L G O R I T H M   C L A S S   H E
 * A D E R                        */
/*                                                                                                              */
/*   Roberto Lopez
 */
...
/// algorithm for the sum squared error performance functional for a multilayer
/// perceptron.
...
class LevenbergMarquardtAlgorithm : public TrainingAlgorithm {
 ...
 public:
  ...
  ///
  /// This structure contains the training results for the Levenberg-Marquardt
  /// algorithm.
  ///

  struct LevenbergMarquardtAlgorithmResults
      : public TrainingAlgorithm::Results {
    /// Default constructor.
    ...
    LevenbergMarquardtAlgorithmResults(
        LevenbergMarquardtAlgorithm*
            new_Levenberg_Marquardt_algorithm_pointer) {
    ...
    /// Pointer to the Levenberg-Marquardt algorithm object for which the
    /// training results are to be stored.
 ...
 private:
  ...
  /// True if the damping parameter history vector is to be reserved, false
  /// otherwise.

  bool reserve_damping_parameter_history;

  /// Vector containing the damping parameter history over the training
  /// iterations.
  ...
  /// True if the Hessian history vector of matrices is to be reserved, false
  /// otherwise.
