...
ConditionsLayer::ConditionsLayer(const unsigned& new_inputs_number, const unsigned& new_conditions_neurons_number)
{
...
const double& ConditionsLayer::get_external_input_value(const unsigned& i) const
{
...
// const double& get_exteoutput_value(const unsigned&, const unsigned&) const method

/// Returns a single output value for the conditions. 
/// @param i Index of output. 
/// @param j Index of condition. 

const double& ConditionsLayer::get_output_value(const unsigned& i, const unsigned& j) const
{
...
void ConditionsLayer::set(const unsigned& new_external_inputs_number, const unsigned& new_conditions_neurons_number)
{
...
void ConditionsLayer::set_external_inputs_number(const unsigned& new_external_inputs_number)
{
   external_inputs_number = new_external_inputs_number;
}
...
void ConditionsLayer::set_conditions_neurons_number(const unsigned& new_conditions_neurons_number)
{
   conditions_neurons_number = new_conditions_neurons_number;
}
...
void ConditionsLayer::set_external_input_value(const unsigned& i, const double& new_external_input_value)
{
...
void ConditionsLayer::set_output_value(const unsigned& i, const unsigned& j, const double& new_output_value)
{
