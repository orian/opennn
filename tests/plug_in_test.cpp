...
void PlugInTest::test_get_display(void) { message += "test_get_display\n"; }
...
void PlugInTest::test_set_display(void) { message += "test_set_display\n"; }
...
void PlugInTest::test_to_XML(void) { message += "test_to_XML\n"; }

void PlugInTest::test_from_XML(void) { message += "test_from_XML\n"; }
...
void PlugInTest::test_load(void) { message += "test_load\n"; }
