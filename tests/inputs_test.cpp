...
void InputsTest::test_destructor(void) { message += "test_destructor\n"; }
...
void InputsTest::test_set(void) { message += "test_set\n"; }

void InputsTest::test_set_default(void) { message += "test_set_default\n"; }
...
void InputsTest::test_get_display(void) { message += "test_get_display\n"; }

void InputsTest::test_set_names(void) { message += "test_set_names\n"; }

void InputsTest::test_set_name(void) { message += "test_set_name\n"; }

void InputsTest::test_set_units(void) { message += "test_set_units\n"; }

void InputsTest::test_set_unit(void) { message += "test_set_unit\n"; }
...
void InputsTest::test_set_display(void) { message += "test_set_display\n"; }
