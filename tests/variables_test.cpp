...
void VariablesTest::test_get_name(void) { message += "test_get_name\n"; }
...
void VariablesTest::test_get_unit(void) { message += "test_get_unit\n"; }
...
void VariablesTest::test_set_input(void) { message += "test_set_input\n"; }

void VariablesTest::test_set_target(void) { message += "test_set_target\n"; }

void VariablesTest::test_set_names(void) { message += "test_set_names\n"; }

void VariablesTest::test_set_name(void) { message += "test_set_name\n"; }

void VariablesTest::test_set_units(void) { message += "test_set_units\n"; }

void VariablesTest::test_set_unit(void) { message += "test_set_unit\n"; }
...
void VariablesTest::test_set_display(void) { message += "test_set_display\n"; }
