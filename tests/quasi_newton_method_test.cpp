...
void QuasiNewtonMethodTest::test_get_inverse_Hessian_approximation_method(
  ...
  assert_true(
      qnm.get_inverse_Hessian_approximation_method() == QuasiNewtonMethod::DFP,
      LOG);

  qnm.set_inverse_Hessian_approximation_method(QuasiNewtonMethod::BFGS);
  assert_true(
      qnm.get_inverse_Hessian_approximation_method() == QuasiNewtonMethod::BFGS,
      LOG);
}
...
void QuasiNewtonMethodTest::test_calculate_DFP_inverse_Hessian_approximation(
  ...
  //   = qnm.calculate_DFP_inverse_Hessian(old_parameters, parameters,
  // old_gradient, gradient, old_inverse_Hessian);
  ...
  //   DFP_inverse_Hessian = qnm.calculate_DFP_inverse_Hessian(old_parameters,
  // parameters, old_gradient, gradient, old_inverse_Hessian);
...
void QuasiNewtonMethodTest::test_calculate_BFGS_inverse_Hessian_approximation(
  ...
  //   = qnm.calculate_BFGS_inverse_Hessian(old_parameters, parameters,
  // old_gradient, gradient, old_inverse_Hessian);
...
void QuasiNewtonMethodTest::test_calculate_inverse_Hessian_approximation(void) {
  ...
  //   = qnm.calculate_inverse_Hessian_approximation(old_parameters, parameters,
  // old_gradient, gradient, old_inverse_Hessian);
...
void QuasiNewtonMethodTest::test_perform_training(void) {
  ...
  qnm.set_maximum_iterations_number(2), qnm.set_display(false);
