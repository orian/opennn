...
void NormalizedSquaredErrorTest::test_calculate_performance(void) {
  ...
  assert_true(
      nse.calculate_performance() == nse.calculate_performance(parameters),
      LOG);
}

void NormalizedSquaredErrorTest::test_calculate_generalization_performance(
    void) {
...
void NormalizedSquaredErrorTest::test_calculate_gradient(void) {
  ...
  numerical_objective_gradient = nd.calculate_gradient(
      nse, &NormalizedSquaredError::calculate_performance, network_parameters);
...
void NormalizedSquaredErrorTest::test_calculate_Jacobian_terms(void) {
  ...
  numerical_Jacobian_terms = nd.calculate_Jacobian(
      nse, &NormalizedSquaredError::calculate_terms, network_parameters);
