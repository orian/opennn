...
void
NumericalDifferentiationTest::test_calculate_forward_differences_derivative(
    void) {
  ...
  x = 0.0;
  d = nd.calculate_forward_differences_derivative(
      *this, &NumericalDifferentiationTest::f1, x);

  assert_true(d == 1.0, LOG);
}

void
NumericalDifferentiationTest::test_calculate_central_differences_derivative(
    void) {
  ...
  x = 0.0;
  d = nd.calculate_central_differences_derivative(
      *this, &NumericalDifferentiationTest::f1, x);
...
void NumericalDifferentiationTest::
    test_calculate_forward_differences_second_derivative(void) {
  ...
  x = 0.0;
  d2 = nd.calculate_forward_differences_second_derivative(
      *this, &NumericalDifferentiationTest::f1, x);
...
void NumericalDifferentiationTest::
    test_calculate_central_differences_second_derivative(void) {
  ...
  x = 0.0;
  d2 = nd.calculate_central_differences_second_derivative(
      *this, &NumericalDifferentiationTest::f1, x);
...
void NumericalDifferentiationTest::test_calculate_second_derivative(void) {
  ...
  x = 0.0;
  d2 = nd.calculate_second_derivative(*this, &NumericalDifferentiationTest::f1,
                                      x);
...
void NumericalDifferentiationTest::test_calculate_forward_differences_gradient(
  ...
  g = nd.calculate_forward_differences_gradient(
      *this, &NumericalDifferentiationTest::f2, x);
...
void NumericalDifferentiationTest::test_calculate_central_differences_gradient(
  ...
  g = nd.calculate_central_differences_gradient(
      *this, &NumericalDifferentiationTest::f2, x);
...
void NumericalDifferentiationTest::test_calculate_forward_differences_Hessian(
  ...
  x.set(2, 0.0);
  H = nd.calculate_forward_differences_Hessian(
      *this, &NumericalDifferentiationTest::f2, x);
...
void NumericalDifferentiationTest::test_calculate_central_differences_Hessian(
  ...
  x.set(2, 0.0);
  H = nd.calculate_central_differences_Hessian(
      *this, &NumericalDifferentiationTest::f2, x);
...
void NumericalDifferentiationTest::test_calculate_forward_differences_Jacobian(
  ...
  J = nd.calculate_forward_differences_Jacobian(
      *this, &NumericalDifferentiationTest::f3, x);
...
void NumericalDifferentiationTest::test_calculate_central_differences_Jacobian(
  ...
  J = nd.calculate_central_differences_Jacobian(
      *this, &NumericalDifferentiationTest::f3, x);
...
void
NumericalDifferentiationTest::test_calculate_forward_differences_Hessian_form(
    void) {
  ...
  x.set(2, 0.0);
  H = nd.calculate_forward_differences_Hessian_form(
      *this, &NumericalDifferentiationTest::f3, x);
...
void
NumericalDifferentiationTest::test_calculate_central_differences_Hessian_form(
    void) {
  ...
  Vector<Matrix<double> > Hessian =
      nd.calculate_central_differences_Hessian_form(
          *this, &NumericalDifferentiationTest::f3, x);
...
double NumericalDifferentiationTest::f1(const double& x) const { return (x); }
