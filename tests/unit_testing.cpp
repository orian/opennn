...
unsigned UnitTesting::get_tests_count(void) const { return (tests_count); }
...
std::string& UnitTesting::get_message(void) { return (message); }

// const bool& get_display(void) const method

/// Returns the display messages to the screen value of this object.

const bool& UnitTesting::get_display(void) const { return (display); }
...
void UnitTesting::set_tests_passed_count(
    const unsigned& new_tests_passed_count) {
...
void UnitTesting::set_tests_failed_count(
    const unsigned& new_tests_failed_count) {
  tests_failed_count = new_tests_failed_count;
}

// void set_numerical_differentiation_tests(bool) method

void UnitTesting::set_numerical_differentiation_tests(
    const bool& new_numerical_differentiation_tests) {
...
void UnitTesting::set_random_tests_number(
    const unsigned& new_random_tests_number) {
...
/// It appends to the information message an error message is the condition is
/// not satisfied.
/// @param condition Expression of the condition to be tested.
/// @param error_message Error message to be appended to the information
/// message,
/// typically the file name and the line where the condition has been tested.

void UnitTesting::assert_true(const bool& condition,
...
void UnitTesting::assert_false(const bool& condition,
                               const std::string& error_message) {
  tests_count++;
...
void UnitTesting::print_results(void) {
  ...
  if (tests_failed_count == 0) {
    ...
    std::cout << "Test case NOT OK: " << tests_failed_count << " tests failed."
              << std::endl;
  }
}
