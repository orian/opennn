...
void PatternRecognitionTestingTest::test_calculate_binary_training_output_data(
    void) {
  ...
  Matrix<bool> binary_training_output_data =
      cu.calculate_binary_training_output_data();
...
void
PatternRecognitionTestingTest::test_calculate_binary_validation_output_data(
    void) {
...
void PatternRecognitionTestingTest::test_calculate_binary_testing_output_data(
    void) {
...
void PatternRecognitionTestingTest::test_get_binary_validation_target_data(
    void) {
...
void PatternRecognitionTestingTest::test_calculate_binary_classification_test(
    void) {
