...
class MockPerformanceTerm : public PerformanceTerm {
 ...
 public:
  ...
  Vector<double> calculate_sum_squared_parameters_gradient(
      const Vector<double>&) const;
  Matrix<double> calculate_sum_squared_parameters_Hessian(
      const Vector<double>&) const;
