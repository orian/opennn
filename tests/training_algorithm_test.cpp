...
void TrainingAlgorithmTest::test_set(void) { message += "test_set\n"; }
...
void TrainingAlgorithmTest::test_to_XML(void) { message += "test_to_XML\n"; }

void TrainingAlgorithmTest::test_from_XML(void) {
  message += "test_from_XML\n";
}

void TrainingAlgorithmTest::test_print(void) { message += "test_print\n"; }
