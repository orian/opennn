...
void RootMeanSquaredErrorTest::test_calculate_performance(void) {
  ...
  assert_true(
      rmse.calculate_performance() == rmse.calculate_performance(parameters),
      LOG);
}
...
void RootMeanSquaredErrorTest::test_calculate_gradient(void) {
  ...
  numerical_objective_gradient = nd.calculate_gradient(
      rmse, &RootMeanSquaredError::calculate_performance, network_parameters);
...
void RootMeanSquaredErrorTest::test_to_XML(void) { message += "test_to_XML\n"; }
