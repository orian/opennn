...
void ScalingLayerTest::test_destructor(void) { message += "test_destructor\n"; }
...
void ScalingLayerTest::test_set(void) { message += "test_set\n"; }
...
void ScalingLayerTest::test_get_mean(void) { message += "test_get_mean\n"; }
...
void ScalingLayerTest::test_set_means(void) { message += "test_set_means\n"; }
...
void ScalingLayerTest::test_set_mean(void) { message += "test_set_mean\n"; }
...
void ScalingLayerTest::test_get_scaling_method(void) {
  ...
  assert_true(sl.get_scaling_method() == ScalingLayer::MeanStandardDeviation,
              LOG);
