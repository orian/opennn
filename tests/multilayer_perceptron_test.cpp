...
void MultilayerPerceptronTest::test_count_cumulative_perceptrons_number(void) {
  ...
  Vector<unsigned> cumulative_neurons_number;
...
void MultilayerPerceptronTest::test_arrange_layers_parameters_number(void) {
  ...
  MultilayerPerceptron n;
  Vector<unsigned> layers_parameters_number;
  Vector<unsigned> architecture(3, 1);
...
void MultilayerPerceptronTest::test_set(void) { message += "test_set\n"; }
...
void MultilayerPerceptronTest::test_get_parameter_indices(void) {
  ...
  Vector<unsigned> parameter_indices(3);
...
void MultilayerPerceptronTest::test_arrange_parameters_indices(void) {
  ...
  Matrix<unsigned> parameters_indices;
...
void MultilayerPerceptronTest::test_calculate_parameters_norm(void) {
  ...
  assert_true(fabs(parameters_norm - parameters.calculate_norm()) < 1.0e-6,
              LOG);
}
...
void MultilayerPerceptronTest::test_calculate_outputs(void) {
  ...
  assert_true(mlp.calculate_outputs(inputs) ==
                  mlp.calculate_outputs(inputs, parameters),
              LOG);
...
void MultilayerPerceptronTest::test_calculate_Jacobian(void) {
  ...
  assert_true((Jacobian - output_layer_Jacobian.dot(hidden_layer_Jacobian))
  ...
  if (numerical_differentiation_tests) {
    numerical_Jacobian = nd.calculate_Jacobian(
        n, &MultilayerPerceptron::calculate_outputs, inputs);
    assert_true(
  ...
  for (unsigned i = 0; i < random_tests_number; i++) {
    n.initialize_random();
...
void MultilayerPerceptronTest::test_calculate_Hessian_form(void) {
  ...
  if (numerical_differentiation_tests) {
    //      numerical_Hessian_form = nd.calculate_Hessian_form(n,
    // &MultilayerPerceptron::calculate_outputs, inputs);

    //      assert_true((Hessian_form[0]-numerical_Hessian_form[0]).calculate_absolute_value()
    // < 1.0e-3, LOG);
  }
  ...
  if (numerical_differentiation_tests) {
    ...
    //    assert_true((Hessian_form[0]-numerical_Hessian_form[0]).calculate_absolute_value()
    // < 1.0e-3, LOG);
    //    assert_true((Hessian_form[1]-numerical_Hessian_form[1]).calculate_absolute_value()
    // < 1.0e-3, LOG);
  }
  ...
  //   output_layer_Jacobian = n.calculate_layer_Jacobian(1,
  // hidden_layer_output);
  //   output_layer_Hessian_form = n.calculate_layer_Hessian_form(1,
  // hidden_layer_output);
  ...
  //   Hessian =
  // hidden_layer_Jacobian.calculate_transpose().dot(output_layer_Hessian_form[0]).dot(hidden_layer_Jacobian)
  ...
  //   Hessian =
  // hidden_layer_Jacobian.calculate_transpose().dot(output_layer_Hessian_form[1]).dot(hidden_layer_Jacobian)
  ...
  //   Hessian =
  // hidden_layer_Jacobian.calculate_transpose().dot(output_layer_Hessian_form[2]).dot(hidden_layer_Jacobian)
  ...
  //	     {
  //         assert_true((Hessian_form[j]-numerical_Hessian_form[j]).calculate_absolute_value()
  // < 1.0e-3, LOG);
  //	     }
  //      }
  //   }
...
void MultilayerPerceptronTest::test_calculate_layer_combination_combination(
  ...
  layer_combination_combination =
      n.calculate_layer_combination_combination(1, previous_layer_combination);
  ...
  layer_combination_combination =
      n.calculate_layer_combination_combination(1, hidden_layer_combination);

  assert_true((layer_combination_combination - output_layer_combination)
                      .calculate_absolute_value() <
                  1.0e-3,
              LOG);
}
...
void
MultilayerPerceptronTest::test_calculate_layer_combination_combination_Jacobian(
    void) {
  ...
  layer_combination_combination_Jacobian =
      n.calculate_layer_combination_combination_Jacobian(
          1, previous_layer_combination);
  ...
  previous_layer_activation_derivative =
      previous_layer.calculate_activations_derivatives(
          previous_layer_combination);

  layer_combination_combination_Jacobian =
      n.calculate_layer_combination_combination_Jacobian(
          1, previous_layer_activation_derivative);

  if (numerical_differentiation_tests) {
    numerical_layer_combination_combination_Jacobian = nd.calculate_Jacobian(
        n, &MultilayerPerceptron::calculate_layer_combination_combination, 1,
        previous_layer_combination);

    assert_true((layer_combination_combination_Jacobian -
                 numerical_layer_combination_combination_Jacobian)
                        .calculate_absolute_value() <
                    1.0e-3,
                LOG);
  }
  ...
  hidden_layer_activation =
      hidden_layer.calculate_activations(hidden_layer_combination);
  hidden_layer_activation_derivative =
      hidden_layer.calculate_activations_derivatives(hidden_layer_combination);

  const PerceptronLayer& output_layer = n.get_layer(1);

  output_layer_combination =
      output_layer.calculate_combinations(hidden_layer_activation);

  layer_combination_combination_Jacobian =
      n.calculate_layer_combination_combination_Jacobian(
          1, hidden_layer_activation_derivative);
...
void
MultilayerPerceptronTest::test_calculate_interlayer_combination_combination(
    void) {
  ...
  interlayer_combination_combination =
      n.calculate_interlayer_combination_combination(0, 0,
                                                     hidden_layer_combination);

  assert_true((interlayer_combination_combination - hidden_layer_combination)
                      .calculate_absolute_value() <
                  1.0e-3,
              LOG);

  interlayer_combination_combination =
      n.calculate_interlayer_combination_combination(0, 1,
                                                     hidden_layer_combination);

  assert_true((interlayer_combination_combination - output_layer_combination)
                      .calculate_absolute_value() <
                  1.0e-3,
              LOG);

  interlayer_combination_combination =
      n.calculate_interlayer_combination_combination(1, 1,
                                                     output_layer_combination);
...
void MultilayerPerceptronTest::
    test_calculate_interlayer_combination_combination_Jacobian(void) {
  ...
  /*
     ...
     hidden_layer_activation =
  hidden_layer.calculate_activation(hidden_layer_combination);
  
     hidden_layer_activation_derivative =
  hidden_layer.calculate_activation_derivative(hidden_layer_combination);
  
     const PerceptronLayer& output_layer = n.get_layer(1);
  
     output_layer_combination =
  output_layer.calculate_combination(hidden_layer_activation);
  
     interlayer_combination_combination_Jacobian =
  n.calculate_interlayer_combination_combination_Jacobian(0, 0,
  hidden_layer_combination);
     assert_true(interlayer_combination_combination_Jacobian.get_rows_number()
  == 4, LOG);
     assert_true(interlayer_combination_combination_Jacobian.get_columns_number()
  == 4, LOG);
     assert_true(interlayer_combination_combination_Jacobian.is_identity(),
  LOG);
  
     if(numerical_differentiation_tests)
     {
        numerical_interlayer_combination_combination_Jacobian =
  nd.calculate_Jacobian(n,
  &MultilayerPerceptron::calculate_interlayer_combination_combination, 0, 0,
  hidden_layer_combination);
        assert_true((interlayer_combination_combination_Jacobian-numerical_interlayer_combination_combination_Jacobian).calculate_absolute_value()
  < 1.0e-3, LOG);			    
     }
  
     interlayer_combination_combination_Jacobian =
  n.calculate_interlayer_combination_combination_Jacobian(0, 1,
  hidden_layer_combination);
     assert_true(interlayer_combination_combination_Jacobian.get_rows_number()
  == 3, LOG);
     assert_true(interlayer_combination_combination_Jacobian.get_columns_number()
  == 4, LOG);
     ...
     layer_combination_combination_Jacobian =
  n.calculate_layer_combination_combination_Jacobian(1,
  hidden_layer_activation_derivative);
     assert_true((interlayer_combination_combination_Jacobian -
  layer_combination_combination_Jacobian).calculate_absolute_value() < 1.0e-3,
  LOG);
     ...
     if(numerical_differentiation_tests)
     {
        numerical_interlayer_combination_combination_Jacobian =
  nd.calculate_Jacobian(n,
  &MultilayerPerceptron::calculate_interlayer_combination_combination, 0, 1,
  hidden_layer_combination);
        assert_true((interlayer_combination_combination_Jacobian-numerical_interlayer_combination_combination_Jacobian).calculate_absolute_value()
  < 1.0e-3, LOG);			    
     }
     ...
     interlayer_combination_combination_Jacobian =
  n.calculate_interlayer_combination_combination_Jacobian(1, 0,
  hidden_layer_combination);
     assert_true(interlayer_combination_combination_Jacobian.get_rows_number()
  == 4, LOG);
     assert_true(interlayer_combination_combination_Jacobian.get_columns_number()
  == 3, LOG);
     ...
     interlayer_combination_combination_Jacobian =
  n.calculate_interlayer_combination_combination_Jacobian(1, 1,
  output_layer_combination);
     assert_true(interlayer_combination_combination_Jacobian.get_rows_number()
  == 3, LOG);
     assert_true(interlayer_combination_combination_Jacobian.get_columns_number()
  ...
  LOG);
     ...
     if(numerical_differentiation_tests)
     {
        numerical_interlayer_combination_combination_Jacobian =
  nd.calculate_Jacobian(n,
  &MultilayerPerceptron::calculate_interlayer_combination_combination, 1, 1,
  output_layer_combination);
        assert_true((interlayer_combination_combination_Jacobian-numerical_interlayer_combination_combination_Jacobian).calculate_absolute_value()
  < 1.0e-3, LOG);			    
     }
  ...
  domain_index++)
     {
           for(unsigned image_index = 0; image_index < layers_number;
  image_index++)
        {              
              interlayer_combination_combination_Jacobian =
  n.calculate_interlayer_combination_combination_Jacobian(domain_index,
  image_index, layers_combination[domain_index]);
  ...
  < 1.0e-3, LOG);			    
     ...
     {
                 assert_true(interlayer_combination_combination_Jacobian == 0.0,
  LOG);			    
        }
        }	     
        }   
...
void MultilayerPerceptronTest::
    test_calculate_interlayers_combination_combination_Jacobian(void) {
  ...
  interlayers_combination_combination_Jacobian =
      n.calculate_interlayers_combination_combination_Jacobian(inputs);

  assert_true(
      interlayers_combination_combination_Jacobian.get_rows_number() == 0, LOG);
  assert_true(
      interlayers_combination_combination_Jacobian.get_columns_number() == 0,
      LOG);
  ...
  assert_true(
      interlayers_combination_combination_Jacobian.get_rows_number() == 1, LOG);
  assert_true(
      interlayers_combination_combination_Jacobian.get_columns_number() == 1,
      LOG);
  assert_true(
      interlayers_combination_combination_Jacobian[0][0].get_rows_number() == 1,
      LOG);
  assert_true(
      interlayers_combination_combination_Jacobian[0][0].get_columns_number() ==
          1,
      LOG);
  ...
  assert_true(
      ...
      LOG);
  assert_true(
      interlayers_combination_combination_Jacobian[0][0].get_rows_number() == 2,
      LOG);
  assert_true(
      interlayers_combination_combination_Jacobian[0][0].get_columns_number() ==
          2,
      LOG);
  assert_true(interlayers_combination_combination_Jacobian[0][0].is_identity(),
              LOG);
  ...
  assert_true(
      interlayers_combination_combination_Jacobian.get_rows_number() == 2, LOG);
  assert_true(
      interlayers_combination_combination_Jacobian.get_columns_number() == 2,
      LOG);
  ...
  assert_true(
      interlayers_combination_combination_Jacobian.get_rows_number() == 3, LOG);
  assert_true(
      interlayers_combination_combination_Jacobian.get_columns_number() == 3,
      LOG);
  ...
  assert_true(
      interlayers_combination_combination_Jacobian[0][0].get_rows_number() == 4,
      LOG);
  assert_true(
      interlayers_combination_combination_Jacobian[0][0].get_columns_number() ==
          4,
  ...
  assert_true(
      interlayers_combination_combination_Jacobian[0][1].get_rows_number() == 4,
      LOG);
  assert_true(
      interlayers_combination_combination_Jacobian[0][1].get_columns_number() ==
          3,
      LOG);

  assert_true(
      interlayers_combination_combination_Jacobian[1][0].get_rows_number() == 3,
      LOG);
  assert_true(
      interlayers_combination_combination_Jacobian[1][0].get_columns_number() ==
          4,
      LOG);

  assert_true(
      interlayers_combination_combination_Jacobian[1][1].get_rows_number() == 3,
      LOG);
  assert_true(
      interlayers_combination_combination_Jacobian[1][1].get_columns_number() ==
          3,
      LOG);
  ...
  for (unsigned i = 0; i < random_tests_number; i++) {
    ...
    for (unsigned domain_index = 0; domain_index < layers_number;
      ...
      for (unsigned image_index = 0; image_index < layers_number;
           image_index++) {
        if (domain_index > image_index) {
          assert_true(interlayers_combination_combination_Jacobian[image_index][
                          domain_index] ==
                          0.0,
                      LOG);
        } else {
          if (numerical_differentiation_tests) {
            ...
            // domain_index, image_index, layers_combination[domain_index]);
            // 
            // assert_true((interlayers_combination_combination_Jacobian[image_index][domain_index]
            // -
            // numerical_interlayer_combination_combination_Jacobian).calculate_absolute_value()
            // < 1.0e-3, LOG);
          }
        }
      }
...
void MultilayerPerceptronTest::test_calculate_output_layers_delta(void) {
  ...
  // n.calculate_layers_activation_derivative(inputs);

  //   output_layers_delta =
  // n.calculate_output_layers_delta(layers_activation_derivative);

  //   assert_true(output_layers_delta.size() == layers_number, LOG);

  //   assert_true(output_layers_delta[0].get_rows_number() == architecture[1],
  // LOG);
  //   assert_true(output_layers_delta[0].get_columns_number() ==
  // architecture[0], LOG);

  //   assert_true(output_layers_delta[1].get_rows_number() == architecture[1],
  // LOG);
  //   assert_true(output_layers_delta[1].get_columns_number() ==
  // architecture[1], LOG);
  ...
  if (numerical_differentiation_tests) {
    numerical_hidden_layer_output_delta = nd.calculate_Jacobian(
        n, &MultilayerPerceptron::calculate_output_layer_combination, 0,
        hidden_layer_combination);

    assert_true((numerical_hidden_layer_output_delta - output_layers_delta[0])
                        .calculate_absolute_value() <
                    1.0e-3,
                LOG);

    numerical_output_layer_output_delta = nd.calculate_Jacobian(
        n, &MultilayerPerceptron::calculate_output_layer_combination, 1,
        output_layer_combination);

    assert_true((numerical_output_layer_output_delta - output_layers_delta[1])
                        .calculate_absolute_value() <
                    1.0e-3,
                LOG);
  }
  ...
  if (numerical_differentiation_tests) {
    for (unsigned i = 0; i < random_tests_number; i++) {
      ...
      for (unsigned i = 0; i < layers_number; i++) {
        numerical_layer_output_delta = nd.calculate_Jacobian(
            n, &MultilayerPerceptron::calculate_output_layer_combination, i,
            layers_combination[i]);

        assert_true((numerical_layer_output_delta - output_layers_delta[i])
                            .calculate_absolute_value() <
                        1.0e-3,
                    LOG);
      }
...
void MultilayerPerceptronTest::test_calculate_output_interlayers_Delta(void) {
  ...
  layers_activation_second_derivative =
      n.calculate_layers_activation_second_derivative(inputs);

  second_order_forward_propagation =
      n.calculate_second_order_forward_propagation(inputs);

  interlayers_combination_combination_Jacobian =
      n.calculate_interlayers_combination_combination_Jacobian(
          layers_combination);

  output_layers_delta =
      n.calculate_output_layers_delta(layers_activation_derivative);

  output_interlayers_Delta = n.calculate_output_interlayers_Delta(
      second_order_forward_propagation,
  ...
  if (numerical_differentiation_tests) {
    numerical_output_layer_output_layer_output_Delta =
        nd.calculate_Hessian_form(
            n, &MultilayerPerceptron::calculate_output_layer_combination, 0,
            layers_combination[0]);
    assert_true((numerical_output_layer_output_layer_output_Delta[0] -
                 output_interlayers_Delta[0][0][0]).calculate_absolute_value() <
                    1.0e-3,
                LOG);
    assert_true((numerical_output_layer_output_layer_output_Delta[1] -
                 output_interlayers_Delta[0][0][1]).calculate_absolute_value() <
                    1.0e-3,
                LOG);
  }
  ...
  if (numerical_differentiation_tests) {
    ...
    assert_true((numerical_output_layer_output_layer_output_Delta[1] -
                 output_interlayers_Delta[0][0][1]).calculate_absolute_value() <
                    1.0e-3,
                LOG);
    assert_true((numerical_output_layer_output_layer_output_Delta[2] -
                 output_interlayers_Delta[0][0][2]).calculate_absolute_value() <
                    1.0e-3,
                LOG);
  }
  ...
  if (numerical_differentiation_tests) {
    ...
    assert_true((numerical_output_layer_output_layer_output_Delta[0] -
                 output_interlayers_Delta[1][1][0]).calculate_absolute_value() <
                    1.0e-3,
                LOG);

    numerical_hidden_layer_hidden_layer_output_Delta =
        nd.calculate_Hessian_form(
            n, &MultilayerPerceptron::calculate_output_layer_combination, 0,
            layers_combination[0]);
    //      assert_true((numerical_hidden_layer_hidden_layer_output_Delta[0] -
    // output_interlayers_Delta[0][0][0]).calculate_absolute_value() < 1.0e-3,
    // LOG);
  }
  ...
  if (numerical_differentiation_tests) {
    ...
    //      numerical_hidden_layer_hidden_layer_output_Delta =
    // nd.calculate_Hessian_form(n,
    // &MultilayerPerceptron::calculate_output_layer_combination, 0,
    // layers_combination[0]);
    //      assert_true((numerical_hidden_layer_hidden_layer_output_Delta[0] -
    // output_interlayers_Delta[0][0][0]).calculate_absolute_value() < 1.0e-3,
    // LOG);
  ...
  if (numerical_differentiation_tests) {
    numerical_output_layer_output_layer_output_Delta =
        nd.calculate_Hessian_form(
            ...
            layers_combination[1]);
    //   assert_true((numerical_output_layer_output_layer_output_Delta[0] -
    // output_interlayers_Delta[1][1][0]).calculate_absolute_value() < 1.0e-3,
    // LOG);
  ...
  if (numerical_differentiation_tests) {
    //      numerical_output_layer_output_layer_output_Delta =
    // nd.calculate_Hessian_form(n,
    // &MultilayerPerceptron::calculate_output_layer_combination, 1,
    // layers_combination[1]);
    //   assert_true((numerical_output_layer_output_layer_output_Delta[0] -
    // output_interlayers_Delta[1][1][0]).calculate_absolute_value() < 1.0e-3,
    // LOG);
  ...
  if (numerical_differentiation_tests) {
    ...
    // LOG);
    //   assert_true((numerical_output_layer_output_layer_output_Delta[1] -
    // output_interlayers_Delta[1][1][1]).calculate_absolute_value() < 1.0e-3,
    // LOG);
    //   assert_true((numerical_output_layer_output_layer_output_Delta[2] -
    // output_interlayers_Delta[1][1][2]).calculate_absolute_value() < 1.0e-3,
    // LOG);
    ...
    // output_interlayers_Delta[0][0][0]).calculate_absolute_value() < 1.0e-3,
    // LOG);
    //   assert_true((numerical_hidden_layer_hidden_layer_output_Delta[1] -
    // output_interlayers_Delta[0][0][1]).calculate_absolute_value() < 1.0e-3,
    // LOG);
    //   assert_true((numerical_hidden_layer_hidden_layer_output_Delta[2] -
    // output_interlayers_Delta[0][0][2]).calculate_absolute_value() < 1.0e-3,
    // LOG);
  }
  ...
  if (numerical_differentiation_tests) {
    for (unsigned i = 0; i < random_tests_number; i++) {
      ...
      //         interlayers_combination_combination_Jacobian =
      // n.calculate_interlayers_combination_combination_Jacobian(layers_combination);

      //       output_interlayers_Delta =
      // n.calculate_output_interlayers_Delta(second_order_forward_propagation,
      // interlayers_combination_combination_Jacobian, output_layers_delta);

      //         for(unsigned j = 0; j < layers_number; j++)
      {
        //            numerical_layer_layer_output_Delta =
        // nd.calculate_Hessian_form(n,
        // &MultilayerPerceptron::calculate_output_layer_combination, j,
        // layers_combination[j]);

        //            for(unsigned k = 0; k < outputs_number; k++)
        {
          //               assert_true((numerical_layer_layer_output_Delta[k] -
          // output_interlayers_Delta[j][j][k]).calculate_absolute_value() <
          // 1.0e-3, LOG);
        }
      }
    }
...
void MultilayerPerceptronTest::test_calculate_parameters_Jacobian(void) {
  ...
  //   hidden_layer_combination = hidden_layer.calculate_combination(inputs);
  //   hidden_layer_activation = n.calculate_layer_activation(0,
  // hidden_layer_combination);
  //   hidden_layer_activation_derivative =
  // n.calculate_layer_activation_derivative(0, hidden_layer_combination);
  //   hidden_layer_activation_second_derivative =
  // n.calculate_layer_activation_second_derivative(0,
  // hidden_layer_combination);

  //   hidden_layer_output = n.calculate_layer_output(0, inputs);

  //   hidden_layer_combination_parameters_Jacobian =
  // n.calculate_layer_combination_parameters_Jacobian(0, inputs);

  //   output_layer_combination_parameters_Jacobian =
  // n.calculate_layer_combination_parameters_Jacobian(1, hidden_layer_output);

  //   parameters_Jacobian = n.calculate_parameters_Jacobian(inputs);

  //   assert_true(parameters_Jacobian.get_rows_number() == 3, LOG);
  //   assert_true(parameters_Jacobian.get_columns_number() ==
  // parameters_number, LOG);

  if (numerical_differentiation_tests) {
    //      numerical_parameters_Jacobian = nd.calculate_Jacobian(n,
    // &MultilayerPerceptron::calculate_parameters_output, inputs, parameters);

    assert_true((parameters_Jacobian - numerical_parameters_Jacobian)
                        .calculate_absolute_value() <
                    1.0e-3,
                LOG);
  }
  ...
  if (numerical_differentiation_tests) {
    for (unsigned i = 0; i < random_tests_number; i++) {
      ...
      //         numerical_parameters_Jacobian = nd.calculate_Jacobian(n,
      // &MultilayerPerceptron::calculate_parameters_output, inputs,
      // parameters);
...
void MultilayerPerceptronTest::test_calculate_parameters_Hessian_form(void) {
  ...
  //   assert_true(parameters_Hessian_form[0].get_rows_number() ==
  // parameters_number, LOG);
  //   assert_true(parameters_Hessian_form[0].get_columns_number() ==
  // parameters_number, LOG);
  //   assert_true(parameters_Hessian_form[0] == 0.0, LOG);

  //   layer_parameters_Hessian_form =
  // n.calculate_layer_parameters_Hessian_form(0, inputs);

  //   assert_true((parameters_Hessian_form[0]-layer_parameters_Hessian_form[0]).calculate_absolute_value()
  // < 1.0e-3, LOG);
  //   assert_true((parameters_Hessian_form[0] -
  // parameters_Hessian_form[0].calculate_transpose()).calculate_absolute_value()
  // < 1.0e-3, LOG);

  //   if(numerical_differentiation_tests)
  {
    //      numerical_parameters_Hessian_form = nd.calculate_Hessian_form(n,
    // &MultilayerPerceptron::calculate_parameters_output, inputs, parameters);

    //   assert_true((parameters_Hessian_form[0]-numerical_parameters_Hessian_form[0]).calculate_absolute_value()
    // < 1.0e-3, LOG);
  }
  ...
  //   assert_true(parameters_Hessian_form[1].get_rows_number() ==
  // parameters_number, LOG);
  //   assert_true(parameters_Hessian_form[1].get_columns_number() ==
  // parameters_number, LOG);
  //   assert_true(parameters_Hessian_form[1] == 0.0, LOG);
  //   assert_true((parameters_Hessian_form[1] -
  // parameters_Hessian_form[1].calculate_transpose()).calculate_absolute_value()
  // < 1.0e-3, LOG);
  ...
  //   assert_true((parameters_Hessian_form[0]-layer_parameters_Hessian_form[0]).calculate_absolute_value()
  // < 1.0e-3, LOG);
  //   assert_true((parameters_Hessian_form[1]-layer_parameters_Hessian_form[1]).calculate_absolute_value()
  // < 1.0e-3, LOG);
  ...
  if (numerical_differentiation_tests) {
    ...
    //    assert_true((parameters_Hessian_form[0]-numerical_parameters_Hessian_form[0]).calculate_absolute_value()
    // < 1.0e-3, LOG);
    //    assert_true((parameters_Hessian_form[1]-numerical_parameters_Hessian_form[1]).calculate_absolute_value()
    // < 1.0e-3, LOG);
  }
  ...
  if (numerical_differentiation_tests) {
    ...
    //    assert_true((parameters_Hessian_form[1]-numerical_parameters_Hessian_form[1]).calculate_absolute_value()
    // < 1.0e-3, LOG);
    //    assert_true((parameters_Hessian_form[2]-numerical_parameters_Hessian_form[2]).calculate_absolute_value()
    // < 1.0e-3, LOG);
    //    assert_true((parameters_Hessian_form[3]-numerical_parameters_Hessian_form[3]).calculate_absolute_value()
    // < 1.0e-3, LOG);
  }
  ...
  if (numerical_differentiation_tests) {
    for (unsigned i = 0; i < random_tests_number; i++) {
      ...
      //       parameters_Hessian_form =
      // n.calculate_parameters_Hessian_form(inputs);

      //         numerical_parameters_Hessian_form =
      // nd.calculate_Hessian_form(n,
      // &MultilayerPerceptron::calculate_parameters_output, inputs,
      // parameters);

      for (unsigned j = 0; j < outputs_number; j++) {
        //          assert_true((parameters_Hessian_form[j]-numerical_parameters_Hessian_form[j]).calculate_absolute_value()
        // < 1.0e-3, LOG);
      }
    }
  }
...
void MultilayerPerceptronTest::test_calculate_layers_combination(void) {
  ...
  Vector<Vector<double> > forward_propagation_combination =
      n.calculate_layers_combination(inputs);
...
void
MultilayerPerceptronTest::test_calculate_layers_combination_parameters_Jacobian(
    void) {
  message += "test_calculate_layers_combination_parameters_Jacobian\n";
}

void MultilayerPerceptronTest::
    test_calculate_perceptrons_combination_parameters_gradient(void) {
  ...
  perceptrons_combination_parameters_gradient =
      n.calculate_perceptrons_combination_parameters_gradient(layers_inputs);
}
...
void
MultilayerPerceptronTest::test_calculate_layers_activation_second_derivative(
    void) {
...
void MultilayerPerceptronTest::test_calculate_layers_Jacobian(void) {
  ...
  Vector<unsigned> architecture(4);
  architecture[0] = 1;
  architecture[1] = 2;
  architecture[2] = 3;
  architecture[3] = 4;
...
void MultilayerPerceptronTest::test_calculate_first_order_forward_propagation(
  ...
  first_order_forward_propagation =
      n.calculate_first_order_forward_propagation(inputs);
