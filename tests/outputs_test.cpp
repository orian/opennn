...
void OutputsTest::test_destructor(void) { message += "test_destructor\n"; }
...
void OutputsTest::test_set(void) { message += "test_set\n"; }

void OutputsTest::test_set_default(void) { message += "test_set_default\n"; }
...
void OutputsTest::test_get_display(void) { message += "test_get_display\n"; }

void OutputsTest::test_set_names(void) { message += "test_set_names\n"; }

void OutputsTest::test_set_name(void) { message += "test_set_name\n"; }

void OutputsTest::test_set_units(void) { message += "test_set_units\n"; }

void OutputsTest::test_set_unit(void) { message += "test_set_unit\n"; }
...
void OutputsTest::test_set_display(void) { message += "test_set_display\n"; }
