...
void PerformanceTermTest::test_calculate_layers_delta(void) {
  ...
  layers_delta = mpt.calculate_layers_delta(layers_activation_derivative,
  ...
  layers_activation_derivative = nn.get_multilayer_perceptron_pointer()
      ->calculate_layers_activation_derivative(inputs);
...
void PerformanceTermTest::test_calculate_interlayers_Delta(void) {
  ...
  interlayers_combination_combination_Jacobian =
      nn.get_multilayer_perceptron_pointer()
  ...
  interlayers_Delta = mpt.calculate_interlayers_Delta(
      ...
      interlayers_combination_combination_Jacobian, output_objective_gradient,
      output_objective_Hessian, layers_delta);
  ...
  layers_activation_derivative = nn.get_multilayer_perceptron_pointer()
      ->calculate_layers_activation_derivative(inputs);
  layers_activation_second_derivative = nn.get_multilayer_perceptron_pointer()
      ->calculate_layers_activation_second_derivative(inputs);
...
void PerformanceTermTest::test_calculate_point_gradient(void) {
  ...
  point_gradient =
      mpt.calculate_point_gradient(inputs, layers_activation, layers_delta);
  ...
  layers_activation = nn.get_multilayer_perceptron_pointer()
      ->calculate_layers_activation(inputs);
  layers_activation_derivative = nn.get_multilayer_perceptron_pointer()
      ->calculate_layers_activation_derivative(inputs);
...
void PerformanceTermTest::test_calculate_point_Hessian(void) {
  ...
  point_Hessian = mpt.calculate_point_Hessian(
      layers_activation_derivative, perceptrons_combination_parameters_gradient,
      interlayers_combination_combination_Jacobian, layers_delta,
      interlayers_Delta);
  ...
  //   point_Hessian = mpt.calculate_point_Hessian(layers_activation_derivative,
  // perceptrons_combination_parameters_gradient,
  // interlayers_combination_combination_Jacobian, layers_delta,
  // interlayers_Delta);

  //   assert_true(point_Hessian.get_rows_number() == network_parameters_number,
  // LOG);
  //   assert_true(point_Hessian.get_columns_number() ==
  // network_parameters_number, LOG);
  ...
  layers_delta = mpt.calculate_layers_delta(layers_activation_derivative,
                                            output_objective_gradient);
  //   interlayers_Delta =
  // mpt.calculate_interlayers_Delta(layers_activation_derivative,
  // layers_activation_second_derivative,
  // interlayers_combination_combination_Jacobian, output_objective_gradient,
  // output_objective_Hessian, layers_delta);

  //   point_Hessian = mpt.calculate_point_Hessian(inputs, layers_activation,
...
void PerformanceTermTest::test_calculate_gradient(void) {
  ...
  numerical_gradient = nd.calculate_gradient(
      mpt, &MockPerformanceTerm::calculate_performance, parameters);
