...
// @todo Fix exception in file constructor: basic_string::_S_construct null not
// valid
...
void DataSetTest::test_set_display(void) { message += "test_set_display\n"; }
...
void DataSetTest::test_set_generalization_input_instance(void) {
  ...
  assert_true(
      generalization_input_instance == new_generalization_input_instance, LOG);
}
...
void DataSetTest::test_set_generalization_target_instance(void) {
  ...
  assert_true(
      generalization_target_instance == new_generalization_target_instance,
      LOG);
}
...
void DataSetTest::test_calculate_generalization_instances_statistics(void) {
  ...
  generalization_instances_statistics =
      ds.calculate_generalization_instances_statistics();
}
...
void DataSetTest::test_scale_targets_mean_standard_deviation(void) {
  ...
  assert_true(targets_statistics[0].has_mean_zero_standard_deviation_one(),
              LOG);
}
...
void DataSetTest::test_load(void) {
  ...
  /*
     ...
     assert_true(ds_copy.get_variables_pointer()->get_description(0) ==
  "distance", LOG);
  
     assert_true(ds_copy.get_variables_pointer()->get_name(1) == "y", LOG);
     assert_true(ds_copy.get_variables_pointer()->get_unit(1) == "[s]", LOG);
     assert_true(ds_copy.get_variables_pointer()->get_description(1) == "time",
  LOG);
  */
}

void DataSetTest::test_print_data(void) { message += "test_print_data\n"; }
