...
void NeuralParametersNormTest::test_calculate_performance(void) {
  ...
  assert_true(
      npn.calculate_performance() == npn.calculate_performance(parameters),
      LOG);
}
...
void NeuralParametersNormTest::test_calculate_gradient(void) {
  ...
  numerical_gradient = nd.calculate_gradient(
      npn, &NeuralParametersNorm::calculate_performance, parameters);
...
void NeuralParametersNormTest::test_calculate_Hessian(void) {
  ...
  assert_true(Hessian.get_columns_number() == nn.count_parameters_number(),
              LOG);
  ...
  //   Hessian = npn.calculate_Hessian();
  //   numerical_Hessian = nd.calculate_Hessian(npn,
  // &NeuralParametersNorm::calculate_performance, parameters);
