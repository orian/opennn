...
void UnscalingLayerTest::test_set(void) { message += "test_set\n"; }
...
void UnscalingLayerTest::test_get_mean(void) { message += "test_get_mean\n"; }
...
void UnscalingLayerTest::test_set_means(void) { message += "test_set_means\n"; }

void UnscalingLayerTest::test_set_standard_deviations(void) {
  message += "test_set_standard_deviations\n";
}

void UnscalingLayerTest::test_set_mean(void) { message += "test_set_mean\n"; }
...
void UnscalingLayerTest::test_calculate_derivatives(void) {
  ...
  if (numerical_differentiation_tests) {
    ...
    numerical_derivative =
        nd.calculate_derivative(ul, &UnscalingLayer::calculate_outputs, inputs);

    assert_true(
        (derivative - numerical_derivative).calculate_absolute_value() < 1.0e-3,
        LOG);
  }
...
void UnscalingLayerTest::test_get_unscaling_method(void) {
  ...
  assert_true(
      ul.get_unscaling_method() == UnscalingLayer::MeanStandardDeviation, LOG);
