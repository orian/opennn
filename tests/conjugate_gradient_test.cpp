...
void ConjugateGradientTest::test_get_training_direction_method(void) {
  ...
  ConjugateGradient::TrainingDirectionMethod training_direction_method =
      cg.get_training_direction_method();
...
void ConjugateGradientTest::test_calculate_PR_training_direction(void) {
  ...
  Vector<double> PR_training_direction = cg.calculate_PR_training_direction(
      old_gradient, gradient, old_training_direction);
...
void ConjugateGradientTest::test_calculate_FR_training_direction(void) {
  ...
  Vector<double> FR_training_direction = cg.calculate_FR_training_direction(
      old_gradient, gradient, old_training_direction);
