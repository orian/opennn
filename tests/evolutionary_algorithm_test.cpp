...
void EvolutionaryAlgorithmTest::test_get_population_size(void) {
  ...
  unsigned population_size = ea.get_population_size();
...
void EvolutionaryAlgorithmTest::test_get_population(void) {
  ...
  unsigned rows_number = population.get_rows_number();
  unsigned columns_number = population.get_columns_number();
...
void
EvolutionaryAlgorithmTest::test_get_reserve_standard_deviation_norm_history(
    void) {
...
void EvolutionaryAlgorithmTest::test_get_reserve_mean_performance_history(
    void) {
...
void EvolutionaryAlgorithmTest::
    test_get_reserve_standard_deviation_performance_history(void) {
  ...
  assert_true(ea.get_reserve_standard_deviation_performance_history() == true,
              LOG);

  ea.set_reserve_standard_deviation_performance_history(false);

  assert_true(ea.get_reserve_standard_deviation_performance_history() == false,
              LOG);
}

void EvolutionaryAlgorithmTest::test_get_reserve_best_performance_history(
    void) {
...
void EvolutionaryAlgorithmTest::test_get_fitness_assignment_method(void) {
  ...
  assert_true(ea.get_fitness_assignment_method() ==
                  EvolutionaryAlgorithm::LinearRanking,
              LOG);
}
...
void EvolutionaryAlgorithmTest::test_get_selection_method(void) {
  ...
  assert_true(ea.get_selection_method() == EvolutionaryAlgorithm::RouletteWheel,
              LOG);
}
...
void EvolutionaryAlgorithmTest::test_get_recombination_method(void) {
  ...
  assert_true(ea.get_recombination_method() == EvolutionaryAlgorithm::Line,
              LOG);

  ea.set_recombination_method(EvolutionaryAlgorithm::Intermediate);

  assert_true(
      ea.get_recombination_method() == EvolutionaryAlgorithm::Intermediate,
      LOG);
}
...
void EvolutionaryAlgorithmTest::test_set(void) { message += "test_set\n"; }
...
void EvolutionaryAlgorithmTest::test_set_standard_deviation_performance_goal(
    void) {
...
void
EvolutionaryAlgorithmTest::test_set_reserve_standard_deviation_norm_history(
    void) {
...
void EvolutionaryAlgorithmTest::test_set_reserve_mean_performance_history(
    void) {
  message += "test_set_reserve_mean_performance_history\n";
}

void EvolutionaryAlgorithmTest::
    test_set_reserve_standard_deviation_performance_history(void) {
  message += "test_set_reserve_standard_deviation_performance_history\n";
}

void EvolutionaryAlgorithmTest::test_set_reserve_best_performance_history(
    void) {
...
void EvolutionaryAlgorithmTest::test_perform_linear_ranking_fitness_assignment(
  ...
  assert_true(fitness.calculate_maximum() ==
                  (population_size - 1.0) * selective_pressure,
              LOG);
  ...
  assert_true(performance.calculate_minimal_index() ==
                  fitness.calculate_maximal_index(),
              LOG);
  assert_true(performance.calculate_maximal_index() ==
                  fitness.calculate_minimal_index(),
              LOG);
...
void EvolutionaryAlgorithmTest::test_perform_training(void) {
  ...
  ea.set_best_performance_goal(0.0);
  ea.set_mean_performance_goal(0.0);
  ea.set_standard_deviation_performance_goal(
      standard_deviation_performance_goal);
  ea.set_maximum_generations_number(10);
  ea.set_maximum_time(10.0);

  ea.perform_training();

  double standard_deviation_performance =
      ea.calculate_standard_deviation_performance();

  assert_true(
      standard_deviation_performance < standard_deviation_performance_goal,
      LOG);
}
...
void EvolutionaryAlgorithmTest::test_from_XML(void) {
  ...
  //   assert_true(ea.get_population() == population, LOG);
}
