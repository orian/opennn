...
Vector<double> MockPerformanceTerm::calculate_output_integral_integrand_gradient(const double& x) const
{
   ...
   const unsigned int layers_number = multilayer_perceptron_pointer->get_layers_number();
...
double MockPerformanceTerm::calculate_output_integral(const Vector<double>& parameters) const
{
