...
MockPerformanceTerm::MockPerformanceTerm(
...
const MockPerformanceTerm::Expression& MockPerformanceTerm::get_expression(
    void) const {
  return (expression);
}

void MockPerformanceTerm::set_expression(
    const MockPerformanceTerm::Expression& new_expression) {
...
Vector<double> MockPerformanceTerm::calculate_sum_squared_parameters_gradient(
    void) const {
  const Vector<double> parameters =
      neural_network_pointer->arrange_parameters();
...
Matrix<double> MockPerformanceTerm::calculate_sum_squared_parameters_Hessian(
    void) const {
...
Vector<double> MockPerformanceTerm::calculate_sum_squared_parameters_terms(
    void) const {
  const Vector<double> parameters =
      neural_network_pointer->arrange_parameters();
...
Matrix<double>
MockPerformanceTerm::calculate_sum_squared_parameters_terms_Jacobian(
    void) const {
  const Vector<double> parameters =
      neural_network_pointer->arrange_parameters();
  const unsigned parameters_number =
...
double MockPerformanceTerm::calculate_sum_squared_parameters(
...
double MockPerformanceTerm::calculate_output_integral_integrand(
    const double& x) const {
  const Vector<double> input(1, x);

  const Vector<double> output =
      neural_network_pointer->calculate_outputs(input);
...
MockPerformanceTerm::calculate_output_integral_integrand_gradient(
  ...
  const Vector<Vector<double> > layers_delta = calculate_layers_delta(
      layers_activation_derivative, output_objective_gradient);

  const Vector<double>
      objective_gradient_integrand;  // =
                                     // calculate_point_objective_gradient(input,
                                     // layers_activation, layers_delta);
...
Vector<double> MockPerformanceTerm::calculate_output_integral_gradient(
    void) const {
...
Matrix<double> MockPerformanceTerm::calculate_output_integral_integrand_Hessian(
    const double&) const {
...
Matrix<double> MockPerformanceTerm::calculate_output_integral_Hessian(
    void) const {
...
double MockPerformanceTerm::calculate_output_integral(
    const Vector<double>& parameters) const {
  ...
  switch (expression) {
    ...
    case OutputIntegral: {
      ...
      buffer << "OpenNN Exception: MockPerformanceFunctional class\n"
             ...
             << "The terms function is not defined for the output integral "
                "expression.\n";
...
double MockPerformanceTerm::calculate_performance(
    const Vector<double>& parameters) const {
  switch (expression) {
    case SumSquaredParameters: {
...
Vector<double> MockPerformanceTerm::calculate_gradient(
    const Vector<double>& parameters) const {
  switch (expression) {
    case SumSquaredParameters: {
...
Matrix<double> MockPerformanceTerm::calculate_Hessian(
    const Vector<double>& parameters) const {
  switch (expression) {
    case SumSquaredParameters: {
    ...
    default: {
      ...
      buffer << "OpenNN Exception: MockPerformanceFunctional class\n"
             << "Vector<double> calculate_Hessian(const Vector<double>&) const "
                "method.\n"
             << "Unknown expression.\n";
