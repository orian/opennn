...
void OutputsIntegralsTest::test_calculate_gradient(void) {
  ...
  //   gradient = nnoi.calculate_gradient();
  //   numerical_gradient = nd.calculate_gradient(nnoi,
  // &OutputsIntegrals::calculate_performance, parameters);
...
void OutputsIntegralsTest::test_to_XML(void) { message += "test_to_XML\n"; }

void OutputsIntegralsTest::test_from_XML(void) { message += "test_from_XML\n"; }
