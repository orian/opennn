...
void FunctionRegressionTestingTest::test_calculate_scaled_target_output_data(
    void) {
  ...
  Vector<Matrix<double> > scaled_target_output_data =
      fru.calculate_scaled_target_output_data();
...
void FunctionRegressionTestingTest::test_calculate_linear_regression_parameters(
    void) {
  ...
  Vector<Vector<double> > linear_regression_parameters =
      mu.calculate_linear_regression_parameters();
...
void FunctionRegressionTestingTest::test_print_linear_regression_parameters(
    void) {
...
void FunctionRegressionTestingTest::test_save_linear_regression_parameters(
    void) {
...
void FunctionRegressionTestingTest::test_print_linear_regression_analysis(
    void) {
