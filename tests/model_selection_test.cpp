...
void ModelSelectionTest::test_perform_model_order_selection(void) {
  ...
  //   assert_true(model_order_selection_data.parameters_data.get_rows_number()
  // == 1, LOG);
  //   assert_true(model_order_selection_data.parameters_data.get_columns_number()
  // == 1, LOG);

  //   assert_true(model_order_selection_data.training_objective_data.get_rows_number()
  // == 1, LOG);
  //   assert_true(model_order_selection_data.training_objective_data.get_columns_number()
  // == 1, LOG);

  //   assert_true(model_order_selection_data.generalization_objective_data.get_rows_number()
  // == 1, LOG);
  //   assert_true(model_order_selection_data.generalization_objective_data.get_columns_number()
  // == 1, LOG);
}
...
void ModelSelectionTest::test_print(void) { message += "test_print\n"; }

void ModelSelectionTest::test_save(void) { message += "test_save\n"; }
