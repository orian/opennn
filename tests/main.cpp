...
int main(void) {
  std::cout << "Open Neural Networks Library. Test Suite Application.\n"
               "Write test:\n"
               "variables\n"
               "instances\n"
               "data_set\n"
  ...
  try {
    ...
    if (test == "vector") {
      ...
      tests_passed_count +=
          test_numerical_differentiation.get_tests_passed_count();
      tests_failed_count +=
          test_numerical_differentiation.get_tests_failed_count();
      ...
      tests_passed_count +=
          linear_algebraic_equations_test.get_tests_passed_count();
      tests_failed_count +=
          linear_algebraic_equations_test.get_tests_failed_count();
    }
      ...
      tests_passed_count +=
          ordinary_differential_equations_test.get_tests_passed_count();
      tests_failed_count +=
          ordinary_differential_equations_test.get_tests_failed_count();
      ...
      tests_passed_count +=
          independent_parameters_test.get_tests_passed_count();
      tests_failed_count +=
          independent_parameters_test.get_tests_failed_count();
      ...
      tests_passed_count +=
          root_mean_squared_error_test.get_tests_passed_count();
      tests_failed_count +=
          root_mean_squared_error_test.get_tests_failed_count();
      ...
      tests_passed_count +=
          normalized_squared_error_test.get_tests_passed_count();
      tests_failed_count +=
          normalized_squared_error_test.get_tests_failed_count();
      ...
      tests_passed_count +=
          independent_parameters_error_test.get_tests_passed_count();
      tests_failed_count +=
          independent_parameters_error_test.get_tests_failed_count();
      ...
      tests_passed_count +=
          test_inverse_sum_squared_error.get_tests_passed_count();
      tests_failed_count +=
          test_inverse_sum_squared_error.get_tests_failed_count();
      ...
      tests_passed_count +=
          test_neural_parameters_norm.get_tests_passed_count();
      tests_failed_count +=
          test_neural_parameters_norm.get_tests_failed_count();
      ...
      tests_passed_count +=
          performance_functional_test.get_tests_passed_count();
      tests_failed_count +=
          performance_functional_test.get_tests_failed_count();
    }
      ...
      tests_passed_count +=
          training_rate_algorithm_test.get_tests_passed_count();
      tests_failed_count +=
          training_rate_algorithm_test.get_tests_failed_count();
      ...
      tests_passed_count +=
          evolutionary_algorithm_test.get_tests_passed_count();
      tests_failed_count +=
          evolutionary_algorithm_test.get_tests_failed_count();
      ...
      tests_passed_count +=
          Levenberg_Marquardt_algorithm_test.get_tests_passed_count();
      tests_failed_count +=
          Levenberg_Marquardt_algorithm_test.get_tests_failed_count();
    ...
    if (tests_failed_count == 0) {
      ...
      std::cout << "Test NOT OK. " << tests_failed_count << " tests failed"
                << std::endl;
    }
