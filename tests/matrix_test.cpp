...
void MatrixTest::test_destructor(void) { message += "test_destructor\n"; }
...
void MatrixTest::test_initialize(void) { message += "test_initialize\n"; }
...
void MatrixTest::test_dot(void) { message += "test_dot\n"; }
