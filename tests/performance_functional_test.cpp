...
void PerformanceFunctionalTest::test_get_numerical_differentiation_pointer(
    void) {
...
void PerformanceFunctionalTest::test_calculate_performance(void) {
  ...
  assert_true(
      fabs(pf.calculate_performance() - pf.calculate_performance(parameters)) <
          1.0e-3,
      LOG);
  ...
  assert_true(
      pf.calculate_performance() != pf.calculate_performance(parameters * 2.0),
      LOG);
  ...
  assert_true(pf.calculate_performance(direction, rate) ==
                  pf.calculate_performance(parameters + direction * rate),
              LOG);
...
void PerformanceFunctionalTest::test_calculate_inverse_Hessian(void) {
  ...
  //   assert_true(pf.calculate_inverse_Hessian() ==
  // Hessian.calculate_inverse(), LOG);
}
...
void PerformanceFunctionalTest::test_calculate_vector_dot_Hessian(void) {
  ...
  //   assert_true(pf.calculate_vector_dot_Hessian(vector) ==
  // vector.dot(Hessian), LOG);
}
...
void PerformanceFunctionalTest::test_calculate_zero_order_Taylor_approximation(
    void) {
  message += "test_calculate_zero_order_Taylor_approximation\n";
}

void PerformanceFunctionalTest::test_calculate_first_order_Taylor_approximation(
    void) {
  message += "test_calculate_first_order_Taylor_approximation\n";
}

void
PerformanceFunctionalTest::test_calculate_second_order_Taylor_approximation(
    void) {
...
void PerformanceFunctionalTest::test_calculate_directional_performance(void) {
  ...
  assert_true(
      pf.calculate_performance(direction, rate) != pf.calculate_performance(),
      LOG);
}

void
PerformanceFunctionalTest::test_calculate_directional_performance_derivative(
    void) {
...
void PerformanceFunctionalTest::
    test_calculate_directional_performance_second_derivative(void) {
  ...
  assert_true(
      pf.calculate_performance_second_derivative(direction, rate) == 0.0, LOG);
}
...
void PerformanceFunctionalTest::test_from_XML(void) {
  ...
  assert_true(pf2.get_objective_type() ==
                  PerformanceFunctional::MINKOWSKI_ERROR_OBJECTIVE,
              LOG);
  assert_true(pf2.get_regularization_type() ==
                  PerformanceFunctional::NEURAL_PARAMETERS_NORM_REGULARIZATION,
              LOG);
}
