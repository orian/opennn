...
int main(void)
{
   try
   {
      ...
      data_set.load_data("../data/yachtresistance.dat");
      ...
      const unsigned int inputs_number = data_set.get_variables().count_inputs_number();
      const unsigned int hidden_neurons_number = 9;
      const unsigned int outputs_number = data_set.get_variables().count_targets_number();
      ...
      linear_regression_results.save("../data/linear_regression_results.dat");
